...
Private _nTxDolar	:= 0 	//Variavel Especifico Prozyn
Private _cNumPCom 	:= "" 	//Variavel Especifico Prozyn
Private _nVez		:= 1	//Variavel Especifico Prozyn
//Declaração de Lógicos
...
//cString := '' //tirar comentário para testes no xml
