...
TRCell():New(oCabec,"C5_LGLIBCO"	,/*Tabela*/,"Data Liberação"		,								,nTamData    ,/*lPixel*/,{|| SubStr(SC5->C5_LGLIBCO,Rat("Data:",SC5->C5_LGLIBCO)+6,10)},,,,,,.F.)
...
TRCell():New(oPedaFat,"DINIPCP"		,/*Tabela*/,RetTitle("C6_YDTINIP")	,PesqPict("SC6","C6_YDTINIP"		),nTamData				      ,/*lPixel*/ ,{|| dIniPcp			},,,,,,.F.)	// Entrega Prod
TRCell():New(oPedaFat,"DENTREG"		,/*Tabela*/,RetTitle("C6_ENTREG")	,PesqPict("SC6","C6_ENTREG"		),nTamData				      ,/*lPixel*/ ,{|| dEntreg			},,,,,,.F.)	// Entrega Prod 
TRCell():New(oPedaFat,"DENTRSU"		,/*Tabela*/,RetTitle("C6_SUGENTR")	,PesqPict("SC6","C6_SUGENTR"		),nTamData				      ,/*lPixel*/ ,{|| dEntrsu			},,,,,,.F.)	// Entrega Fat
TRCell():New(oPedaFat,"CLAUEX"		,/*Tabela*/,RetTitle("C6_LAUEXT")	,PesqPict("SC6","C6_LAUEXT"		),2						 ,/*lPixel*/,{|| cLauex 		})	// Laudo Externo "S" ou "N"
...
oReport:Section(1):Section(1):Cell("DINIPCP"		):SetBlock({|| dIniPcp			})
oReport:Section(1):Section(1):Cell("DENTREG"		):SetBlock({|| dEntreg			})   
oReport:Section(1):Section(1):Cell("DENTRSU"		):SetBlock({|| dEntrsu			})   
oReport:Section(1):Section(1):Cell("CLAUEX"			):SetBlock({|| cLauex			})
cVends 		:= ""
cItem      	:= "" 
cProduto   	:= "" 
cDescricao 	:= "" 
...
cQueryAdd := ""
	...
	If mv_par15==1
		cTpBloq := '%'+FormatIn(' ;L',";")+'%'
	ElseIf mv_par15==2
		cTpBloq := '%'+FormatIn('B;S',";")+'%'
	Else
		cTpBloq := '%'+FormatIn(' ;B;S;L',";")+'%'
	EndIf
    ...
    If mv_par06 == 3
		...
		SELECT
		SC5.C5_FILIAL,SC5.C5_NUM,SC5.C5_CLIENTE,SC5.C5_LOJACLI,SC5.C5_TIPO,SC5.C5_TIPOCLI,SC5.C5_TRANSP,SC5.C5_EMISSAO,SC5.C5_LGLIBCO,
		SC5.C5_CONDPAG,SC5.C5_MOEDA,SC5.C5_VEND1,SC5.C5_VEND2,SC5.C5_VEND3,SC5.C5_VEND4,SC5.C5_VEND5, SC5.C5_FECENT,
		...
		SUM(SC9.C9_QTDLIB) C9_QTDLIB,SF4.F4_FILIAL,SF4.F4_DUPLIC,SF4.F4_CODIGO,SC5.C5_ACRSFIN,SC6.C6_SUGENTR, SC6.C6_LAUEXT, SC6.C6_YPREVFA, SC6.C6_YDTINIP
		...
		WHERE
			...
			// SC5.C5_XBLQMIN != 'S' AND
			SC5.C5_XBLQFIN IN %Exp:cTpBloq% AND
			SC5.C5_XBLQMRG IN %Exp:cTpBloq% AND
			// SC5.C5_XBLQFIN != 'B' AND
			// SC5.C5_XBLQMRG != 'S' AND
	    ...
	    GROUP BY
			...
			SC6.C6_VALOR,SC6.C6_ITEM,SC6.C6_PRCVEN,SC6.C6_CLI,SC6.C6_LOJA,SC6.C6_ENTREG,SC6.C6_LOCAL,SC6.C6_QTDENT,SC6.C6_BLQ,
			SC9.C9_FILIAL,SC9.C9_PEDIDO,SC9.C9_ITEM,SC9.C9_NFISCAL,SC9.C9_BLEST,SC9.C9_BLCRED,SC9.C9_PRODUTO,
			SF4.F4_FILIAL,SF4.F4_DUPLIC,SF4.F4_CODIGO,SC5.C5_ACRSFIN,SC6.C6_SUGENTR,SC6.C6_LAUEXT, SC6.C6_YPREVFA, SC6.C6_YDTINIP
...
While !oReport:Cancel() .AND. !( cAliasSC6 )->( Eof() ) .AND. (cAliasSC6)->C6_FILIAL == xFilial("SC6")
	...
	If lFiltro
		...
		dIniPcp	   := (cAliasSC6)->C6_YDTINIP
		dEntreg    := (cAliasSC6)->C6_ENTREG
		dEntrsu    := (cAliasSC6)->C6_SUGENTR
		cLauex	   := IIF((cAliasSC6)->C6_LAUEXT=="1","S","N")
		//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
//³ mv_par15         // Bloqueados 1-Sem bloqueio 2- Somente Bloqueados 3 - Ambos ³
...
cQuery := "SELECT "
cQuery += "SC5.C5_FILIAL,SC5.C5_NUM,SC5.C5_CLIENTE,SC5.C5_LOJACLI,SC5.C5_TIPO,SC5.C5_TIPOCLI,SC5.C5_TRANSP,SC5.C5_EMISSAO,SC5.C5_LGLIBCO,
