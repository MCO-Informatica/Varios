...
Static Function CriaTabAnli()
	...
	aAdd (aCmp, {"ANL_UM_MES"	,"N", TAMSX3("C4_QUANT")[1]		,	TAMSX3("C4_QUANT")[2]})//Quantidade do forecast 1 M๊s
...
Static Function CriaTabSint()
	...
	aAdd (aCmp, {"SIN_UM_MES"	,"N", TAMSX3("C4_QUANT")[1]+2		,	TAMSX3("C4_QUANT")[2]})//Quantidade do forecast 1 m๊s
