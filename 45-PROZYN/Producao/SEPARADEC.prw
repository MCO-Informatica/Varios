...
±±ºPrograma  ³SEPARADEC ºAutor  ³Denis Varella       º Data ³  07/10/19   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Fonte responsável por criar a grid de separação com divisão  ±±
±±º          ³de etiquetas na ordem de produção de Decimais               º±±
±±º          ³                                                            º±±
...
User Function SEPARADEC()
	Local cPerg		:= PadR("SEPARADEC",10)
	AjustaSX1(cPerg)
	If Pergunte(cPerg,.T.)
		//If MSCBFSem()
...
Static Function SeparaOP
	...
	DbSelectArea("CB5")
	CB5->(DbSetOrder(1))
	CB5->(DbSeek(xFilial("CB5")+cImp))  //-- cadastro de locais de impressao
...
Static Function getBalanca(nSaldo)
	...
	If MSOpenPort(nHandle,"COM1:9600,N,8,1")
		MsgAlert("COM1")
	EndIf
...
Static Function AjustaSX1(cPerg)
	...
	AADD(	aSx1,{ cPerg,"01","ORDEM DE SEPARAÇÃO:"	,"","","mv_ch1","C",06,0,0,"G","","mv_par01","","","","","","","","","","","","","","","","","","","","","","","","","CB7DEC",""})
