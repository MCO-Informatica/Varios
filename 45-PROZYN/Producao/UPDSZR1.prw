...
/*/
//--------------------------------------------------------------------
User Function UPDSZR1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSZR1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSZR1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, {'SC6','28','C6_XNFVEN','C',9,0,'Nf Triang','Nf Triang','Nf Triang','Nf Triang','Nf Triang','Nf Triang','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','SD2TRG',0,Chr(254) + Chr(192),'','S','U','N','A','R','','','','','','','','','','','','','','N','','','N','','',''} )
aAdd( aSX3, {'SC6','29','C6_XNFITE','C',2,0,'It Nf Triang','It Nf Triang','It Nf Triang','It Nf Triang','It Nf Triang','It Nf Triang','@!','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','N','A','R','','','','','','','','','','','','','','N','','','N','','',''} )
...
aAdd( aSIX, {'SD2','H','D2_FILIAL+D2_DOC+D2_COD+D2_ITEM','Num. Docto.+Produto+Item','Nro. Doc.+Producto+Item','Doc. Number+Producto+Item','U','','','N'} )
//
// Atualizando dicionário
//
...
aAdd( aSX7, {'C6_XNFVEN','001','Posicione("SD2",17,xFilial("SD2")+M->C6_XNFVEN+M->C6_PRODUTO,"D2_ITEM")','C6_XNFITE','P','N','',0,'','U',''} )
//
// Atualizando dicionário
//
...
aAdd( aSXB, {'SD2TRG','1','01','DB','NF TRIANGULAR SD2','NF TRIANGULAR SD2','NF TRIANGULAR SD2','','SD2'} )
aAdd( aSXB, {'SD2TRG','2','01','01','Produto + Armazem +','Producto + Deposito','Product + Warehouse','',''} )
aAdd( aSXB, {'SD2TRG','4','01','01','Num. Docto.','Nro. Doc.','Doc. Number','','D2_DOC'} )
aAdd( aSXB, {'SD2TRG','4','01','02','Produto','Producto','Product','','D2_COD'} )
aAdd( aSXB, {'SD2TRG','4','01','03','Item','Item','Item','','D2_ITEM'} )
aAdd( aSXB, {'SD2TRG','4','01','04','Quantidade','Cantidad','Quantity','','D2_QUANT'} )
aAdd( aSXB, {'SD2TRG','5','01','','','','','','SD2->D2_DOC'} )
aAdd( aSXB, {'SD2TRG','6','01','','','','','','SD2->D2_CF =="5122" .OR. SD2->D2_CF == "6122"'} )
//
// Atualizando dicionário
//
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDSZR1" ) ) ) ;
