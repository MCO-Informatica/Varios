...
User Function relat014()
	Local oReport := nil
	Local cPerg:= Padr("RELAT014",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Contas a Pagar - Baixados",cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	...
	oSection2:= TRSection():New(oReport, "Contas a Pagar - Baixados", {"SE2"}, NIL, .F., .T.)
...
Static Function ReportPrint(oReport)
	...
	While !Eof()
		...
		IncProc("Imprimindo Contas a Pagar - Baixados"+alltrim(TRBFIN->TMP_VENCREAL))
