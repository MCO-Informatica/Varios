...
User Function relat015()
	Local oReport := nil
	Local cPerg:= Padr("RELAT015",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Contas a Receber - Baixados",cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	...
	oSection2:= TRSection():New(oReport, "Contas a Receber - Baixados", {"SE1"}, NIL, .F., .F.)
...
Static Function ReportPrint(oReport)
	...
	cQuery += "	FROM SE1010 "
	cQuery += "	WHERE SE1010.D_E_L_E_T_ <> '*' AND E1_BAIXA <> '' AND "
	...
	cQuery += "	ORDER BY E1_VENCREA, E1_XXIC, E1_EMISSAO "
	...
	While !Eof()
		...
		IncProc("Imprimindo Contas a Receber - Baixados"+alltrim(TRBFIN->TMP_VENCREAL))
