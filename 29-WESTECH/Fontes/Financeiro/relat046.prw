...
User Function relat046()


	Local oReport := nil
	Local cPerg:= Padr("RELAT046",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Contas a Receber - Abertos",cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	...
	oSection2:= TRSection():New(oReport, "Contas a Receber - Abertos", {"SE1"}, NIL, .F., .T.)
...
Static Function ReportPrint(oReport)
	...
	While !Eof()
		...
		IncProc("Imprimindo Contas a Receber - Abertos"+alltrim(TRBFIN->TMP_VENCREAL))
