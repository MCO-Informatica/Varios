...
User Function relat033()
	Local oReport := nil
	Local cPerg:= Padr("RELAT033",10)
...
Static Function RptDef(cNome)
	...
	TRCell():New(oSection2,"TMP_CODFORN"	,"TRBFIN","Código"			,"@!"				,10)
	TRCell():New(oSection2,"TMP_FORNECE"	,"TRBFIN","Fornecedor"		,"@!"				,40)
	TRCell():New(oSection2,"TMP_VENCTO"		,"TRBFIN","Vencimento"		,""					,20)
...
Static Function ReportPrint(oReport)
	...
	cQuery += "		E2_NOMFOR as 'TMP_FORNECE', CAST(E2_EMISSAO as Date) as 'TMP_EMISSAO', CAST(E2_VENCTO as Date) as 'TMP_VENCTO', CAST(E2_VENCREA as Date) as 'TMP_VENCREAL', " 
