...
User Function relPag03()
	Local oReport := nil
	Local cPerg:= Padr("relPag03",10)
...
Static Function RptDef(cNome)
	...
	TRCell():New(oSection2,"TMP_CONTRATO",	"TRBFIN",	"Contrato"  		,"@!"	,	13)
	TRCell():New(oSection2,"TMP_NTITULO"	,"TRBFIN","Título"			,"@!"				,20)
	...
	TRCell():New(oSection2,"TMP_NOME"		,"TRBFIN","Nome"			,""					,40)
...
Static Function ReportPrint(oReport)
    ...
    cQuery += "	WHERE SE5010.D_E_L_E_T_ <> '*' AND SE2010.D_E_L_E_T_ <> '*' AND SA6010.D_E_L_E_T_ <> '*' AND E5_TIPO NOT IN ('PA') AND "
 cQuery += " E5_FORNECE		  >= '" + MV_PAR03 + "' AND  "
 cQuery += " E5_FORNECE    	  <= '" + MV_PAR04 + "' AND  "
 cQuery += " E5_RECPAG = 'P' AND E5_TIPODOC IN ('PA','VL') AND E5_BANCO <> '' OR " 
 cQuery += " SE5010.D_E_L_E_T_ <> '*' AND SE2010.D_E_L_E_T_ <> '*' AND SA6010.D_E_L_E_T_ <> '*' AND E5_TIPO NOT IN ('PA') AND "
 cQuery += " E5_FORNECE		  >= '" + MV_PAR03 + "' AND  "
 cQuery += " E5_FORNECE    	  <= '" + MV_PAR04 + "' AND  "
