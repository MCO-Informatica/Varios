...
User Function relGC04()

	Local oReport := nil
	Local cPerg:= Padr("relGC04",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Relatório de Custos Empenhado  " ,cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	...
	TRCell():New(oSection1,"TMP_CONTRATO",	"TRBSGC",	"Contrato"  		,"@!"				,26)
	TRCell():New(oSection1,"TMP_DTINI"		,"TRBSGC","Data Venda."			,""					,18,,,,,"CENTER")
	TRCell():New(oSection1,"TMP_CLIENTE"	,"TRBSGC","Cliente."  			,"@!"				,60)
	...
	TRCell():New(oSection1,"TMP_PERCTB"		,"TRBSGC","% Mg.Contr."			,"@E 99,999,999.99",24,,,,,"RIGHT")
	//TRCell():New(oSection1,"TMP_DESCRI",	"TRBSGC",	"Descricao"  		,"@!"				,22)
...
Static Function ReportPrint(oReport)
	...
	*/
	...
	oReport:SkipLine(3)
	oReport:FatLine()
	oReport:PrintText("Custo Empenhado")
	oReport:FatLine()
