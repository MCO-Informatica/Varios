...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Relatório de Faturamento / Recebimento Revisado / Realizado " ,cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	...
	TRCell():New(oSection1,"TMP_DESCRI"		,"TRBSGC","Descricao"  			,"@!"	,	25)
