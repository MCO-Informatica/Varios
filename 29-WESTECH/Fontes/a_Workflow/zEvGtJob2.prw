...
Static Function zEvMail(cTo, cCc, cAssunto, cMsg, aAnexo)
    ...
    //for nI=1 to len(aMatriz2) 
		...
		cMsg+='							<th colspan="2" style="text-align: center;">Enpenhado</th>
		...
		cFiltro1A := " ZZP->ZZP_ITEMCT = _cItemConta " 
        ...
        oMessage:cFrom              := cUsr
        oMessage:cTo                := "linfanti@westech-inc.com"
        oMessage:cCc                := "dzironian@westech.com.br" // cEmailCC
