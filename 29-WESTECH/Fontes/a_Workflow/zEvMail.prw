...
//Envia E-mail
User Function zEvMail(cTo, cCc, cAssunto, cMsg, aAnexo)
	Local cNum			:= CA120NUM
...
for nI=1 to Len( aCOLS )
	AAdd( aMatriz, Posicione("CTD",1,xFilial("CTD") +  ALLTRIM(aCols[nI][3]),"CTD_XIDPM") ,nI )
...
//////////////////////////////////////////
	...
	cMsg+='	<div id="titulo">'
	cMsg+='				<h1 class="titulo-topo"> EMISSAO PEDIDO DE COMPRA</h1>'
	cMsg+='	</div>'
	...
	// CAPTURAR DO COORDENADOR DO CONTRATO
				...
				//alert ( SC7->C7_XAPRN3 + " " + substr(SC7->C7_ITEMCTA,1,2) + " " + CValToChar(nTotalCom) + " " + cUserCoord +  " " + cGrup  ) 
