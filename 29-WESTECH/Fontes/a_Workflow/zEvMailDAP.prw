...
//Envia E-mail
User Function zEvMailDAP(cTo, cCc, cAssunto, cMsg, aAnexo)
	Local cNum			:= TRB1->NUM
...
//////////////////////////////////////////
	...
	cMsg+='				<h4 class="titulo-topo"> por ' + AllTrim(UsrFullName(AllTrim(RetCodUsr()))) + '</h4>'
	cMsg+='	</div>'
...
//Desconecta do servidor
    ...
    msginfo('Aviso de pedido APROVADO enviado para o e-mail ' + cEmail + '.','Westech')
