...
//Envia E-mail
User Function zEnviaAprov(cTo, cCc, cAssunto, cMsg, aAnexo)
	Local cNum			:= TRB1->NUM
...
//////////////////////////////////////////
	...
	cMsg+='	<div id="titulo">'
	cMsg+='				<h1 class="titulo-topo"> PEDIDO DE COMPRA APROVADO</h1>'
...
//Desconecta do servidor
	...
	msginfo('Aviso de pedido APROVADO enviado paro o e-mail ' + cEmail + '.','Westech')
