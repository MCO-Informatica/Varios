...
User Function Booking()


	Local oReport := nil
	Local cPerg:= Padr("Booking",10)
...
Static Function RptDef(cNome)
	...
	TRCell():New(oSection2,"TMP_CONTRATO"	,"TRBSGC","Contrato"										,"@!"				,26)
	...
	TRCell():New(oSection2,"TMP_PAIS"		,"TRBSGC","Pais"											,"@!"				,8)
	...
	TRCell():New(oSection2,"TMP_MGCONTR"	,"TRBSGC","Margem" + Chr(13) + Chr(10) + "Contrib."			,"@E 999.99"		,12,,,,,"CENTER")
	TRCell():New(oSection2,"TMP_XPCOM"		,"TRBSGC","%" 	   + Chr(13) + Chr(10) + "Comis."			,"@E 999.99"		,12,,,,,"CENTER")
...
Static Function ReportPrint(oReport)
	...
	cQuery += "	CTD_XEQUIP AS 'TMP_OPUNIT', CTD_XVDSI AS 'TMP_XVDSI', CTD_XCUSTO AS 'TMP_CUSTOPR', CTD_XCUTOT AS 'TMP_CUSTOT', "
