...
User Function relat025()
	Local oReport := nil
	Local cPerg:= Padr("RELAT025",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Relatório Apontamento Horas por Usuário (NÃO APROVADAS)",cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
...
Static Function ReportPrint(oReport)
	...
	While !Eof()
		...
		IncProc("Imprimindo Apontamento de Horas (NÃO APROVADAS "+alltrim(TRBAPT->TMP_COLAB))
