...
User Function relat029()
	Local oReport := nil
	Local cPerg:= Padr("RELAT029",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Relatório Apontamento Horas por Contrato (APROVADAS)",cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	oReport:SetPortrait()    
...
Static Function ReportPrint(oReport)
	...
	While !Eof()
		...
		IncProc("Imprimindo Apontamento de Horas (APROVADAS) "+alltrim(TRBAPT->TMP_CONTRATO))
