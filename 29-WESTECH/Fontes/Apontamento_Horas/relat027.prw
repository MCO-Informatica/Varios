...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Relatório Apontamento Horas por Usuário (Geral) " + Substr(DTOS(MV_PAR05),7,2) + "/" + Substr(DTOS(MV_PAR05),5,2) + "/" + Substr(DTOS(MV_PAR05),1,4) + " até " +  Substr(DTOS(MV_PAR06),7,2) + "/" + Substr(DTOS(MV_PAR06),5,2) + "/" + Substr(DTOS(MV_PAR06),1,4),cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
...
static function ajustaSx1(cPerg)
	...
	putSx1(cPerg, "10", "Tarefa até?"	  	  , "", "", "mv_ch10", "C", 02, 0, 0, "G", "", "ZZ", "", "", "mv_par10")
