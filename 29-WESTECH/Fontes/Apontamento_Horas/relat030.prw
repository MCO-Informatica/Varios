...
User Function relat030()
	Local oReport := nil
	Local cPerg:= Padr("RELAT030",10)
...
Static Function RptDef(cNome)
	...
	oReport := TReport():New(cNome,"Relatório Apontamento Horas por Contrato (GERAL)",cNome,{|oReport| ReportPrint(oReport)},"Descrição do meu relatório")
	oReport:SetPortrait()    
...
Static Function ReportPrint(oReport)
	...
	While !Eof()
		...
		IncProc("Imprimindo Apontamento de Horas (GERAL) "+alltrim(TRBAPT->TMP_CONTRATO))
