...
oProcess:oHtml:ValByName("usuario","Fernanda")
...
// Informe o endereço eletrônico do destinatário.
oProcess:cTo := "ricardo.souza@upduo.com.br"

//oProcess:ohtml:ValByName("usuario","Administrador")

oProcess:ohtml:ValByName("proc_link","http://18.231.100.240:8089/workflow/messenger/emp01/compras/" + cMailID + ".htm")
...
oProcess:cTo := _cMailcompr+";ricardo.souza@upduo.com.br"
