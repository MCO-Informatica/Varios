...
Static function rodape(cBody)
	...
	cRod += '<span style="font-size:9px;">This e-mail and any attachment is for authorised use by the intended recipient(s) only. It may contain proprietary material, confidential information and/or be subject to legal privilege. It should not be copied, disclosed to, retained or used by, any other party. If you are not an intended recipient then please promptly delete this e-mail and any attachment and all copies and inform the sender. Thank you.</span></p>'
	cRod += '<span style="font-size:9px;">Esse e-mail e/ou qualquer anexo &eacute; para uso autorizado apenas de seu(s) destinat&aacute;rio(s). Pode conter material propriet&aacute;rio, informa&ccedil;&atilde;o confidencial e/ou estar sujeito a privil&eacute;gio legal. N&atilde;o deve ser copiado, divulgado, retido ou usado por qualquer outra parte. Se voc&ecirc; n&atilde;o for o destinat&aacute;rio, por favor exclua imediatamente esse e-mail e qualquer anexo ou c&oacute;pias e notifique seu emissor. Obrigado.</span></p>'
	cRod += '</html>'
