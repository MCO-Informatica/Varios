...
Static Function RFAT093
	...
	Local Cabec1         := "Pedido TP Cliente  Nome Fantasia        Emissใo  Usuแrio Emitente                 Vendedor                         Cond.Pagamento                           Entrega            Grupo Vendas"
...
//Local aUsu := AllUsers()
	...
	Acabec := {"Pedido","Tipo","Cliente","Loja","Nome Fantasia","Emissใo", "Usuแrio Emitente","Nome Usuแrio", "Cod.Vendedor","Nome Vendedor","Cond.Pagamento",;
		"Data Entrega","Numero da OC","Grupo Vendas","Item","Produto","Descri็ใo","Quantidade","Estoque Disponivel","Saldo em Estoque","Moeda","Valor Unitario","Valor Total","Pricipal"}
