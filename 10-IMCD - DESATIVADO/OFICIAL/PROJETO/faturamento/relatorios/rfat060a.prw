...
±±ºPrograma  ³ RFAT060A  º Autor ³ Eneovaldo Roveri Jrº Data ³  21/12/09   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Relatorio de Margem de Contribuição                        º±±
±±º          ³ RFAT060A - CUSTOMIZAÇÃO DENIS, PARA TRAZER OS FRETES        º±±
...
MsgRun("Processando Relatório de Margem em excel, aguarde...","",{|| U_IMPR060A() })

Return

/*/
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
±±ºPrograma  ³ IMPR060A  º Autor ³ Eneovaldo Roveri Jrº Data ³  21/12/09   º±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
/*/
...
aadd(aCabec, {"Preço Seg." ,"N", 18, 4})
aadd(aCabec, {"Margem Seg." ,"N", 18, 4})
aadd(aCabec, {"Obs Aprovador" ,"C", 40, 0})
aadd(aCabec, {"Preco Liquido Tab.Preço" ,"N", 18, 4})
...
While !EOF()
	...
	If (MV_PAR15 == 3 .and. nMrgBrut <= 0) .or.; //imprimir somente os registros com margem bruta negativa
		...
		//Alterado por Marcos Andrade para não buscar da ZA4 Apos 25/01/2018
