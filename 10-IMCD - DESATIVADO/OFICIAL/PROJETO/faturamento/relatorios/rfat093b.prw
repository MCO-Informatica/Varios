...
User Function RFAT093B()
	...
	Local nLin           := 80
	Local cQuery         := ""
	Local Cabec1         := "Pedido TP Cliente Nome Fantasia                               Entrega     Nr Pedido Cliente Usuแrio Emitente   Vendedor                         Cond.Pagamento                                 Emissao      Grupo Vendas"
...
//============================================================================
	...
	cQuery += "  SC5.C5_NUM, SC5.C5_CLIENTE, SC5.C5_LOJACLI, SA1.A1_NREDUZ,SA1.A1_LOTEUNI, SA1.A1_FATVALI, SC5.C5_EMISSAO, SC5.C5_USERLGI, SC5.C5_VEND1, SA3.A3_NREDUZ, "
	cQuery += "  SE4.E4_DESCRI, SC5.C5_XENTREG, C5_GRPVEN, C5_DGRPVEN, SC6.C6_ITEM, SC6.C6_PRODUTO, SB1.B1_DESC, SC6.C6_QTDVEN, SC6.C6_XPRUNIT,"
	...
	cQuery += "  SC6.C6_XICMEST, SC6.C6_XPISCOF, SC6.C6_XMEDIO, SC6.C6_XTAXA, SB1.B1_CUSTD, SC6.C6_XVLRINF ,C6_NUMPCOM,C6_ITEMPC , C6_PEDCLI , C6_ITEMPED, "
...
//
	...
	If aReturn[8] == 1
		cQuery += "ORDER BY SC5.C5_NUM, SC6.C6_ITEM	, SC6.C6_LOCAL "
	Else
		cQuery += "ORDER BY SC5.C5_XENTREG, SC5.C5_NUM, SC6.C6_ITEM, SC6.C6_LOCAL"
	Endif
...
Static Function RunReport(Cabec1,Cabec2,Titulo,nLin)
	...
	*/
		...
		If (cAlias)->C5_NUM <> cNum  .or. nLin == 9
			...
			@nLin,007 PSAY (cAlias)->C5_NUM+" "+(cAlias)->C5_TIPO
...
//Local aUsu := AllUsers()
	...
	Acabec := {"Pedido","Tipo","Cliente","Loja","Nome Fantasia","Emissใo", "Nome Usuแrio", "Cod.Vendedor","Nome Vendedor",;
