...
ฑฑบPrograma  ณIMCDRH001 บAutor  ณCarlos Miranda      บ Data ณ  15/07/2016 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Rotina para compensar o Saldo do Banco de Horas.           บฑฑ
ฑฑบ          ณ Rodar ap๓s o Fechamento do Banco de Horas.                 บฑฑ
...
Static Function RunComp()
	If MSGBOX("Serแ iniciado agora o processo de compensa็ใo de horas. Deseja continuar?","Compensa็ใo de horas","YESNO")
		cProv := MV_PAR05
		cDesc := MV_PAR06
		cQuery := " SELECT * FROM "
		...
		EndDo
		QSPB->(DbCloseArea())
		MsgBox("Processo concluํdo com sucesso!","Ok","INFO")
	EndIf
...
Local j := 0
	...
	cPerg := PADR(cPerg,10)
	aRegs := {}
	AADD(aRegs,{cPerg,"01","Filial de ?",Space(20),Space(20),"mv_ch1","C",02,0,0,"G","","mv_par01","","","","","","","","","","","","","","","","","","","","","","","","","SMO","","","","","","",""})
	AADD(aRegs,{cPerg,"02","Filial ate ?",Space(20),Space(20),"mv_ch2","C",02,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","SMO","","","","","","",""})
	...
	AADD(aRegs,{cPerg,"08","Data Pagto at้ ?",Space(20),Space(20),"mv_ch8","D",08,0,0,"G","","mv_par08","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
