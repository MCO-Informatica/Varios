...
TRCell():New(oSection1,"D1_FILIAL"  ,"SD1",/*Titulo*/	,/*Picture*/, TamSX3("D1_FILIAL")[1]+5,/*lPixel*/,/*{|| code-block de impressao }*/)
...
If lVeiculo
	...
	IF !EMPTY(Alltrim(mv_par20))
		cWhereSB1 += " AND D1_FILIAL BETWEEN '"+Alltrim(mv_par19)+"' AND '"+Alltrim(mv_par20)+"' "
	ENDIF
	IF !EMPTY(Alltrim(mv_par16))
   		cWhereSB1 += " AND SB1.B1_X_PRINC BETWEEN '" + Alltrim(mv_par15) + "' AND '" + Alltrim(mv_par16) + "' "
	ENDIF
	IF !EMPTY(Alltrim(mv_par18))
    	cWhereSB1 += " AND SB1.B1_GRUPO BETWEEN '" + Alltrim(mv_par17) + "' AND '" + Alltrim(mv_par18) + "' "
	ENDIF	
    cWhereSB1 += "%"
Else
    cWhereSB1 := "%"
