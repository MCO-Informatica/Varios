...
User Function REST007()
	...
	//oLogTXT := EPLOGTXT():NEW( UPPER(ALLTRIM(FUNNAME())) , "REST007" , __cUserID )
...
Static Function ReportDef()
	...
	//³                                                                        ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oReport:= TReport():New("MATR820",cTitle,"MTR820", {|oReport| ReportPrint(oReport, cAliasTop)},OemToAnsi("Este programa ira imprimir a Rela‡„o das Ordens de Produ‡„o Mec-Tubo"))
	...
	//³ Sessao 1 (oSection1)                                         ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oSection1 := TRSection():New(oReport,"Ordems de Producao",{"SC2","SB1","SC5","SA1"},aOrdem) // "Ordens de Produção"
	...
	TRCell():New(oSection1,'Emissao'   	,'SC2',"Emissao"   ,PesqPict("SC2","C2_DATPRI"),TamSX3("C2_DATPRI")[1],/*lPixel*/,{|| dDataBase })
	...
	TRCell():New(oSection1,'C2_QUANT'	,'SC2',"Quant"   ,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	TRCell():New(oSection1,'OpQuant'  	,'SC2',"op quant"   ,PesqPict("SC2","C2_QUANT"),TamSX3("C2_QUANT")[1],/*lPixel*/,{|| (cAliasTop)->C2_QUANT - (cAliasTop)->C2_QUJE })
	...
	//³ Sessao 2 (oSection2)                                         ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oSection2 := TRSection():New(oSection1,"Empenhos",{"SD4","SB1"},/*Ordem*/) //"Empenhos"
	oSection2:SetHeaderBreak()
	oSection2:SetReadOnly()

	TRCell():New(oSection2,'D4_COD'	 	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'B1_DESC' 	,'SB1',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.F./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_QUANT' 	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'B1_UM'   	,'SB1',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_LOCAL'	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'B2_LOCALIZ'	,'SB2',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_TRT'  	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_LOTECTL'	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_NUMLOTE'	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)
	TRCell():New(oSection2,'D4_OP'  	,'SD4',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign*/,/*lCellBreak*/,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/)

	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	//³ Sessao 3 (oSection3)                                         ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	oSection3 := TRSection():New(oSection1,"Operacoes",{"SG2","SH8","SH1","SH4"},/*Ordem*/) //"Operações"
	...
	TRCell():New(oSection4,'IniAloc'	,'SH8',"INI ALOC"   ,'@!'  , 24        ,/*lPixel*/,{|| " ____/ ____/____ ___:___" })
	TRCell():New(oSection4,'FimAloc'	,'SH8',"FIM ALOC"   ,'@!'  , 24        ,/*lPixel*/,{|| " ____/ ____/____ ___:___" })
	TRCell():New(oSection4,'H8_QUANT'	,'SH8',/*Titulo*/,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
	TRCell():New(oSection4,'QtdeProd'	,'SH8',"Quant.prod"   ,/*Picture*/, 12       ,/*lPixel*/,{|| Space(12) })
	TRCell():New(oSection4,'QtdPerda'	,'SH8',"Quant Perda"   ,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| Space(12) })
...
Static Function ReportPrint(oReport, cAliasTop)
	...
	ElseIf !oReport:oPage:IsLandScape()
		...
		oSection2:Cell("D4_NUMLOTE"):SetTitle("NUM LOTE")
	EndIf
	...
	While !oReport:Cancel() .And. !(cAliasTop)->(Eof())
		...
		oReport:SetTitle("        O R D E M   D E   P R O D U C A O       NRO :"+(cAliasTop)->(C2_NUM+C2_ITEM+C2_SEQUEN+C2_ITEMGRD)) //"        O R D E M   D E   P R O D U C A O       NRO :"
...
Static Function MR820Desc(oReport, cAliasTop)
	...
	If (mv_par07 <> 2) .And. lSB1Desc
		...
		If SB1->( dbSeek(xFilial("SB1")+(cAliasTop)->C2_PRODUTO) )
			...
			oSection1:Cell("B1_DESC"):SetValue(AllTrim(SB1->B1_DESC))
		EndIf
	EndIf
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
*/
Static Function MTR820R3()
	Local titulo  := "Ordens de Producao"
	Local cString := "SC2"
	Local wnrel   := "MATR820"
	Local cDesc   := "Este programa irá imprimir a Rela‡„o das Ordens de Produ‡„o conforme layout "+SM0->M0_NOMECOM
...
Static Function R820Imp(lEnd,wnRel,titulo,tamanho)
	...
	While !Eof()
		...
		For I := 2 TO Len(aArray)
			...
			dbGotop()
			do While !Eof()
				If LB2->LB2_COD == aArray[I][1]
					cTanque := "Tanque " + Substr(LB2->LB2_TANQUE,5,2)
					Exit
				Endif
				dbSkip()
			Enddo

			If Empty(cTanque) .and. !Empty(aArray[I][10])
				cTanque := "T0"
			Endif

			@Li ,   0 PSay aArray[I][1]    	 				   		// CODIGO PRODUTO
			For nBegin := 1 To Len(Alltrim(aArray[I][2])) Step 52  // DESCRICAO
				@li,016 PSay Substr(aArray[I][2],nBegin,52)
				li++
			Next nBegin
			Li--
			cQtd := Alltrim(Transform(aArray[I][5],PesqPictQt("D4_QUANT",TamSX3("D4_QUANT")[1])))
			@Li , (88-Len(cQtd))-10 PSay cQtd						// QUANTIDADE
			@Li ,  80 PSay aArray[I][4]						  		// UNIDADE DE MEDIDA
			@li ,  83 PSay aArray[I][6]		                  		// ALMOXARIFADO
			@li ,  86 PSay cTanque					         		// LOCALIZACAO
			@li ,  96 PSay aArray[I][8]     	             		// SEQUENCIA
			@li , 103 PSay aArray[I][10]			   	 			// LOTE
			@li , 115 PSay Dtoc(Posicione("SB8",3,xFilial("SB8")+aArray[I][1]+"01"+aArray[I][10],"B8_DTVALID"))
			@li , 125 PSay Dtoc(Posicione("SB8",3,xFilial("SB8")+aArray[I][1]+"01"+aArray[I][10],"B8_DFABRIC"))
		...
		Li++
		Li++
		@Li,  00 PSay "Liberação Produção: __________________________________________________________"
		Li++
		Li++
		Li++
		@Li,  00 PSay "Recebimento Armazémo: ________________________________________________________"
		Li++
		Li++
		Li++
		@Li,  00 PSay "Finalização PCP:______________________________________________________________"
		Li++
...
Static Function AddAr820(nQuantItem)
	...
	dbSelectArea("SD4")
	AADD(aArray, {SB1->B1_COD,cDesc,SB1->B1_TIPO,SB1->B1_UM,nQuantItem,D4_LOCAL,D4_OPORIG,D4_TRT,cRoteiro,If(mv_par12 == 1,D4_LOTECTL,""),If(mv_par12 == 1,D4_NUMLOTE,"") } )
...
Static Function CabecOp(Tamanho)
	...
	Local cCabec1 := SM0->M0_NOME+If(mv_par12 == 2,"O R D E M   D E   P R O D U C A O  "," NRO :")	//"        O R D E M   D E   P R O D U C A O       NRO :"
	Local cCabec2 := "I T E N S   E M P E N H A D O S"
	Local cCabec3 := "CODIGO          DESCRICAO                                           QUANTIDADE  UM AM ENDERECO  SEQ   LOTE        DATA VAL  DATA FAB"
	//                                                                                                                                             XX/XX/XX  XX/XX/XX
	...
	@Li,42+20 PSay "INICIO              F I M"
	Li++
	@Li,00 PSay "Unid. Medida"+aArray[1][4]			//"Unid. Medida : "
	@Li,42+20 PSay "prev" +DTOC((cAliasTop)->C2_DATPRI)	//"Prev. : "
	@Li,62+20 PSay "Prev" +DTOC((cAliasTop)->C2_DATPRF)	//"Prev. : "
	Li++
	@Li,00 PSay "C.Custo: "+(cAliasTop)->C2_CC				//"C.Custo: "
	@Li,42+20 PSay "Ajuste: "+DTOC((cAliasTop)->C2_DATAJI)	//"Ajuste: "
	@Li,62+20 PSay "Ajuste: "+DTOC((cAliasTop)->C2_DATAJF)	//"Ajuste: "
	Li++
...
Static Function ImpRot(lSH8)
	...
	@Li,08 PSay SG2->G2_FERRAM // +" "+SUBS(SH4->H4_DESCRI,1,20)
	//@Li,61 PSay SG2->G2_OPERAC
	@Li,17 PSay SG2->G2_OPERAC

	lPrim:=.T.

	For nBegin := 1 To Len(Alltrim(SG2->G2_DESCRI)) Step 90
		@li,20 PSay Substr(SG2->G2_DESCRI,nBegin,90)
		li++
		If lPrim
			lPrim := .F.
			//		@li, 07 PSAY "CC: " + Posicione("CTT",1,xFilial("CTT") + SH1->H1_CCUSTO,"CTT_DESC01")
		Endif
...
Static Function cRotOper()
	...
	Local cCabec2 := "RECURSO FERRAM   OPERACAO"
