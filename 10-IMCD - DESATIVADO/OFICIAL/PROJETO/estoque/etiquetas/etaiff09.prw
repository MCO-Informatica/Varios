...
While (cAliasNew)->(!Eof()) 
	...
	nQtdEtq := 	(cAliasNew)->D2_QUANT / SB1->B1_QE
...
//Produto
	...
	MSCBSAY(040,033,"P.Liquido: " + ALLTRIM(STR( (cAliasNew)->D2_QUANT / nQtdEtq ))+" "+ALLTRIM(SB1->B1_UM),"N","0","025,028")

	If SB1->B1_PESBRU > 0 .and. SB1->B1_PESO > 0
   		MSCBSAY(073,033,"P.Bruto: " + ALLTRIM(STR( ((cAliasNew)->D2_QUANT*(SB1->B1_PESBRU/SB1->B1_PESO)) / nQtdEtq))+" "+ ALLTRIM(SB1->B1_UM),"N","0","025,028") 
	Else
   		MSCBSAY(073,033,"P.Bruto: " + ALLTRIM(STR((cAliasNew)->D2_QUANT / nQtdEtq ))+" "+ALLTRIM(SB1->B1_UM),"N","0","025,028") 
	Endif
