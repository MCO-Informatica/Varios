...
±±?Geronimo     ?6/02/06?93518³correção consiste em que nas vendas efe   ³±?
	...
	If mv_par01 != 3
		...
		While !Eof() .And. (SE1->E1_CLIENTE >= mv_par03 .And. SE1->E1_CLIENTE <= mv_par04)
			...
			If SE1->E1_CLIENTE >= mv_par03 .And. SE1->E1_CLIENTE <= mv_par04
				...
				//ÚÄÄÄÄÄÄÄÄÄÄÄÄADVÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ?
...
±±ºPrograma  ?IMCDSaldo ºAutor  ?Luiz Oliveira  ?Data ? 02/02/16      º±?
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±?
±±ºDescricao ?Refaz o maior saldo baseado no histórico do cliente        º±?
...
ValTotal := 0	
	If Inicio = 1 
		...
		vValor := xMoeda(XE1->E1_VALOR,XE1->E1_MOEDA,nMoedaF,date(),3,XE1->E1_TXMOEDA)  //data sem variação cambial
