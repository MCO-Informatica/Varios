...
/**
 * Instance for JsonBld
 * @class JsonBld
 * @method New
 * @return JsonBld
 */
Method New() Class JsonBld
    ::aKeys   := { }
    ::aValues := { }
    Return Self
 ...
 * @return Nil
 */
Method Set( cKey, xValue ) Class JsonBld
 ...
 * @return JSONParser
 */
Method New( xStream ) Class JSONParser2
    ::xStream   := xStream
    ::nIndex    := 1
    ::lHasError := .F.
    Return Self
 ...
 * @return Logic
 */
Method IsJSON() Class JSONParser2
    Return .T.
 ...
 * @class JSONParser
 * @method Object
 * @return JsonBld | Array
 */
Method Object() Class JSONParser2
    If ::IsJSON()
        Return ::xAST
    EndIf
 ...
 * @return JSONParser
 */
Method Parse() Class JSONParser2
    // Capture syntax error from the lexer. Our parser is also a functor,
    // being data Parser = Maybe JsonBld | JSONSyntaxError
 ...
 * @return JsonBld
 */
Method _Object() Class JSONParser2
    Local oObject := JsonBld():New()
    Local cKey
    Local xValue
 ...
 * @return Array
 */
Method _Array() Class JSONParser2
    Local aResults := { }
    Local xValue
 ...
 */
Method _Value() Class JSONParser2
...
Method Parse() Class JSON
    ...
    xResult := JSONParser2():New( aLexer )
