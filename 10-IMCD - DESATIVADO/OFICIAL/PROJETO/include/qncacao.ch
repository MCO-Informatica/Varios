...
#ELSE
   #IFDEF ENGLISH
         ...
         #define STR0003  "Yea+Correct.Action+Review"
         #define STR0004  "Correct.Action+Review"
   ...
   #ELSE
         #define STR0001  "Relatorio de Acoes Corretivas."
         #define STR0002  "Ser  impresso de acordo com os parametros solicitados pelo usuario."
         #define STR0003  "Ano+Acao Corretiva+Revisao"
         #define STR0004  "Acao Corretiva+Revisao"
         #define STR0005  "Zebrado"
         #define STR0006  "Administra‡„o"
         #define STR0007  "ACOES CORRETIVAS"
         ...
         #define STR0019  "Data Encerramento: "
         #define STR0020  "Acao "
         ...
         #define STR0029  "Ficha Nao Conformidades Relacionadas"
