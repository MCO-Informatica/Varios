	...
	#define STR0006 "Prf-Numero         Fact-e  Codigo Tda  Nomb del Cliente     TP  Modalidad  Fch. de    Vencim.    Vencim.    Banco Valor Original"
	...
	#define STR0023 "ANULADO POR EL OPERADOR"
		...
		#define STR0006 "Prf-Number         NF-e    StoreCode   Customer name        TP  Class      Due date              Due date   Bank  Original Amnt."
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Prf-número         Factura-e    Código Lj.   Nome Do Cliente      Tp.  Natureza   Data De    Venct.     Venct.     Base Valor Original", "Prf-Numero         NF-e    Codigo Lj   Nome do Cliente      TP  Natureza   Data de    Vencto     Vencto     Banco Valor Original" )
