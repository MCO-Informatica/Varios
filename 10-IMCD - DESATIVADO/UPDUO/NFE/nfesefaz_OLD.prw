			...
			Else
	          ...
	          // Posiciono na TES do cupom fiscal para pegar a natureza de operação da nf sobre cupom
						...
						aadd(aProd,	{Len(aProd)+1,;
							cCodProd,;
							"",;//IIf(Val(SB1->B1_CODBAR)==0 .OR. cEmpAnt =='02',"",StrZero(Val(SB1->B1_CODBAR),Len(Alltrim(SB1->B1_CODBAR)),0)),;
							cDescProd,;
		...
		Else				
			...
			#IFDEF TOP
				...
				BeginSql Alias cAliasSD1			
						...
						D1_VUNIT,D1_CLASFIS,D1_VALICM,D1_TIPO_NF,D1_PEDIDO,D1_ITEMPC,D1_VALIMP5,D1_VALIMP6,D1_BASEIRR,D1_VALIRR, D1_LOTECTL, D1_DFABRIC,D1_DTVALID, 
