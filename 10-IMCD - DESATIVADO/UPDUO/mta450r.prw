...
User Function MTA450R()
	...
	IF _lOk
		...
		IF !Empty(cEmailPa) .or. !Empty(cEmailCC)
			...
			cTextoEmail := U_SC5WF1(SC5->C5_NUM,SC5->C5_CLIENTE,SC5->C5_NOMECLI,SC5->C5_LOJACLI, _cObs, cStatus)
...
User Function SC5WF1(cNum,cCliente,cNome,cLoja,cMotivo)
