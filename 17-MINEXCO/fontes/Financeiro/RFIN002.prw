...
±±ºPrograma  ³ RFIN002  º Autor ³ CM                 º Data ³  21/10/06   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Rotina de Impressçao de Faturas a Receber                  º±±
...
If Found()
	...
	While E1_NUM >= mv_par01 .and. E1_NUM <= mv_par02 .And. E1_PREFIXO == mv_par03 .and. !Eof() 
		If E1_FATURA == "NOTFAT"
			...
			//buscar os Títulos que compoem esse fatura e imprimi-los
