...
***************************
	...
	oPrint:Say( 0760, 1400, "Peso Líquido:",oFont3c,100 )
...
Static Function FinalPed()
	...
	//oPrint:Say( 2080, 0060, 'Condições Gerais de Fornecimento:',oFont9,100 )
	oPrint:Say( 1780, 0060, 'Condicoes Gerais de Fornecimento:',oFont9,100 )
	oPrint:Say( 1810, 0060, "1. Confirmacao do pedido: Pedidos verbais não serao aceitos. O pedido somente ser confirmado por formulario proprio do cliente ou atraves da retransmissão do orcamento enviado com a aprovação do responsavel pela compra;",oFont7,100 )
	//oPrint:Say( 1840, 0060, "   retransmissão do orçamento enviado com a aprovação do responsável pela compra;",oFont7,100 )
	...
	oPrint:Say( 1870, 0060, "3. Para condicao de pagamento antecipado, feitos via depósito em conta: mandar comprovante via  e-mail, junto com o pedido;. ",oFont7,100 )
	...
	//oPrint:Say( 1990, 0060, "   Caso não ocorra o recebimento no prazo estabelecido, contatar o Dept Financeiro da empresa, para solicitar o envio da segunda via do boleto",oFont7,100 )
	...
	oPrint:Say( 1960, 0060, "5. O Pedido de Compra deve citar o Nº Proposta/Revisão para que todo o processo possa ser rastreado.;",oFont7,100 )

	//diferença de 20 do ultimo
