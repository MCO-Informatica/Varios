...
***************************
	...
	*/
	...
	//cStatus := 'Proposta em Aberto'
	//If SCJ->CJ_STATUS=="A" 
	//	cStatus := 'Proposta em Aberto'
	//ElseIf SCJ->CJ_STATUS=="B" 
	//	cStatus := 'Proposta Baixada'
	//ElseIf SCJ->CJ_STATUS=="C" 
	//	cStatus := 'Proposta Cancelada'
	//Endif
	...
	//oPrint:Say( 0880, 1200, "PRAZO FABRICA??O:",oFont3c,100 )
...
Private lCheck1 		:= .F.
Private lCheck2 		:= .f.
Private cAssunto   		:= 'Pedido de Vendas - No. ' + SC5->C5_NUM


cCC := UsrRetMail(RetCodUsr())
cAnexos:=cAnexo
cDestino := "/system/emailanexos/"
CPYT2S(cAnexos,cDestino,,.t.)
