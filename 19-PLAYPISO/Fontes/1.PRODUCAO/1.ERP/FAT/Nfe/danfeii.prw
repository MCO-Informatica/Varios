...
//#DEFINE MAXITEMC   038                                              // Máxima de caracteres por linha de produtos/serviços  - substituido pela linha abaixo Luiz Henrique 25/03/2015
#DEFINE MAXITEMC   050                                                // Máxima de caracteres por linha de produtos/serviços   // LUIZ HENRIQUE 25/03/2015
...
//#DEFINE MAXVALORC  009											  // Máximo de caracteres por linha de valores numéricos - substituido pela linha abaixo - Luiz Henrique 25/03/2015
#DEFINE MAXVALORC  012                                                // Máximo de caracteres por linha de valores numéricos     // LUIZ HENRIQUE 25/03/2015
...
/*****************  CUSTOMIZAÇÃO UPDUO - MARCOS GOMES 10/02/2022 *********************************/
User Function Prt2NfeSef(cIdEnt, oDanfe, lExistNFe	)
	...
	RPTStatus( {|lEnd| DANFEProc(@oDanfe, @lEnd, cIDEnt, Nil, Nil, @lExistNFe, .f./*lIsLoja*/)}, "Imprimindo DANFE..." )
...
oDanfe:Say(450, nAuxH + 2, "DESCRIÇÃO DO PROD./SERV.", oFont07N:oFont)    // ALTERADO DE oFont08N para oFont07N  - luiz henrique 25/03/2015
nAuxH += aTamCol[2]
...
For nY := 1 To nLenItens
	...
	If lflag
		If nL > nMaxItemP2
			...
			oDanfe:Say(171+nLinhavers, nAuxH + 2, "DESCRIÇÃO DO PROD./SERV.", oFont07N:oFont)   //// ALTERADO DE oFont08N para oFont07N  - luiz henrique 25/03/2015 
			nAuxH += aTamCol[2]
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		oDanfe:Say(171, nAuxH + 2, "DESCRIÇÃO DO PROD./SERV.", oFont07N:oFont) //// ALTERADO DE oFont08N para oFont07N  - luiz henrique 25/03/2015 
		nAuxH += aTamCol[2]
	...
	Else
		...
		nAuxH += aTamCol[1]
		oDanfe:Say(nLinha, nAuxH + 2, aAux[1][2][nY], oFont07:oFont) // DESCRICAO DO PRODUTO      // ALTERADO DE oFont08N para oFont07N  - luiz henrique 25/03/2015 henrique
		nAuxH += aTamCol[2]
...
if lFirsFolha
	oDanfe:Say(nRow2, nAuxH + 2, "DESCRIÇÃO DO PROD./SERV.", oFont07N:oFont)  //// ALTERADO DE oFont08N para oFont07N  - luiz henrique 25/03/2015
endif
nAuxH += aTamCol[1]
