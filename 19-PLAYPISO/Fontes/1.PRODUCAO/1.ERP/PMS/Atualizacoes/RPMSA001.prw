...
ฑฑบPrograma  ณRPMSA001  บAutor  ณAlexandre Sousa     บ Data ณ  09/27/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณChamada da funcao padrao de manutencao de orcamentos        บฑฑ
ฑฑบ          ณchama antes o lembrete do vendedor.                         บฑฑ
...
User Function RPMSA001(cAlias, nReno, nopc)
	...
	While l_alterou
		...
		If DbSeek(xFilial('SA3')+__cuserid)
			...
			FGEN008(c_query , {{"ORCAMENTO", "CLIENTE", "DESCRICAO", "DATA"}, {"AF1_ORCAME", "AF1_CLIENT", "AF1_DESCRI", "DATA"}}, "Atualiza็ใo de Or็amentos", 1)
...
Static Function gravatudo()
	...
	If d_dtRet >= dDataBase + 61  
		msgalert('A data de retorno nใo pode ser maior que 60 dias !!', "A T E N ว ร O")
		Return .F.
	EndIf
	If Empty(c_texto)
	...
	If c_termom $ GetMV("LP_STNAPRV")  //status da tabela ZA1 que ira atribuir a fase 05
		Return(MsgBox("Serแ atribuํda esta proposta a fase 05-PROP. NAO APROVADA. Manter este STATUS ?","STATUS","YESNO"))
	EndIf	
