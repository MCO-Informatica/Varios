...
ฑฑบPrograma  ณMT120ALT  บAutor  ณAlexandre Sousa     บ Data ณ  11/08/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณPonto de entrada durante a manutencao do pedido de compras  บฑฑ
ฑฑบ          ณutilizado para validar a aprovacao finanaceira do mesmo.    บฑฑ
...
User Function MT120ALT()
	...
	/*If SC7->C7_CONAPRO = 'L'
		msgAlert('O pedido de compras encontra-se aprovado.', 'A T E N ว รO')
		Return .F.
	EndIf*/
	
	If SC7->C7_XSTATFI = 'P'
		msgAlert('O pedido de compras encontra-se pendente de libera็ใo financeira. Favor solicitar a libera็ใo do mesmo ao responsแvel.', 'A T E N ว รO')
		Return .F.
	EndIf
