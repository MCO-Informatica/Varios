...
±±ºPrograma  ³PMSXCUST  ºAutor  ³Alexandre Sousa     º Data ³  10/26/10   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Ponto de entrada durante o calculo do custo do orcamento.   º±±
±±º          ³utilizado para acertar os valores zerados.                  º±±
...
//	DbSetOrder(1) //AF2_FILIAL, AF2_ORCAME, AF2_TAREFA, AF2_ORDEM, R_E_C_N_O_, D_E_L_E_T_
	...
	While AF2->(!EOF()) .and. AF2->AF2_FILIAL = xFilial('AF2') .and. AF1->AF1_ORCAME = AF2->AF2_ORCAME
		...
		If l_prim
			...
			AF2->AF2_TOTAL := AF2->AF2_CUSTO+AF2->AF2_VALBDI // + AF1->AF1_VALBDI
			AF2->(MsUnLock())
			AF2->(DbSkip())		
			l_prim := .F.
		EndIf           
