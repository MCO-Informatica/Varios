//#INCLUDE "FINR150.CH"
		...
		//#define STR0006  "Codigo-Nome do Fornecedor PRF-Numero           Tp  Natureza      Descricao                    Data de   OBRA      Descricao da Obra       |   Vencto    Valor Original   | Titulos a vencer |Dias  Historico(Vencidos+Vencer)"   // alteração do layout para nao aparecer portador nem vlr juros ou permanencia - luiz henrique 27/08/2012
		...
		#define STR0006  "Codigo-Nome do Fornecedor PRF-Numero           Tp  Natureza      Descricao                    OBRA      Descricao da Obra       |Venct       Vencto   Difer  Valor Original   | Titulos a vencer |Historico(Vencidos+Vencer)"   // alteração do layout para nao aparecer portador nem vlr juros ou permanencia - luiz henrique 27/08/2012
		...
		#define STR0033  "                                                                                                                     |        Titulos vencidos         | Titulos a vencer |                         (Vencidos+Vencer)"// alteração do layout para nao aparecer portador nem vlr juros ou permanencia - luiz henrique 27/08/2012
...
//	oReport:PrintDialog()
//Else
FINR150R3() // Executa versão anterior do fonte
//Endif
...
While SM0->(!Eof()) .and. SM0->M0_CODIGO == cEmpAnt .and. SM0->M0_CODFIL <= cFilAte
	...
	#IFDEF TOP
		...
		if TcSrvType() != "AS/400"
			cQuery := "SELECT *,ED_DESCRIC,CTT_DESC01 "                 // incluido ed_descric e CTT_DESC01 para imprimir a descrição da natureza e descricao da OBRA - luiz henrique 22/05/2013
...
While !Eof() .and. M0_CODIGO == cEmpAnt .and. M0_CODFIL <= cFilAte
	...
	SetRegua(nTotsRec)
/*	  LH  comentado para trazer as informações ordenando por natureza 14/09
//	If MV_MULNATP .And. nOrdem == 2
	...
	While &cCond1 .and. !Eof() .and. lContinua .and. E2_FILIAL == xFilial("SE2")
		...
		While &cCond2 == cCarAnt .and. !Eof() .and. lContinua .and. E2_FILIAL == xFilial("SE2")
            ...
            EndIf
				...
				@li, 51  PSAY SE2->E2_NATUREZ+ED_DESCRIC // alterado para imprimir a descrição da natureza - luiz henrique 27/08/2012
...
AADD(aRegs,{cPerg,	"37","Obra"     ,"¿Tit. Emision Futura ?"       ,"Future issue bill ?"  ,"MV_CHV",        "C",          9,         0,         9,"G" ,"","mv_par37"  ,""             ,""             ,""         ,""         ,"",""           , ""             , ""           ,"","",         "",          "",            "","","",         "",          "",            "","","",         "",          "",            "","",   "CTT","S",    "","","","" }) 
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
/*  //LH - comentado para trazer as informações ordenado por natureza 14/09/15
	...
	While E2_NATUREZ == cNatAnt .And. !Eof()
		...
		If nSaldo > 0
			...
			If mv_par20 == 1
				...
				@li, 47 PSAY E2_TIPO
				@li, 51 PSAY E2_NATUREZ+ED_DESCRIC // alterado para imprimir a descrição da natureza - luiz henrique 27/08/2012
