...
User Function MSBAR(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:= CBBARX():New(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:Draw()
Return                            
User Function MSBAR2(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:= CBBARX():New(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:useOldCm2Pix:= .F.
   oBar:Draw()
Return                            
User Function MSBAR3(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:= CBBARX():New(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:useOldCm2Pix:= .F.
...
User Function MSBAR4(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:= CBBARX():New(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix)
   oBar:useOldCm2Pix:= .F.
// nrs da HP LaserJet 4 
   oBar:nVertRes:= 3720
...
MAT25
*/
Method New(cTypeBar,nRow,nCol,cCode,oPrint,lCheck,Color,lHorz,nWidth,nHeigth,lBanner,cFont,cMode,lPrint,nPFWidth,nPFHeigth,lCmtr2Pix) CLASS CBBARX
Local bBlock
...
If ValType(::cCode) =="A" 
   If ::cTypeBar <> "EAN128"
      ::cErro := "Obrigatorio o tipo ser EAN128"
   EndIf
...
Method CBCODE128() CLASS CBBARX // MELHORIAS: MECANISMO DE MUDANCA DO SUBSET E A OPCAO DE TER O BANNER
Local cCode    := ::cCode
Local cStart   := ''
Local cConteudo:= ''
Local cBarra   := ''
...
Method CBCODE3_9() CLASS CBBARX   // MELHORIAS: MECANISMO DE MUDANCA DO SUBSET E A OPCAO DE TER O BANNER
...
If Len(Alltrim(Str(Val(::cCode),12))) < 12
   ::cErro:="***Conteudo invalido para codigo EAN13***"  
EndIf
...
If Len(Alltrim(Str(Val(::cCode),nLen))) < nLen
   ::cErro:="***Conteudo invalido para codigo EAN8***"  
EndIf
...
If Len(Alltrim(Str(Val(::cCode),nLen))) < nLen
   ::cErro:="***Conteudo invalido para codigo UPCA***"  
EndIf
...
EndIf
If ! ::lHorz .and. (::lBanner .or. ! Empty(::cBanner) )
   // tramento especial somente ateh o objeto printer nao permitir rotacionar o texto     
   ::cErro:= "***Codigo de barras com Banner nao disponivel p/ vertical****"
EndIf    
...
Method FillBar(cConteudo,nIndice,nIniVertical) CLASS CBBARX
Local n, oBr
Local ac:= array(4)
Local nHeigth
Local nWidth           
...
Method TrataEan(aConteudo) CLASS CBBARX
...
Static Function CB128GS()
Return ">8"

Static Function CB128A()
Return ">7"

Static Function CB128B()
Return ">6"

Static Function CB128C()
Return ">5"
