...
||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
||+---------------------+-------------------------------+------------------+||
||| Programa: DBRROMAN  | Autor: Danilo Alves Del Busso | Data: 09/10/2015 |||
||+-----------+---------+-------------------------------+------------------+||
||| Descricao | Relatorio de Romaneio por Nota Fiscal                      |||
||+-----------+------------------------------------------------------------+||
||| Alteracao | 										| Data: 		   |||
||+-----------+------------------------------------------------------------+||
||| Descrição | 														   |||
...
==============================================================================
*/
User Function DBRROMAN()

Local oReport
Local cTitulo1 := "Relatorio de Romaneio por Nota Fiscal"
Local cTitulo2 := "Relatorio de Romaneio por Nota Fiscal"
Private cEof   := Chr(13) + Chr(10)
Private cCodVenPg := U_CFMPGVEN()

oReport := TReport():New("DBRROMAN", cTitulo1, "DBRROMAN", {|oReport| PrintReport(oReport)}, cTitulo2)
oReport:SetLandScape() //Retrato
oReport:SetTotalInLine(.F.)
oReport:ShowHeader()


PutSX1("DBRROMAN","01","Emissao de ?   ","","","MV_CHA","D",08,0,0,"G","",""   ,"","","MV_PAR01",""       ,"","","",""       ,"","","",""        ,"","","",""      ,"","","",""       ,"","")
PutSX1("DBRROMAN","02","Emissao ate ?  ","","","MV_CHB","D",08,0,0,"G","",""   ,"","","MV_PAR02",""       ,"","","",""       ,"","","",""        ,"","","",""      ,"","","",""       ,"","")
...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
||+-----------------------+------------------------------+------------------+||
||| Programa: PrintReport | Autor: Danilo Alves Del Busso| Data: 09/10/2015 |||
||+-----------+-----------+------------------------------+------------------+||
||| Descricao | Relatorio de Romaneio por Nota Fiscal                       |||
||+-----------+-------------------------------------------------------------+||
||| Alteracao |                                                             |||
...
//CONTEUDO DO RELATORIO ACREDITO
...
cQuery += "    AND F2_EMISSAO BETWEEN '"+dTos(MV_PAR01)+"' AND '"+dTos(MV_PAR02)+"'  " + cEof 
//cQuery += "    AND F2_DOC IN ('000005591','000005845')                               " + cEof 
...
While !SF2TMP->(Eof())
	...
	oSection2:Cell("VALREAL"):SetValue(SF2TMP->(VLRTOTAL-DESCZFR))
	oSection2:Cell("VALDOLA"):SetValue(SF2TMP->((VLRTOTAL-DESCZFR)/TXDOLAR))
