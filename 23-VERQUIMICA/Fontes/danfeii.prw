...
#DEFINE HMARGEM    030
#DEFINE VMARGEM    030
#DEFINE MAXITEM    015                                                // Máximo de produtos para a primeira página
...
Private aCertificados := {} // Vetor Com certificados Localizados na QEK
...
If Len(aCertificados) > 0                     
	MsAguarde({|| U_XQier050(.F.,aCertificados) },"Processando Certificados...","Aguarde... ")
Endif
...
User Function DanfeProc(oDanfe,lEnd,cIdEnt,cVal1,cVal2,lExistNfe)
...
For nZ := 1 To nLenDet
	...
	// Localiza Registro do Item da Danfe na Tabela SD2

	If SD2->(dbSetOrder(3), dbSeek(xFilial("SD2")+SF2->F2_DOC+SF2->F2_SERIE+SF2->F2_CLIENTE+SF2->F2_LOJA+AllTrim(SubStr(oDet[nX]:_Prod:_cProd:TEXT,1,nMaxCod))))
		If QEK->(dbSetOrder(6),dbSeek(xFilial("QEK")+SD2->D2_LOTECTL))
			AAdd(aCertificados,{QEK->QEK_FORNEC,;
								QEK->QEK_LOJFOR,;
								QEK->QEK_PRODUT,;
								QEK->QEK_DTENTR,;
								QEK->QEK_LOTE,;
...
oDanfe:Box(043,000,053,501)
oDanfe:Say(049, 002, "RECEBEMOS DE "+NoChar(oEmitente:_xNome:Text,lConverte)+" OS PRODUTOS CONSTANTES DA NOTA FISCAL INDICADA AO LADO", oFont07:oFont)
oDanfe:Box(052,000,080,101)
oDanfe:Say(059, 002, "DATA DE RECEBIMENTO", oFont07N:oFont)
oDanfe:Box(052,100,080,500)
oDanfe:Say(059, 102, "IDENTIFICAÇÃO E ASSINATURA DO RECEBEDOR", oFont07N:oFont)
oDanfe:Box(043,500,080,603)
oDanfe:Say(050, 542, "NF-e", oFont08N:oFont)
oDanfe:Say(060, 510, "N. "+StrZero(Val(oIdent:_NNf:Text),9), oFont08:oFont)
oDanfe:Say(070, 510, "SÉRIE "+oIdent:_Serie:Text, oFont08:oFont)


//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Quadro 1 IDENTIFICACAO DO EMITENTE                                      ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Box(089.2,000,184.2,250)
oDanfe:Say(099.2,098, "Identificação do emitente",oFont12N:oFont)
nLinCalc	:=	112.2
...
For nX := 1 To nForTo
	oDanfe:Say(nLinCalc,098,SubStr(cStrAux,Iif(nX==1,1,((nX-1)*24)),Iif(nX==1,23,25)), oFont12N:oFont )
	nLinCalc+=10                           
Next nX
...
oDanfe:Box(089.2,248,184.2,351)
oDanfe:Say(102.2,275, "DANFE",oFont18N:oFont)
oDanfe:Say(112.2,258, "DOCUMENTO AUXILIAR DA",oFont07:oFont)
oDanfe:Say(122.2,258, "NOTA FISCAL ELETRÔNICA",oFont07:oFont)
oDanfe:Say(132.2,266, "0-ENTRADA",oFont08:oFont)
oDanfe:Say(142.2,266, "1-SAÍDA"  ,oFont08:oFont)
oDanfe:Box(125.2,315,142.2,325)
oDanfe:Say(136.2,318, oIdent:_TpNf:Text,oFont08N:oFont)
oDanfe:Say(157.2,255,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont10N:oFont)
oDanfe:Say(167.2,255,"SÉRIE "+oIdent:_Serie:Text,oFont10N:oFont)
oDanfe:Say(177.2,255,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont10N:oFont)
...
If nfolha==1
	If lMv_Logod
		oDanfe:SayBitmap(092.2,005,cLogoD,090,090)
	Else
		oDanfe:SayBitmap(092.2,005,cLogo,090,090)
	EndIF
Endif
...
oDanfe:Box(089.2,350,135.2,603)
oDanfe:Box(122.2,350,157.2,603)
oDanfe:Say(142.2,355,TransForm(SubStr(oNF:_InfNfe:_ID:Text,4),"@r 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999 9999"),oFont12N:oFont)
oDanfe:Box(152.2,350,184.2,603)

If nFolha == 1
	oDanfe:Say(132.2,355,"CHAVE DE ACESSO DA NF-E",oFont12N:oFont)
	nFontSize := 28
	oDanfe:Code128C(119.2,370,SubStr(oNF:_InfNfe:_ID:Text,4), nFontSize )
EndIf
...
If Empty(cCodAutDPEC)
	If Empty(cChaveCont)
		oDanfe:Say(164.2,355,"Consulta de autenticidade no portal nacional da NF-e",oFont12:oFont)
		oDanfe:Say(174.2,355,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont12:oFont)
	Endif
Endif
...
If !Empty(cChaveCont) .And. Empty(cCodAutDPEC) .And. !(Val(oNF:_INFNFE:_IDE:_SERIE:TEXT) >= 900)
	If nFolha == 1
		If !Empty(cChaveCont)
			nFontSize := 28
			oDanfe:Code128C(182.2,370,cChaveCont, nFontSize )
		EndIf
	Else
		If !Empty(cChaveCont)
			nFontSize := 28
			oDanfe:Code128C(159.2,370,cChaveCont, nFontSize )
		EndIf
	EndIf
EndIf
...
oDanfe:Box(186.2,000,209.2,603)
oDanfe:Box(186.2,000,209.2,350)
oDanfe:Say(195.2,002,"NATUREZA DA OPERAÇÃO",oFont08N:oFont)
oDanfe:Say(205.2,002,oIdent:_NATOP:TEXT,oFont08:oFont)


If !Empty(cCodAutDPEC)
	oDanfe:Say(195.2,352,"NÚMERO DE REGISTRO DPEC",oFont08N:oFont)
Endif
...
//³Quadro 5                                                                ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Box(211.2,000,234.2,603)
oDanfe:Box(211.2,000,234.2,200)
oDanfe:Box(211.2,200,234.2,400)
oDanfe:Box(211.2,400,234.2,603)
oDanfe:Say(219.2,002,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
oDanfe:Say(227.2,002,IIf(Type("oEmitente:_IE:TEXT")<>"U",oEmitente:_IE:TEXT,""),oFont08:oFont)
oDanfe:Say(219.2,205,"INSC.ESTADUAL DO SUBST.TRIB.",oFont08N:oFont)
oDanfe:Say(227.2,205,IIf(Type("oEmitente:_IEST:TEXT")<>"U",oEmitente:_IEST:TEXT,""),oFont08:oFont)
oDanfe:Say(219.2,405,"CNPJ",oFont08N:oFont)
oDanfe:Say(227.2,405,TransForm(oEmitente:_CNPJ:TEXT,IIf(Len(oEmitente:_CNPJ:TEXT)<>14,"@r 999.999.999-99","@r 99.999.999/9999-99")),oFont08:oFont)
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
oDanfe:Say(242.2,002,"DESTINATARIO/REMETENTE",oFont08N:oFont)
oDanfe:Box(244.2,000,264.2,450)
oDanfe:Say(252.2,002, "NOME/RAZÃO SOCIAL",oFont08N:oFont)
oDanfe:Say(262.2,002,NoChar(oDestino:_XNome:TEXT,lConverte),oFont08:oFont)
oDanfe:Box(244.2,280,264.2,500)
oDanfe:Say(252.2,283,"CNPJ/CPF",oFont08N:oFont)
oDanfe:Say(262.2,283,cAux,oFont08:oFont)

oDanfe:Box(264.2,000,284.2,500)
oDanfe:Box(264.2,000,284.2,260)
oDanfe:Say(271.2,002,"ENDEREÇO",oFont08N:oFont)
oDanfe:Say(281.2,002,aDest[01],oFont08:oFont)
oDanfe:Box(264.2,230,284.2,380)
oDanfe:Say(271.2,232,"BAIRRO/DISTRITO",oFont08N:oFont)
oDanfe:Say(281.2,232,aDest[02],oFont08:oFont)
oDanfe:Box(264.2,380,284.2,500)
oDanfe:Say(271.2,382,"CEP",oFont08N:oFont)
oDanfe:Say(281.2,382,aDest[03],oFont08:oFont)

oDanfe:Box(283.2,000,304.2,500)
oDanfe:Box(283.2,000,304.2,180)
oDanfe:Say(292.2,002,"MUNICIPIO",oFont08N:oFont)
oDanfe:Say(302.2,002,aDest[05],oFont08:oFont)
oDanfe:Box(283.2,150,304.2,256)
oDanfe:Say(292.2,152,"FONE/FAX",oFont08N:oFont)
oDanfe:Say(302.2,152,aDest[06],oFont08:oFont)
oDanfe:Box(283.2,255,304.2,341)
oDanfe:Say(292.2,257,"UF",oFont08N:oFont)
oDanfe:Say(302.2,257,aDest[07],oFont08:oFont)
oDanfe:Box(283.2,340,304.2,500)
oDanfe:Say(292.2,342,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
oDanfe:Say(302.2,342,aDest[08],oFont08:oFont)


oDanfe:Box(244.2,502,264.2,603)
oDanfe:Say(252.2,504,"DATA DE EMISSÃO",oFont08N:oFont)
oDanfe:Say(262.2,504,Iif(oNF:_INFNFE:_VERSAO:TEXT >= "3.10",ConvDate(oIdent:_DHEmi:TEXT),ConvDate(oIdent:_DEmi:TEXT)),oFont08:oFont)
oDanfe:Box(264.2,502,284.2,603)
oDanfe:Say(271.2,504,"DATA ENTRADA/SAÍDA",oFont08N:oFont)
oDanfe:Say(280.2,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont)
oDanfe:Box(283.2,502,304.2,603)
oDanfe:Say(290.2,503,"HORA ENTRADA/SAÍDA",oFont08N:oFont)
oDanfe:Say(297.2,503,aHrEnt[01],oFont08:oFont)
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Quadro fatura                                                           ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
aAux := {{{},{},{},{},{},{},{},{},{}}}
...
oDanfe:Say(310.2,002,"FATURA",oFont08N:oFont)
oDanfe:Box(312.2,000,343.2,068)
oDanfe:Box(312.2,067,343.2,134)
oDanfe:Box(312.2,134,343.2,202)
oDanfe:Box(312.2,201,343.2,268)
oDanfe:Box(312.2,268,343.2,335)
oDanfe:Box(312.2,335,343.2,403)
oDanfe:Box(312.2,402,343.2,469)
oDanfe:Box(312.2,469,343.2,537)
oDanfe:Box(312.2,536,343.2,603)

nColuna := 002
If Len(aFaturas) >0
	For nY := 1 To 9
		oDanfe:Say(320.2,nColuna,aAux[1][nY][1],oFont08:oFont)
		oDanfe:Say(328.2,nColuna,aAux[1][nY][2],oFont08:oFont)
		oDanfe:Say(336.2,nColuna,aAux[1][nY][3],oFont08:oFont)
		nColuna:= nColuna+67
	Next nY
Endif       
...
//³Calculo do imposto                                                      ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Say(352.2,002,"CALCULO DO IMPOSTO",oFont08N:oFont)
oDanfe:Box(354.2,000,377.2,121)
oDanfe:Say(363.2,002,"BASE DE CALCULO DO ICMS",oFont08N:oFont)
If cMVCODREG $ "3" 
	oDanfe:Say(373.2,002,aTotais[01],oFont08:oFont)
ElseIf lImpSimpN
	oDanfe:Say(373.2,002,aSimpNac[01],oFont08:oFont)	
Endif
oDanfe:Box(354.2,120,377.2,200)
oDanfe:Say(363.2,125,"VALOR DO ICMS",oFont08N:oFont)
If cMVCODREG $ "3" 
	oDanfe:Say(373.2,125,aTotais[02],oFont08:oFont)
ElseIf lImpSimpN
	oDanfe:Say(373.2,125,aSimpNac[02],oFont08:oFont)
Endif
oDanfe:Box(354.2,199,377.2,360)
oDanfe:Say(363.2,200,"BASE DE CALCULO DO ICMS SUBSTITUIÇÃO",oFont08N:oFont)
oDanfe:Say(373.2,202,aTotais[03],oFont08:oFont)
oDanfe:Box(354.2,360,377.2,490)
oDanfe:Say(363.2,363,"VALOR DO ICMS SUBSTITUIÇÃO",oFont08N:oFont)
oDanfe:Say(373.2,363,aTotais[04],oFont08:oFont)
oDanfe:Box(354.2,490,377.2,603)
oDanfe:Say(363.2,491,"VALOR TOTAL DOS PRODUTOS",oFont08N:oFont)
oDanfe:Say(374.2,491,aTotais[05],oFont08:oFont)


oDanfe:Box(377.2,000,400.2,110)
oDanfe:Say(386.2,002,"VALOR DO FRETE",oFont08N:oFont)
oDanfe:Say(396.2,002,aTotais[06],oFont08:oFont)
oDanfe:Box(377.2,100,400.2,190)
oDanfe:Say(386.2,102,"VALOR DO SEGURO",oFont08N:oFont)
oDanfe:Say(396.2,102,aTotais[07],oFont08:oFont)
oDanfe:Box(377.2,190,400.2,290)
oDanfe:Say(386.2,194,"DESCONTO",oFont08N:oFont)
oDanfe:Say(396.2,194,aTotais[08],oFont08:oFont)
oDanfe:Box(377.2,290,400.2,415)
oDanfe:Say(386.2,295,"OUTRAS DESPESAS ACESSÓRIAS",oFont08N:oFont)
oDanfe:Say(396.2,295,aTotais[09],oFont08:oFont)
oDanfe:Box(377.2,414,400.2,500)
oDanfe:Say(386.2,420,"VALOR DO IPI",oFont08N:oFont)
oDanfe:Say(396.2,420,aTotais[10],oFont08:oFont)
oDanfe:Box(377.2,500,400.2,603)
oDanfe:Say(386.2,506,"VALOR TOTAL DA NOTA",oFont08N:oFont)
oDanfe:Say(396.2,506,aTotais[11],oFont08:oFont)            

//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Transportador/Volumes transportados                                     ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oDanfe:Say(408.2,002,"TRANSPORTADOR/VOLUMES TRANSPORTADOS",oFont08N:oFont)
oDanfe:Box(410.2,000,433.2,603)
oDanfe:Say(419.2,002,"RAZÃO SOCIAL",oFont08N:oFont)
oDanfe:Say(429.2,002,aTransp[01],oFont08:oFont)
oDanfe:Box(410.2,245,433.2,315)
oDanfe:Say(419.2,247,"FRETE POR CONTA",oFont08N:oFont)
If cModFrete =="0"
	oDanfe:Say(429.2,247,"0-EMITENTE",oFont08:oFont)
ElseIf cModFrete =="1"
	oDanfe:Say(429.2,247,"1-DEST/REM",oFont08:oFont)
ElseIf cModFrete =="2"
	oDanfe:Say(429.2,247,"2-TERCEIROS",oFont08:oFont)
ElseIf cModFrete =="9"
	oDanfe:Say(429.2,247,"9-SEM FRETE",oFont08:oFont)
Else
	oDanfe:Say(429.2,247,"",oFont08:oFont)
Endif
//oDanfe:Say(382,102,"0-EMITENTE/1-DESTINATARIO       [" + aTransp[02] + "]",oFont08:oFont)
oDanfe:Box(410.2,315,433.2,370)
oDanfe:Say(419.2,317,"CÓDIGO ANTT",oFont08N:oFont)
oDanfe:Say(429.2,319,aTransp[03],oFont08:oFont)
oDanfe:Box(410.2,370,433.2,490)
oDanfe:Say(419.2,375,"PLACA DO VEÍCULO",oFont08N:oFont)
oDanfe:Say(429.2,375,aTransp[04],oFont08:oFont)
oDanfe:Box(410.2,450,433.2,510)
oDanfe:Say(419.2,452,"UF",oFont08N:oFont)
oDanfe:Say(429.2,452,aTransp[05],oFont08:oFont)
oDanfe:Box(410.2,510,433.2,603)
oDanfe:Say(419.2,512,"CNPJ/CPF",oFont08N:oFont)
oDanfe:Say(429.2,512,aTransp[06],oFont08:oFont)

oDanfe:Box(432.2,000,456.2,603)
oDanfe:Box(432.2,000,456.2,241)
oDanfe:Say(440.2,002,"ENDEREÇO",oFont08N:oFont)
oDanfe:Say(451.2,002,aTransp[07],oFont08:oFont)
oDanfe:Box(432.2,240,456.2,341)
oDanfe:Say(440.2,242,"MUNICIPIO",oFont08N:oFont)
oDanfe:Say(451.2,242,aTransp[08],oFont08:oFont)
oDanfe:Box(432.2,340,456.2,440)
oDanfe:Say(440.2,342,"UF",oFont08N:oFont)
oDanfe:Say(451.2,342,aTransp[09],oFont08:oFont)
oDanfe:Box(432.2,440,456.2,603)
oDanfe:Say(440.2,442,"INSCRIÇÃO ESTADUAL",oFont08N:oFont)
oDanfe:Say(451.2,442,aTransp[10],oFont08:oFont)


oDanfe:Box(455.2,000,479.2,603)
oDanfe:Box(455.2,000,479.2,101)
oDanfe:Say(465.2,002,"QUANTIDADE",oFont08N:oFont)
oDanfe:Say(475.2,002,aTransp[11],oFont08:oFont)
oDanfe:Box(455.2,100,479.2,200)
oDanfe:Say(465.2,102,"ESPECIE",oFont08N:oFont)
oDanfe:Say(475.2,102,Iif(!Empty(aTransp[12]),aTransp[12],Iif(Len(aEspVol)>0,aEspVol[1][1],"")),oFont08:oFont)
//oDanfe:Say(428,102,aEspVol[1][1],oFont08:oFont)
oDanfe:Box(455.2,200,479.2,301)
oDanfe:Say(465.2,202,"MARCA",oFont08N:oFont)
oDanfe:Say(475.2,202,aTransp[13],oFont08:oFont)
oDanfe:Box(455.2,300,479.2,400)
oDanfe:Say(465.2,302,"NUMERAÇÃO",oFont08N:oFont)
oDanfe:Say(475.2,302,aTransp[14],oFont08:oFont)
oDanfe:Box(455.2,400,479.2,501)
oDanfe:Say(465.2,402,"PESO BRUTO",oFont08N:oFont)
oDanfe:Say(475.2,402,Iif(!Empty(aTransp[15]),aTransp[15],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][3])>0,Transform(Val(aEspVol[1][3]),"@E 999999.9999"),"")),oFont08:oFont)
//oDanfe:Say(428,402,Iif (!Empty(aEspVol[1][3]),Transform(val(aEspVol[1][3]),"@E 999999.9999"),""),oFont08:oFont)
oDanfe:Box(455.2,500,479.2,603)
oDanfe:Say(465.2,502,"PESO LIQUIDO",oFont08N:oFont)
oDanfe:Say(475.2,502,Iif(!Empty(aTransp[16]),aTransp[16],Iif(Len(aEspVol)>0 .And. Val(aEspVol[1][2])>0,Transform(Val(aEspVol[1][2]),"@E 999999.9999"),"")),oFont08:oFont)
...
oDanfe:Say(487.2,002,"DADOS DO PRODUTO / SERVIÇO",oFont08N:oFont)
oDanfe:Box(489.2,000,678,603)
nAuxH := 0
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[1])
oDanfe:Say(497.2, nAuxH + 2, "COD. PROD",oFont08N:oFont)
nAuxH += aTamCol[1]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[2])
oDanfe:Say(497.2, nAuxH + 2, "DESCRIÇÃO DO PROD./SERV.", oFont08N:oFont)
nAuxH += aTamCol[2]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[3])
oDanfe:Say(497.2, nAuxH + 2, "NCM/SH", oFont08N:oFont)
nAuxH += aTamCol[3]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[4])

If cMVCODREG == "1"
	oDanfe:Say(497.2, nAuxH + 2, "CSOSN", oFont08N:oFont)
Else
	oDanfe:Say(497.2, nAuxH + 2, "CST", oFont08N:oFont)
Endif

nAuxH += aTamCol[4]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[5])
oDanfe:Say(497.2, nAuxH + 2, "CFOP", oFont08N:oFont)
nAuxH += aTamCol[5]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[6])
oDanfe:Say(497.2, nAuxH + 2, "UN", oFont08N:oFont)
nAuxH += aTamCol[6]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[7])
oDanfe:Say(497.2, nAuxH + 2, "QUANT.", oFont08N:oFont)
nAuxH += aTamCol[7]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[8])
oDanfe:Say(497.2, nAuxH + 2, "V.UNITARIO", oFont08N:oFont)
nAuxH += aTamCol[8]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[9])
oDanfe:Say(497.2, nAuxH + 2, "V.TOTAL", oFont08N:oFont)
nAuxH += aTamCol[9]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[10])
oDanfe:Say(497.2, nAuxH + 2, "BC.ICMS", oFont08N:oFont)
nAuxH += aTamCol[10]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[11])
oDanfe:Say(497.2, nAuxH + 2, "V.ICMS", oFont08N:oFont)
nAuxH += aTamCol[11]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[12])
oDanfe:Say(497.2, nAuxH + 2, "V.IPI", oFont08N:oFont)
nAuxH += aTamCol[12]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[13])
oDanfe:Say(497.2, nAuxH + 2, "A.ICMS", oFont08N:oFont)
nAuxH += aTamCol[13]
oDanfe:Box(489.2, nAuxH, 678, nAuxH + aTamCol[14])
oDanfe:Say(497.2, nAuxH + 2, "A.IPI", oFont08N:oFont)
...
For nY := 1 To nLenItens
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		oDanfe:Box(000,350,125,603)
		oDanfe:Box(000,350,040,603)
		oDanfe:Box(040,350,062,603)
		oDanfe:Box(063,350,125,603)
		...
		If Empty(cChaveCont)
			oDanfe:Say(105,355,"Consulta de autenticidade no portal nacional da NF-e",oFont12:oFont)
			oDanfe:Say(115,355,"www.nfe.fazenda.gov.br/portal ou no site da SEFAZ Autorizada",oFont12:oFont)
		Endif
...
If nfolha==1
	If lMv_Logod
		oDanfe:SayBitmap(043,001,cLogoD,125,096)
	Else
		oDanfe:SayBitmap(043,001,cLogo,125,096)
	EndIF
Endif
...
oDanfe:Box(072,350,093,603)
oDanfe:Box(115,350,115,603)
...
oDanfe:Box(072,248,147,351)
oDanfe:Say(055,275, "DANFE",OFONT12N:oFont)
oDanfe:Say(125,258, "SIMPLIFICADO",OFONT12N:oFont)
oDanfe:Say(105,258, "DOCUMENTO AUXILIAR DA",oFont07:oFont)
oDanfe:Say(115,258, "NOTA FISCAL ELETRÔNICA",oFont07:oFont)
oDanfe:Say(125,266, "0-ENTRADA",oFont08:oFont)
