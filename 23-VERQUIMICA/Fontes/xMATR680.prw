...
±±³Programa  ³ xMATR680  ³ Autor ³ Marco Bianchi         ³ Data ³ 04/07/06 ³±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±± 
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Alterado ³ Danilo Busso 		 						³ Data ³ 25/09/15 ³±±               
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Uso       ³ Ajustado para atender a demanda da Verquímica              ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/

User Function xMATR680()
...
TRCell():New(oPedNEnt,"EMISSAO"		,"TRB",RetTitle("C5_EMISSAO"	),PesqPict("SC5","C5_EMISSAO"	),TamSx3("C5_EMISSAO"	)[1],/*lPixel*/,{|| TRB->EMISSAO					},/*cAlign*/,lLineBreak)
...
TRCell():New(oPedNEnt,"NOMECLI"		,"TRB",RetTitle("A1_NREDUZ"		),PesqPict("SA1","A1_NREDUZ"		),TamSx3("A1_NREDUZ"		)[1],/*lPixel*/,{|| TRB->NOMECLI					},/*cAlign*/,lLineBreak)
...
TRCell():New(oPedNEnt,"DATENTR"	,"TRB"	,RetTitle("C6_ENTREG")	,PesqPict("SC6","C6_ENTREG"	),nTamData				      ,/*lPixel*/ ,{|| TRB->DATENTR			},/*cAlign*/,lLineBreak)	// Data de Entrega
...
TRCell():New(oProduto,"EMISSAO"		,"TRB",RetTitle("C5_EMISSAO"	),PesqPict("SC5","C5_EMISSAO"	),TamSx3("C5_EMISSAO"	)[1],/*lPixel*/,{|| TRB->EMISSAO 																			},/*cAlign*/,lLineBreak)
TRCell():New(oProduto,"DATENTR"		,"TRB",RetTitle("C6_ENTREG"		),PesqPict("SC6","C6_ENTREG"	),nTamData,/*lPixel*/,{|| TRB->DATENTR																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oProduto,"NOMECLI"		,"TRB",RetTitle("A1_NREDUZ"		),PesqPict("SA1","A1_NREDUZ"		),TamSx3("A1_NREDUZ"		)[1],/*lPixel*/,{|| TRB->NOMECLI 																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oCliente,"NOMECLI"		,"TRB",RetTitle("A1_NREDUZ"		),PesqPict("SA1","A1_NREDUZ"		),TamSx3("A1_NREDUZ"		)[1],/*lPixel*/,{|| TRB->NOMECLI 																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oCliente,"EMISSAO"		,"TRB",RetTitle("C5_EMISSAO"	),PesqPict("SC5","C5_EMISSAO"	),TamSx3("C5_EMISSAO"	)[1],/*lPixel*/,{|| TRB->EMISSAO 																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oCliente,"DATENTR"		,"TRB",RetTitle("C6_ENTREG"		),PesqPict("SC6","C6_ENTREG"	),nTamData,/*lPixel*/,{|| TRB->DATENTR																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oData,"DATENTR"	,"TRB",RetTitle("C6_ENTREG"		),PesqPict("SC6","C6_ENTREG"	),nTamData,/*lPixel*/,{|| TRB->DATENTR																			},/*cAlign*/,lLineBreak)
TRCell():New(oData,"NUM"		,"TRB",RetTitle("C6_NUM"		),PesqPict("SC6","C6_NUM"		),TamSx3("C6_NUM"		)[1],/*lPixel*/,{|| TRB->NUM 																				},/*cAlign*/,lLineBreak)
TRCell():New(oData,"EMISSAO"	,"TRB",RetTitle("C5_EMISSAO"	),PesqPict("SC5","C5_EMISSAO"	),TamSx3("C5_EMISSAO"	)[1],/*lPixel*/,{|| TRB->EMISSAO 																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oData,"NOMECLI"	,"TRB",RetTitle("A1_NREDUZ"		),PesqPict("SA1","A1_NREDUZ"		),TamSx3("A1_NREDUZ"		)[1],/*lPixel*/,{|| TRB->NOMECLI																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oVendedor,"NOMEVEN"	,"TRB",RetTitle("A3_NOME"		),PesqPict("SA3","A3_NOME"	),TamSx3("A3_NOME"	)[1],/*lPixel*/,{|| TRB->NOMEVEN																					},/*cAlign*/,lLineBreak)
...
TRCell():New(oVendedor,"EMISSAO"	,"TRB",RetTitle("C5_EMISSAO"	),PesqPict("SC5","C5_EMISSAO"	),TamSx3("C5_EMISSAO"	)[1],/*lPixel*/,{|| TRB->EMISSAO 																			},/*cAlign*/,lLineBreak)
...
TRCell():New(oVendedor,"DATENTR"	,"TRB",RetTitle("C6_ENTREG"		),PesqPict("SC6","C6_ENTREG"	),nTamData,/*lPixel*/,{|| TRB->DATENTR																			},/*cAlign*/,lLineBreak)
...
Local aConfSched:= IIf(isBlind(), FWSchPrintCFG(),{})
Local nSection  := IIf(isBlind(), aConfSched[4], oReport:Section(1):GetOrder())
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
MakeSqlExpr(MakeSqlExpr(oReport:uParam))
...
Local cCodVenPg  := U_CFMPGVEN()       
Local cUsersRel := GetMv("VQ_RELVEN")
Local aCampos   := {}
Local aTam      := ""
Local cVend     := ""
Local cVendedor := ""
...
If !Empty(cCodVenPg) .AND. (!cUserName $ cUsersRel)
	MV_PAR16 := cCodVenPg
	MV_PAR17 := cCodVenPg
EndIf
...
#IFDEF TOP
	...
	If(Empty(MV_PAR20))
		dEmiIni = '      '   
	Else
	   	dEmiIni := %Exp:DtoS(mv_par20)% 
	EndIf   
	
	If(Empty(MV_PAR21))
	    dEmiFim = 'ZZZZZZZZ'
	Else
		dEmiFim := %Exp:DtoS(mv_par21)%
	EndIf
  
	oSecao:BeginQuery()
	BeginSql Alias cAliasQry
	SELECT SA1.A1_NREDUZ,SC5.C5_EMISSAO,SC6.* 
	FROM %Table:SC6% SC6   
	INNER JOIN %Table:SA1% SA1 ON (SC6.C6_CLI = SA1.A1_COD AND SC6.C6_LOJA = SA1.A1_LOJA ) AND SA1.%notdel%
	INNER JOIN SC5010 SC5 ON (SC6.C6_NUM = SC5.C5_NUM) AND SC5.%notdel%
	WHERE C6_FILIAL = %xFilial:SC6%
	    ...
	    AND C5_EMISSAO >= %Exp:dEmiIni% AND C5_EMISSAO <= %Exp:dEmiFim%        //Danilo Busso
        AND SC6.%notdel%
        %Exp:cWhere%
...
#ELSE
	...
	//Danilo Busso
	cCondicao  += "Dtos(C5_EMISSAO)>='"+Dtos(MV_PAR20)+"'.And.Dtos(C5_EMISSAO)<='"+Dtos(MV_PAR21)+"'"
			...
			For nX := 1 to nQtdVend
				...
				If !EMPTY(cVendedor) .And. (cVendedor >= MV_PAR16 .And. cVendedor <= MV_PAR17 )                                  
					...
					If (Empty(cFilSA3)) .Or. (!Empty(cFilSA3) .And. (&cFilSA3))
						...
						Replace NOMECLI    With (cAliasQry)->A1_NREDUZ
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o	 ³ DBRelR3³ Autor ³ Alexandre Inacio Lemes³ Data ³ 15.03.01 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Relacao de Pedidos nao entregues							  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso		 ³ Generico 												  ³±±
...
LOCAL cString   := "SC6"
LOCAL tamanho   := "G"
LOCAL wnrel     := "xMATR680"
Local aConfSched:= IIf(isBlind(), FWSchPrintCFG(),{})

PRIVATE aReturn := { STR0005, 1,STR0006, 1, 2, 1, "", IIf(isBlind(), aConfSched[4], 1) }      //"Zebrado"###"Administracao"
PRIVATE nTamRef := Val(Substr(GetMv("MV_MASCGRD"),1,2))
PRIVATE nomeprog:= "xMATR680"
...
LOCAL dEmiIni	:= MV_PAR20  //Danilo Busso
LOCAL dEmiFim	:= MV_PAR21  //Danilo Busso
LOCAL nTipVal   := IIF(cPaisLoc == "BRA",MV_PAR19,MV_PAR20)
LOCAL nSaldo    := 0
LOCAL nX        := 0
LOCAL nQtdVend  := FA440CntVen() // Retorna a quantidade maxima de Vendedores
