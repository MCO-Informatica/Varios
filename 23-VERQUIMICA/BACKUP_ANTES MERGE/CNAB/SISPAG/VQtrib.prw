...
//DARF SIMPLES   
  CASE _Tiptrib == "03"	
     ...
     cRet := ALLTRIM(SE2->E2_XGPS01) + ALLTRIM(SE2->E2_XFGTS02) + "2" + SUBSTR(SE2->E2_XCNPJ01,1,14) + SE2->E2_XDARF03 + "000000000" + "0000" + SPACE(4)
     cRet += Strzero(SE2->E2_SALDO*100,14) + _vOutras + _vJuros + _vValor + GRAVADATA(SE2->E2_VENCREA,.F.,5) + GRAVADATA(SE2->E2_VENCREA,.F.,5) + SPACE(30) + SUBSTR(SA2->A2_NOME,1,30)
