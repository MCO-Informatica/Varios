...
±±ºPrograma  ³PAGAR356     º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Gera as informacoes para o cnab a pagar o banco do ITAU  . º±±
±±º                                                                       º±±
±±ºParametros:                                                            º±±
±±º                                                                       º±±
...
If _cOpcao == "01"   // Nome do Contribuinte
   ...
   If !Empty(SE2->E2_XCNPJC)
      ...
      EndIf
  Else
      _cReturn := Subs(U_RetSM0(,,"M0_NOMECOM"),1,30)
  EndIf   
...
ElseIf _cOpcao == "02"   // Detalhes Segmento N 
  ...
  Else
     _cReturn := If(!Empty(SE2->E2_CODRET),SE2->E2_CODRET,SE2->E2_CODRET)+SPACE(2)
  ...
  If SEA->EA_MODELO == "22" .or. SEA->EA_MODELO == "91"  //--- Para GARE ICMS - Retornar o CNPJ da Filial do SE2->E2_FILIAL
  ...
  Else
      ...
      Else
        _cReturn += Subs(U_RetSM0(,,"M0_CGC"),1,14)
      EndIf
...
ElseIf SEA->EA_MODELO == "91"  //--- GARE ICMS - SP
...
If _cOpc == "01"
   _cVolta := U_RetSM0(cEmpAnt,_cFilSE2,"M0_INSC") 
else
   _cVolta := U_RetSM0(cEmpAnt,_cFilSE2,"M0_CGC")
EndIf
