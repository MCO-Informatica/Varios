...
/*/
//--------------------------------------------------------------------
User Function UPDHAC1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDHAC1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDHAC1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	{ 'Cost'																, .T. }, ; //X3_TITSPA
	{ 'Cost'																, .T. }, ; //X3_TITENG
	{ 'Valor Orcado'														, .T. }, ; //X3_DESCRIC
	{ 'Valor Orcado'														, .T. }, ; //X3_DESCSPA
	{ 'Valor Orcado'														, .T. }, ; //X3_DESCENG
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Define o valor orçado.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PC8_XCOST  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "C8_XCOST" )

aHlpPor := {}
aAdd( aHlpPor, 'Define a porcentagem Saving do' )
aAdd( aHlpPor, 'orçamento.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PC8_XSAVING", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "C8_XSAVING" )
