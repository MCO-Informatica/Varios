...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function XMATA972(lAutomato)
...
Local	cText2
Local	cText3
Local	aCAP		:= {"Confirma","Abandona","Parametros"}
Local	cTipoNf		:= ""
Local	aD1Imp		:= {}
Local	aD2Imp		:= {}
Local	nScanPis	:= 0
...
//?Janela Principal                                             ?
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
cTitulo	:=	"Arquivo Magnจฆtico"
cText1	:=	"Este programa gera arquivo prจฆ-formatado dos lan?amentos fiscais"
cText2	:=	"para entrega as Secretarias de Fazenda Estaduais da Guia de  "
cText3	:=	"Informacao e Apuracao do ICMS (GIA) a partir de 2018 ##WAC."
...
While .T.
	...
	If !lAutomato
		...
		Do Case
			Case nOpc==1
				Processa({||xa972Processa()},,,@lEnd)
			Case nOpc==3
				Pergunte(cPerg,.t.)
				Loop
		EndCase
	Else
		Processa({||xa972Processa(lAutomato)},,,@lEnd)
	EndIf
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Processa(lAutomato)
LOCAL aApuracao
Local cRef  := ""
Local lRet  := .F.
Local nX    := 0
Local lAglFil  := (mv_par22 == 1)   // A Variแvel ?local para ser passada por parโmetro na fun็ใo xa972MontTrab, que ?chamada por outras rotinas.
...
If lRet
	...
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	xa972MontTrab(aApuracao,.F.,dDtIni,dDtFim,cNrLivro,nRegime,cFilDe,cFilAte,cVLayOut,lSelFil,lAglFil,lGerCR26,lGerCR27,aAlias)
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//?Grava arquivo texto                                          ?
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	xa972GeraTxt(lAutomato)
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//?Fecha arquivo texto                                          ?
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	If nHandle >= 0
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972MontTrab(aApuracao,lRelDIPAM,dDataIni,dDataFim,cNrLivro,nRegime,cFilDe,cFilAte,cVLayOut,lSelFil,lAglFil,lGerCR26,lGerCR27,aAlias)
Local cCod_Mun  	:= ""
Local cFiltro 	:=	""
Local cChave		:=	""
Local cCGC			:=	""
...
For n0 := 1 to Len(aSM0)
	...
	#ENDIF
			...
			IndRegua(cAliasSF3,cIndSF3,cChave,,cFiltro,"Selec.Notas fiscais...") 
	#IFDEF TOP
		Endif
	#ENDIF
	...
	While (cAliasSF3)->(!Eof()) .and. xFilial("SF3")==(cAliasSF3)->F3_FILIAL
		...
		*/
		...
		If !lRelDIPAM .And. nRegime == 4 .And. ;
			...
			Loop
		EndIf
		cUF	:= xA972CodUF((cAliasSF3)->F3_ESTADO)
		If cMvUF == "SP"
		...
		If lRelDIPAM .OR. nRegime <> 4
			...
			Else
				cCod_Mun := xA972RetMun (cAliasSf3, lTms, cMvEstado, cMVCODDP, cMVCODMUN, lA1CODMUN,cCodMunX)
			EndIf
			//--
			If ( Year(dDtFim) >= 2001 )
				If cCfop1 > "5"
	...
	If lTop .AND. !lRelDIPAM
		...
		Do While !(cAliasF3)->(EOF())
			...
			cCodMun	:=	""
			lZFranca	:= .T.
			cUF := xA972CodUF((cAliasF3)->F3_ESTADO)
...
Static Function xa972CriaTemp(lRelDIPAM)
...
If !lRelDIPAM
	...
	IndRegua(cArqCFO,cArqCFO,"CFOP+TIPOREG",,,"Indexando Detalhes de CFOP") 
	...
	IndRegua(cArqInt,cArqInt,"CFOP+UF+TIPOREG",,,"Indexando Operacoes interestaduais")
	...
	IndRegua(cArqZFM,cArqZFM,"CFOP+UF+TIPOREG",,,"Indexando ZFM/ALC") 
	...
	IndRegua(cArqOcor,cArqOcor,"SUBITEM+PRO_ST+TIPOREG",,,"Indexando Ocorrencias") 
	...
	IndRegua(cArqIE,cArqIE,"SUBITEM+IE",,,"Indexando Remetentes")
Endif
...
If !lRelDIPAM
	...
	IndRegua(cArqIeSt,cArqIeSt,"SUBITEM+IE+NF",,,"Indexando IE Substitutos")
	...
	IndRegua(cArqIeSd,cArqIeSd,"IE+NF",,,"Indexando IE Substitutos") 
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972GeraTxt(lAutomato)
...
While (cArqCabec)->(!eof())
	...
	xa972Cabec(nr10,nr20,nr30,nr31,/*1,*/nr07)
	...
	While (cArqOcor)->(!eof())
		...
		cRegistro	:=xa972Fill("20"+xa972Fill(aOcorr[n20][2],005)+xa972Fill(Num2Chr(aOcorr[n20][3],15,2),015)+xa972Fill(aOcorr[n20][4],001)+;
		xa972Fill(aOcorr[n20][5] ,100)+xa972Fill(aOcorr[n20][6] ,300)+xa972Fill(Num2Chr(nRemetent,4,0),04)  +;
		xa972Fill(Num2Chr(nCR26,4,0),04)+xa972Fill(Num2Chr(nCR27,4,0),04)+xa972Fill(Num2Chr(aOcorr[n20][10],4,0),04),439)
		xa972Grava( cRegistro )
		nRemetent := 0
		nCR26 := 0
		nCR27 := 0
		...
		If Len(aRemetent)>0
			...
			If nPosQ25>0
				For n25:=nPosQ25 To Len(aRemetent)
					cRegistro	:=xa972Fill("25"+xa972Fill(aRemetent[n25][2],12)+xa972Fill(Num2Chr(aRemetent[n25][3],15,2),15),29)
					xa972Grava( cRegistro )
				Next
			Endif
		Endif
		...
		If Len(aCR26)>0
			...
			If nPosQ26>0
				For n26:=1 To Len(aCR26)
					cRegistro	:=xa972Fill("26"+xa972Fill(aCR26[n26][2],12)+xa972Fill(aCR26[n26][3],9)+xa972Fill(aCR26[n26][4],6)+xa972Fill(aCR26[n26][5],6)+xa972Fill(Num2Chr(aCR26[n26][6],15,2),15),50)
					xa972Grava( cRegistro )
				Next
			Endif
		Endif
		...
		If Len(aCR27)>0
			...
			If nPosQ27>0
				For n27:=1 To Len(aCR27)
					cRegistro	:=xa972Fill("27"+xa972Fill(aCR27[n27][2],12)+xa972Fill(aCR27[n27][3],9)+xa972Fill(Num2Chr(aCR27[n27][4],15,2),15),38)
					xa972Grava( cRegistro )
				Next
			Endif
		Endif
		...
		If cRef >= "201004"
			If (cCredAcum)->(msseek(Alltrim((cArqOcor)->SUBITEM)))
				...
				while  (cCredAcum)->(!Eof()).And. (Alltrim(((cCredAcum)->SUBITEM))==Alltrim((cArqOcor)->SUBITEM))
					cRegistro:=xa972Fill("28"+Lower(xa972Fill((cCredAcum)->CODAUTO,12))+xa972Fill(Num2Chr((cCredAcum)->VALOR,15,2),15),29)
					xa972Grava( cRegistro )
					(cCredAcum)->(DbSkip ())
				EndDo
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Mestre(lAutomato)
...
cRegistros	:= xa972Fill(cRegistro,30)
xa972Grava(cRegistro)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Cabec(nr10,nr20,nr30,nr31,/*nOpc,*/nr07)
Local cRegistro

cRegistro	:=	"05"     											//01.Codigo do registro
cRegistro	+=	xa972Fill((cArqCabec)->IE,12)						//02.Inscricao Estadual
cRegistro	+=	xa972Fill((cArqCabec)->CNPJ,14)						//03.CNPJ
cRegistro	+=	xa972Fill((cArqCabec)->CNAE,07)						//04.CNAE
cRegistro	+=	xa972Fill((cArqCabec)->REGTRIB,02)					//05.Regime Tributario
cRegistro	+=	xa972Fill((cArqCabec)->REF,06)						//06.Referencia( Ano e Mes da Gia)
cRegistro	+=	xa972Fill((cArqCabec)->REFINIC,06)					//07.Referencia Inicial
cRegistro	+=	xa972Fill((cArqCabec)->TIPO,02)						//08.Tipo da GIA
cRegistro	+=	xa972Fill((cArqCabec)->MOVIMEN,01)					//09.Indica se houve movimento
cRegistro	+=	xa972Fill((cArqCabec)->TRANSMI,01)	  				//10.Indica se o documento ja foi transmitido
cRegistro	+=	xa972Fill(Num2Chr((cArqCabec)->SALDO,15,2),15)		//11.Saldo Credor do periodo anterior
cRegistro	+=	xa972Fill(Num2Chr((cArqCabec)->SALDOST,15,2),15)	//12.Saldo Credor do Periodo anteiro para ST.
cRegistro	+=	xa972Fill((cArqCabec)->ORIGSOF,14)					//13.Identificacao do fabricante do Software que gerou o arquivo pre formatado
cRegistro	+=	xa972Fill((cArqCabec)->ORIGARQ,01) 					//14.Indica se o arquivo foi gerado por algum sistema de informacao contabil
cRegistro	+=	xa972Fill(Num2Chr((cArqCabec)->ICMSFIX,15,2),15)	//15.ICMS fixado para o periodo
cRegistro   +=  xa972Fill(REPLICATE("0",32),32)						//No caso em que o Pr?formatado-NG ?gerado por algum sistema de informa็ใo contแbil, deixar este campo com ZEROS
If cVLayOut == "0209" .Or. cVLayOut == "0210"
	cRegistro	+=	xa972Fill(Num2Chr(nr07,4,0),04)					//19.Quantidade de Registro tipo CR=07
Endif
cRegistro	+=	xa972Fill(Num2Chr(nr10,4,0),04)						//16.Quantidade de registro tipo CR=10
cRegistro	+=	xa972Fill(Num2Chr(nr20,4,0),04)		//17.Quantidade de Registro tipo CR=20

cRegistro	+=	xa972Fill(Num2Chr(nr30,4,0),04)		//18.Quantidade de Registro tipo CR=30
If strzero(nAno,4)+strzero(nMes,2) < "200101"
	cRegistro	+= "0000"
Else
	cRegistro	+=	xa972Fill(Num2Chr(nr31,4,0),04)	//19.Quantidade de Registro tipo CR=31
Endif

If cVLayOut == "0209" .Or. cVLayOut == "0210"
	cRegistro	:= xa972Fill(cRegistro,165)
Else
	cRegistro	:= xa972Fill(cRegistro,161)
EndIf
xa972Grava( cRegistro )
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972CFOP()
LOCAL cRegistro

cRegistro	:=	"10"											  									//01.Codigo do Registro
cRegistro	+=	xa972Fill(alltrim((cArqCFO)->CFOP)+repli("0",6-len(alltrim((cArqCFO)->CFOP))),06)	//02.Codigo Fiscal de Operacao e Prestacao
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->VALCONT,15,2),15)										//03.Valor Contabil
cRegistro	+=	xa972Fill(Num2Chr(NoRound((cArqCFO)->BASEICM,2),15,2),15)							//04.Base de Calculo
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->VALTRIB,15,2),15)										//05.Imposto
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->ISENTA,15,2),15)										//06.Isentas e Nao tributadas
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->OUTRAS,15,2),15)										//07.Outras
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->RETIDO,15,2),15)										//08.Imposto Retido por Substituicao Tributaria
cRegistro	+=  xa972Fill(Num2Chr((cArqCFO)->RtStSt,15,2),15)          								//Substituto
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->RtSbSt,15,2),15)          								//Substituido
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->IMPOSTO,15,2),15)		    							//09.Outros Impostos
cRegistro	+=	xa972Fill(Num2Chr((cArqCFO)->Q14,4,0),04)											//10.Quantidade de Registros CR=14
cRegistro	:=	xa972Fill(cRegistro,147)
xa972Grava( cRegistro )
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Estados()
LOCAL cRegistro

cRegistro	:=	"14"												//01.Codigo do registro
cRegistro	+=	xa972Fill((cArqInt)->UF,02)							//02.Unidade da Federacao
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->VALCONT,15,2),15)		//03.Valor Contabil de contribuinte
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->BASECON,15,2),15)		//04.Base de Calculo de contribuinte
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->VALNCON,15,2),15)		//05.Valor Contabil de Nao contribuinte
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->BASENCO,15,2),15)		//06.Base de calculo de nao contribuinte
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->IMPOSTO,15,2),15)		//Imposto creditado ou debitado
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->OUTRAS,15,2),15)		//07.Outras
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->RETIDO,15,2),15)		//08.ICMS cobrado por Substituicao Tributaria
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->PETROL,15,2),15)		//09.Petroleo e Energia quando ICMS cobrado por Substituicao Tributaria
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->OUTPROD,15,2),15)		//10.Outros produtos
cRegistro	+=	xa972Fill(if((cArqInt)->BENEF=="1",(cArqInt)->BENEF,"0"),01)//11.Indica se ha alguma operacao beneficiada por isencao de ICMS(ZFM/ALC)
cRegistro	+=	xa972Fill(Num2Chr((cArqInt)->Q18,04,0),04)			//12.Quantidade de registros CR=18
cRegistro	:=	xa972Fill(cRegistro,144)
xa972Grava( cRegistro )
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972ZFranca()
LOCAL cRegistro

cRegistro	:=	"18"              								//01.Codigo do registro
cRegistro	+=  Strzero(Val((cArqZFM)->NFISCAL),09) 			//02.Numero da Nota Fiscal
cRegistro	+=	xa972Fill(dtos((cArqZFM)->EMISSAO),08)			//03.Data de emissao da Nota Fiscal
cRegistro	+=	xa972Fill(Num2Chr((cArqZFM)->VALOR,15,2),15)	//04.Valor da Nota Fiscal
cRegistro	+=	xa972Fill((cArqZFM)->CNPJDES,14)					//05.CNPJ do destinatario
cRegistro	+=	xa972Fill((cArqZFM)->MUNICIP,05)					//06.Codigo do municipio do destinatario

cRegistro	:=	xa972Fill(cRegistro,53)
xa972Grava( cRegistro )
Return
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Ocorrencia(nCR25)
LOCAL cRegistro

cRegistro	:=	"20"											//01.Codigo de registro
cRegistro	+=	xa972Fill((cArqOcor)->SUBITEM,005) 				//02.Codigo do Subitem
cRegistro	+=	xa972Fill(Num2Chr((cArqOcor)->VALOR,15,2),015)	//03.Valor associado ao subitem
cRegistro	+=	xa972Fill((cArqOcor)->PRO_ST,001)				//04.Indica se a operacao e propria ou Substituicao Tributaria
cRegistro	+=	xa972Fill((cArqOcor)->FLEGAL,100)				//05.Fundamento legal associada ao Subitem
cRegistro	+=	xa972Fill((cArqOcor)->OCORREN,300)				//06.Descricao da ocorrencia associada ao Subitem
cRegistro	+=	xa972Fill(Num2Chr((cArqOcor)->Q25,4,0),04)		//07.Quantidade de registro CR=25
cRegistro	+=	xa972Fill(Num2Chr((cArqOcor)->Q26,4,0),04)		//Quantidade de registro CR=26
cRegistro	+=	xa972Fill(Num2Chr((cArqOcor)->Q27,4,0),04)		//Quantidade de registro CR=27
cRegistro	+=	xa972Fill(Num2Chr((cArqOcor)->Q28,4,0),04)		//Quantidade de registro CR=28
cRegistro	:=	xa972Fill(cRegistro,439)
xa972Grava( cRegistro )
Return
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function xa972Remetentes()
LOCAL cRegistro
cRegistro	:=	"25"										//01.Codigo de Registro
cRegistro	+=	xa972Fill((cArqIE)->IE,12)					//02.Inscricao estadual do remetente
cRegistro	+=	xa972Fill(Num2Chr((cArqIE)->VALOR,15,2),15)	//03.Valor associado ao IE do Remetente

cRegistro	:=	xa972Fill( cRegistro,29)
xa972Grava( cRegistro )
return
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Fill(cConteudo,nTam)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Grava(cConteudo)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xA972CodUF(cUF)
cCOD := "01"
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Dipam()

cRegistro	:=	"30"													//01.Codigo de Registro
cRegistro	+=	xa972Fill((cArqDipam)->CODDIP,2)							//02.Codigo da DIPI
cRegistro   +=  xa972Fill((cArqDipam)->MUNICIP,5)						//03.Codigo do Municipio
cRegistro	+=	xa972Fill(Num2Chr((cArqDipam)->VALOR,15,2),15)			//04.Codigo do Municipio
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972Expot()

cRegistro	:=	"31"												//01.Codigo de Registro
cRegistro	+=	xa972Fill((cArqExpt)->RE,15)							//02.Registro de Importacao
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972TmpIE(cAlias)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972TmIeT(cAlias)   //nome da fun็ใo alterada em 07/01/2020 - Luiz
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xa972TmIeSD(cAlias)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿?
*/
Static Function xA972RetMun (cAliasSf3, lTms, cMvUF, cMVCODDP, cMVCODMUN, lA1CODMUN, cCodMunX )
Local		cCod_Mun 	 :=	""
Local		aArea		 :=	GetArea ()
Local		aCodMun	 := {}
