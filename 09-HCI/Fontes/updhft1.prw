...
/*/
//--------------------------------------------------------------------
User Function UPDHFT1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDHFT1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDHFT1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'€'																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'E=Em execucao;F=Finalizado'											, ; //X3_CBOX
	'E=Em execucao;F=Finalizado'											, ; //X3_CBOXSPA
	'E=Em execucao;F=Finalizado'											, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Dt. Prevista'															, ; //X3_TITULO
	'Dt. Prevista'															, ; //X3_TITSPA
	'Dt. Prevista'															, ; //X3_TITENG
	'Data prevista'															, ; //X3_DESCRIC
	'Data prevista'															, ; //X3_DESCSPA
	'Data prevista'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Cargo'																, ; //X3_TITSPA
	'Cargo'																, ; //X3_TITENG
	'Codigo do Cargo'													, ; //X3_DESCRIC
	'Codigo do Cargo'													, ; //X3_DESCSPA
	'Codigo do Cargo'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'ExistCpo("SUM")'																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Informa o status do orçamento.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PCJ_XSTAORC", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "CJ_XSTAORC" )

aHlpPor := {}
aAdd( aHlpPor, 'Informa a data prevista do orçamento' )
aAdd( aHlpPor, '(Data que irá disparar a tarefa no CRM).' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PCJ_XDTPREV", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "CJ_XDTPREV" )
