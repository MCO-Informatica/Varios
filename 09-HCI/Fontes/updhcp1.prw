...
/*/
//--------------------------------------------------------------------
User Function UPDHCP1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDHCP1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDHCP1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	{ 'SB1'																		, .T. }, ; //X3_ARQUIVO
	{ '03'																		, .T. }, ; //X3_ORDEM
	{ 'B1_XTPMAT'																, .T. }, ; //X3_CAMPO
	{ 'C'																		, .T. }, ; //X3_TIPO
	{ 1																			, .T. }, ; //X3_TAMANHO
	{ 0																			, .T. }, ; //X3_DECIMAL
	{ 'Tp. Material'															, .T. }, ; //X3_TITULO
	{ 'Tp. Material'															, .T. }, ; //X3_TITSPA
	{ 'Tp. Material'															, .T. }, ; //X3_TITENG
	{ 'Tipo de material'														, .T. }, ; //X3_DESCRIC
	{ 'Tipo de material'														, .T. }, ; //X3_DESCSPA
	{ 'Tipo de material'														, .T. }, ; //X3_DESCENG
	{ '@!'																		, .T. }, ; //X3_PICTURE
	{ 'Vazio() .Or. Pertence("PI")'												, .T. }, ; //X3_VALID
	...
	{ '€'																		, .T. }, ; //X3_OBRIGAT
	{ ''																		, .T. }, ; //X3_VLDUSER
	{ 'P=Produtivo;I=Improdutivel'												, .T. }, ; //X3_CBOX
	{ ''																		, .T. }, ; //X3_CBOXSPA
	{ ''																		, .T. }, ; //X3_CBOXENG
	{ ''																		, .T. }, ; //X3_PICTVAR
	{ ''																		, .T. }, ; //X3_WHEN
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'B1_XUNDNEG'															, .T. }, ; //X3_CAMPO
	{ 'C'																		, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Unid.Negocio'															, .T. }, ; //X3_TITULO
	{ 'Unid.Negocio'															, .T. }, ; //X3_TITSPA
	{ 'Unid.Negocio'															, .T. }, ; //X3_TITENG
	{ 'Unidade de negocio'													, .T. }, ; //X3_DESCRIC
	{ 'Unidade de negocio'													, .T. }, ; //X3_DESCSPA
	{ 'Unidade de negocio'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("SX5", "TM" + M->B1_XUNDNEG)'									, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	 Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	 Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																		, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	{ 'SB1'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'B1_XATMAT'																, .T. }, ; //X3_CAMPO
	{ 'C'																		, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Atrib.Mater.'															, .T. }, ; //X3_TITULO
	{ 'Atrib.Mater.'															, .T. }, ; //X3_TITSPA
	{ 'Atrib.Mater.'															, .T. }, ; //X3_TITENG
	{ 'Atributo do Material'													, .T. }, ; //X3_DESCRIC
	{ 'Atributo do Material'													, .T. }, ; //X3_DESCSPA
	{ 'Atributo do Material'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ 'ExistCpo("SX5", "AM" + M->B1_XATMAT)'									, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ ''																		, .T. }, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	{ 'Tipo'															, .F. }, ; //X3_TITSPA
	{ 'Type'															, .F. }, ; //X3_TITENG
	{ 'Tipo de Produto (MP,PA,.)'													, .F. }, ; //X3_DESCRIC
	{ 'Tipo de Producto (MP,PA,.'													, .F. }, ; //X3_DESCSPA
	{ 'Type of Product'													, .F. }, ; //X3_DESCENG
	{ '@!'																	, .F. }, ; //X3_PICTURE
	{ 'A010Tipo()'									, .F. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX6, { ;
	...
	'ES_ATVCPEF'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Define a empresa e filial que está ativa a '							, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'codificação do produto (Produtivo e Improdutivel).'								, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	''																	, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'0250|0251'												, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
	''																		, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
...
aAdd( aSX6, { ;
	...
	'ES_FILTPPR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Define os tipos de produtos que nao deverao'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'ser demonstrados na consulta (F3) do campo '										, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	''																		, ; //X6_DSCENG1
	'B1_TIPO.'																		, ; //X6_DESC2
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'AI|BN|EM|GE|GG|'																		, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
	''																		, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
...
aAdd( aSX6, { ;
	...
	'ES_FILGRPR'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Define os grupos de produtos que nao deverao'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	'ser demonstrados na consulta (F3) do campo '										, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'0001|0002|0003|0004|0005|0006|0007'																		, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
	''																		, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
...
aAdd( aSX5, { ;
	...
	'00'																	, ; //X5_TABELA
	'AM'																	, ; //X5_CHAVE
	'ATRIBUICAO DO MATERIAL (CAD. PRD.)'									, ; //X5_DESCRI
	'ATRIBUICAO DO MATERIAL (CAD. PRD.)'									, ; //X5_DESCSPA
	'ATRIBUICAO DO MATERIAL (CAD. PRD.)'									} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'00'																	, ; //X5_TABELA
	'SN'																	, ; //X5_CHAVE
	'CODIGO SEQUENCIAL PRODUTO'												, ; //X5_DESCRI
	'CODIGO SEQUENCIAL PRODUTO'												, ; //X5_DESCSPA
	'CODIGO SEQUENCIAL PRODUTO'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'00'																	, ; //X5_TABELA
	'TM'																	, ; //X5_CHAVE
	'UNIDADE DE NEGOCIO (CAD. PRD)'											, ; //X5_DESCRI
	'UNIDADE DE NEGOCIO (CAD. PRD)'											, ; //X5_DESCSPA
	'UNIDADE DE NEGOCIO (CAD. PRD)'											} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'AM'																	, ; //X5_TABELA
	'08'																	, ; //X5_CHAVE
	'PROJETO OSS'															, ; //X5_DESCRI
	'PROJETO OSS'															, ; //X5_DESCSPA
	'PROJETO OSS'															} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'TM'																	, ; //X5_TABELA
	'CL'																	, ; //X5_CHAVE
	'CALDEIRARIA'															, ; //X5_DESCRI
	'CALDEIRARIA'															, ; //X5_DESCSPA
	'CALDEIRARIA'															} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'TM'																	, ; //X5_TABELA
	'CS'																	, ; //X5_CHAVE
	'CARMAR SOLUTIONS'														, ; //X5_DESCRI
	'CARMAR SOLUTIONS'														, ; //X5_DESCSPA
	'CARMAR SOLUTIONS'														} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'TM'																	, ; //X5_TABELA
	'OG'																	, ; //X5_CHAVE
	'OLEO E GAS'															, ; //X5_DESCRI
	'OLEO E GAS'															, ; //X5_DESCSPA
	'OLEO E GAS'															} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'TM'																	, ; //X5_TABELA
	'PP'																	, ; //X5_CHAVE
	'PARTES E PECAS PARA REVENDA'											, ; //X5_DESCRI
	'PARTES E PECAS PARA REVENDA'											, ; //X5_DESCSPA
	'PARTES E PECAS PARA REVENDA'											} ) //X5_DESCENG
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Informa o tipo de material do produto.' )
aAdd( aHlpPor, 'Produtivo ou Improdutivel.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB1_XTPMAT ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XTPMAT" )

aHlpPor := {}
aAdd( aHlpPor, 'Informa a unidade de negocio.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB1_XUNDNEG", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XUNDNEG" )

aHlpPor := {}
aAdd( aHlpPor, 'Informe o atributo do material do' )
aAdd( aHlpPor, 'produto.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB1_XATMAT ", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "B1_XATMAT" )
