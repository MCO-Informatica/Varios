...
ฑฑบ Programa ณ UPDSB4   บ Autor ณ TOTVS Protheus     บ Data ณ  22/07/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPDSB4     - Gerado por EXPORDIC / Upd. V.4.10.5 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPDSB4( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDSB4" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPDSB4" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
aAdd( aSX3, { ;
	...
	'Grupo Trib.'															, ; //X3_TITENG
	'Grupo Trib.'															, ; //X3_DESCRIC
	'Grupo Trib.'															, ; //X3_DESCSPA
	'Grupo Trib.'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'Vazio() .Or. ExistCpo("SX5","21"+M->B4_GRTRIB)'						, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cons.Inicial'															, ; //X3_TITULO
	'Cons.Inicial'															, ; //X3_TITSPA
	'Cons.Inicial'															, ; //X3_TITENG
	'Cons.Inicial'															, ; //X3_DESCRIC
	'Cons.Inicial'															, ; //X3_DESCSPA
	'Cons.Inicial'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Custo Tabela'															, ; //X3_TITULO
	'Custo Tabela'															, ; //X3_TITSPA
	'Custo Tabela'															, ; //X3_TITENG
	'Custo Tabela'															, ; //X3_DESCRIC
	'Custo Tabela'															, ; //X3_DESCSPA
	'Custo Tabela'															, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	'Imp.Tab_E'																, ; //X3_TITSPA
	'Imp.Tab_E'																, ; //X3_TITENG
	'Imp.Tab_E'																, ; //X3_DESCRIC
	'Imp.Tab_E'																, ; //X3_DESCSPA
	'Imp.Tab_E'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Imp_Tabela_I'															, ; //X3_TITULO
	'Imp_Tabela_I'															, ; //X3_TITSPA
	'Imp_Tabela_I'															, ; //X3_TITENG
	'Imp_Tabela_I'															, ; //X3_DESCRIC
	'Imp_Tabela_I'															, ; //X3_DESCSPA
	'Imp_Tabela_I'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSXA บ Autor ณ TOTVS Protheus     บ Data ณ  22/07/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SXA - Pastas        ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSXA   - Gerado por EXPORDIC / Upd. V.4.10.5 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  22/07/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Grupo Trib.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB4_GRTRIB ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_GRTRIB " + CRLF
...
PutHelp( "PB4_COMIS  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_COMIS  " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Cod Barras' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB4_CODBAR ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_CODBAR " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Cons.Inicial' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB4_CONINI ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_CONINI " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Custo Tabela' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB4_CUSTAB ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_CUSTAB " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Imp.Tab_E' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB4_TABELA ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_TABELA " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Imp_Tabela_I' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PB4_TAB_IN ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_TAB_IN " + CRLF
...
PutHelp( "PB4_PESBRU ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "B4_PESBRU " + CRLF
