...
#DEFINE MAXITEMC   080                                                // Máxima de caracteres por linha de produtos/serviços
...
If nfolha==1
	If lMv_Logod
		oDanfe:SayBitmap(047,002,cLogoD,095,046)
	Else
		oDanfe:SayBitmap(047,002,cLogo,095,046)
	EndIF
Endif
...
For nY := 1 To nLenItens
	...
	If lflag
		If nL > nMaxItemP2
			...
			If lMv_Logod
				oDanfe:SayBitmap(005+nLinhavers,002,cLogoD,095,046)
			Else
				oDanfe:SayBitmap(005+nLinhavers,002,cLogo,095,046)
			EndIf
	...
	If	nL > Iif( (nfolha-1)%2==0 .And. MV_PAR05==1,MAXITEMP3,nMaxItemP2)
		...
		If lMv_Logod
			oDanfe:SayBitmap(005,002,cLogoD,095,046)
		Else
			oDanfe:SayBitmap(005,002,cLogo,095,046)
		EndIf
