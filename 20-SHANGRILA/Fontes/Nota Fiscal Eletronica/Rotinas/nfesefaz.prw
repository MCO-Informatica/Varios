...
Local cCFOPExp 		:= "1501-2501-5501-5502-5504-5505-6501-6502-6504-6505-7101-7102"
					...
					If lContinua
						...
						*/
						...
						aadd(aProd,	{Len(aProd)+1,;
							...
							retQtd2UM( lNoImp2UM, lImp2UM, cCFOPExp, Alltrim((cAliasSD2)->D2_CF), nConvDip, (cAliasSD2)->D2_QUANT,Iif(Alltrim((cAliasSD2)->D2_CF)$cCFOPExp,"M",SB1->B1_TIPCONV )),;
							(cAliasSD2)->D2_VALFRE,;
							(cAliasSD2)->D2_SEGURO,;
...
For nX := 1 To Len(aVol)		
	cString += '<vol>'
		...
		// Personalizado		
		// GENILSON LUCAS - MVG CONSULTORIA
		If Len(aTransp) > 13
			cString += '<nVol>'  +aTransp[14]+'</nVol>' //aTransp[14]        
		Endif				 
		/*if len( aVol[nX] ) >= 5 
