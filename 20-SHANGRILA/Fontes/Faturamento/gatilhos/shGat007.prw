...
/**
*
* @author: Marcos Flóridi Leme
* @since: 04/11/2020 - 15:43
* @description: Gatilho para realizar o alerta quando o numero nao for inteiro, disparado pelo campo C6_QTDVEN para o campo "C6_POTENCI" sem uso.
*/ 
User Function shGat007()
	...
	_xSldsDig	:= 0
	_xPosProd := aScan(aHeader,{|x|Upper(AllTrim(x[2])) == "C6_PRODUTO"}) //Add 19112020 - Marcos Floridi - Fix System
	_xPosQtd  := aScan(aHeader,{|x|Upper(AllTrim(x[2])) == "C6_QTDVEN"}) //Add 19112020 - Marcos Floridi - Fix System
	_xEntPrev	:= 0
	//----------------Estoque Vinculado
