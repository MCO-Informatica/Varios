...
±±ºPrograma  ³NOVO10    º Autor ³ AP6 IDE            º Data ³  31/05/19   º±±
...
User Function SHPCP009
	...
	Private cCadastro := "Calendario x CC"
	//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
	...
	Private cString := "SZR"
	PRIVATE aCores := {}
	AADD(aCores,{ "empty(SZR->ZR_PERIODO) " 	, 'BR_VERDE'})//Movimento pendente
	//AADD(aCores,{ "!EMPTY(SZQ->B8_NUMSEQ) " , 'BR_VERMELHO'})//Movimento realizado
	...
	//³                        cara de outra cor.                           ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	cExprFilTop := ""//"B8_SALDO>0 "
	If Funname()$"RPCPC006"
		cExprFilTop += " AND B8_LOCAL='10' "
	EndIf
	dbSelectArea(cString)
	mBrowse( 6,1,22,75,cString,,,,,,/*aCores*/,,,,,,,,/*cExprFilTop*/)
