...
* Autor			:	Joใo Zabotto
* Data			: 	17/04/2014
* Descricao		:	Rotina Responsแvel por criar o campo ALJ_ZZCOTR para gera็ใo de lan็amento transit๓rio.
* Retorno		: 	
*/
User Function ZUCTGTRA( cEmpAmb, cFilAmb )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  17/04/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'C.O Transito'															, ; //X3_TITULO
	'C.O Transito'															, ; //X3_TITSPA
	'C.O Transito'															, ; //X3_TITENG
	'C.O Transitoria'														, ; //X3_DESCRIC
	'C.O Transitoria'														, ; //X3_DESCSPA
	'C.O Transitoria'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'C.C Transito'															, ; //X3_TITULO
	'C.C Transito'															, ; //X3_TITSPA
	'C.C Transito'															, ; //X3_TITENG
	'C.C Transitoria'														, ; //X3_DESCRIC
	'C.C Transitoria'														, ; //X3_DESCSPA
	'C.C Transitoria'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
