...
* Autor			:	Joใo Zabotto
* Data			: 	17/04/2014
* Descricao		:	Rotina responsavel por alterar os parametros para ativa็ใo da contingencia do PCO, nใo precisa ser executado em modo exclusivo.
* Retorno		: 	
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX6 บ Autor ณ TOTVS Protheus     บ Data ณ  17/04/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function FSAtuSX6( cTexto )
	...
	'MV_PCOCTGP'															, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Habilita a utiliza็ใo de senha no processo de'							, ; //X6_DESCRIC
	...
	'ta็ใo, libera็ใo ou cancelamento de contig๊ncia'						, ; //X6_DESC1
	'contingencias presupuestarias.'										, ; //X6_DSCSPA1
	'budgetary contingencies approval'										, ; //X6_DSCENG1
	'.T. - Envia e-mail / .F. - Nใo envia e-mail'							, ; //X6_DESC2
	...
	'0 - Nใo utiliza o recurso.'											, ; //X6_DESC1
	...
	'MV_PCOSDCT'															, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Ativar controle de saldo de Conting๊ncia.'								, ; //X6_DESCRIC
	...
	'MV_PCOVENC'															, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Numero de dias para vencimento da solicita็ใo de'						, ; //X6_DESCRIC
	...
	'MV_PCOWFCT'															, ; //X6_VAR
	'L'																		, ; //X6_TIPO
	'Ativar aprova็ใo de saldo de Conting๊ncia atrav้s'						, ; //X6_DESCRIC
...
//
	...
	For nI := 1 To Len( aSX6 )
		...
		Else
			lContinua := .T.
			lReclock  := .F.
			cTexto += "Foi Alterado o parโmetro " + aSX6[nI][1] + aSX6[nI][2] + " Conte๚do [" + AllTrim( aSX6[nI][13] ) + "]"+ CRLF
		EndIf
