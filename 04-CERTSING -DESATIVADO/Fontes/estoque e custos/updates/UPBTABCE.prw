...
±±³Fun‡ao    ³UPDTABCE  ³ Autor ³ MICROSIGA             ³ Data ³ 05/03/15 ³±±
...
Processa({|| ProcATU()},"Processando [UPDTABCE]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH050215] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
...
AADD(aRegs,{"DA0",;
	...
	"€",;
	"                                                                                                                                ",;
	"1=GAR;2=HARD.AVULSO;3=PORT.ASSINATURA;4=CURSOS;5=PORT.SSL                                                                       ",;
	"                                                                                                                                ",;
	"                                                                                                                                ",;
	"                    ",;
	"                                                            ",;
