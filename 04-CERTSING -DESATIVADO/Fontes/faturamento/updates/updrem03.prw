...
/*/
//--------------------------------------------------------------------
User Function UPDREM03( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDREM03" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDREM03" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'FECHAMENTO DE REMUNERACAO'												, ; //X2_NOME
	'FECHAMENTO DE REMUNERACAO'												, ; //X2_NOMESPA
	'FECHAMENTO DE REMUNERACAO'												, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Quebra Rel.'															, ; //X3_TITULO
	'Quebra Rel.'															, ; //X3_TITSPA
	'Quebra Rel.'															, ; //X3_TITENG
	'Quebra do Relatorio'													, ; //X3_DESCRIC
	'Quebra do Relatorio'													, ; //X3_DESCSPA
	'Quebra do Relatorio'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=CCR;2=Cartorio'														, ; //X3_CBOX
	'1=CCR;2=Cartorio'														, ; //X3_CBOXSPA
	'1=CCR;2=Cartorio'														, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Valor AR SW'															, ; //X3_TITULO
	'Valor AR SW'															, ; //X3_TITSPA
	'Valor AR SW'															, ; //X3_TITENG
	'Valor AR SW'															, ; //X3_DESCRIC
	'Valor AR SW'															, ; //X3_DESCSPA
	'Valor AR SW'															, ; //X3_DESCENG
	'@E 999,999,999,999.99'													, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Valor AR HW'															, ; //X3_TITULO
	'Valor AR HW'															, ; //X3_TITSPA
	'Valor AR HW'															, ; //X3_TITENG
	'Valor AR HW'															, ; //X3_DESCRIC
	'Valor AR HW'															, ; //X3_DESCSPA
	'Valor AR HW'															, ; //X3_DESCENG
	'@E 999,999,999,999.99'													, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
