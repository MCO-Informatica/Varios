...
/*/
//--------------------------------------------------------------------
User Function UPDSAGE( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSAGE" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSAGE" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'Cadastro de DUA'														, ; //X2_NOME
	'Cadastro de DUA'														, ; //X2_NOMESPA
	'Cadastro de DUA'														, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'OrigCheckout'															, ; //X3_TITULO
	'OrigCheckout'															, ; //X3_TITSPA
	'OrigCheckout'															, ; //X3_TITENG
	'Origem CheckOut'														, ; //X3_DESCRIC
	'Origem CheckOut'														, ; //X3_DESCSPA
	'Origem CheckOut'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'8=Prodest;11=Sage;'													, ; //X3_CBOX
	'8=Prodest;11=Sage;'													, ; //X3_CBOXSPA
	'8=Prodest;11=Sage;'													, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Voucher Sage'															, ; //X3_TITULO
	'Voucher Sage'															, ; //X3_TITSPA
	'Voucher Sage'															, ; //X3_TITENG
	'Voucher Sage'															, ; //X3_DESCRIC
	'Voucher Sage'															, ; //X3_DESCSPA
	'Voucher Sage'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
