...
±±³Fun‡ao    ³GH021015  ³ Autor ³ MICROSIGA             ³ Data ³ 02/10/15 ³±±
...
Processa({|| ProcATU()},"Processando [UPDPSTFI]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [UPDPSTFI] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
...
aRegs  := {}
AADD(aRegs,{"SZ3","60","Z3_POSTOFI","C",08,00,"Posto Fisico","Posto Fisico","Posto Fisico","Posto Fisico ","Posto Fisico ","Posto Fisico "," "," ","€€€€€€€€€€€€€€ "," ","PAS_01",00,"þA"," "," ","U","N","A","R"," "," "," "," "," "," "," "," "," "," "," "," "," "," ","N","N"," "," ","N","N","N"})
AADD(aRegs,{"SZ3","61","Z3_DESPTSF","C",60,00,"Desc Posto F","Desc Posto F","Desc Posto F","Desc Posto F ","Desc Posto F ","Desc Posto F "," "," ","€€€€€€€€€€€€€€ ","If(!INCLUI,Posicione('PAS',1,xFilial('PAS')+M->Z3_POSTOFI,'PAS_DESCRI'),' ') "," ",00,"þA"," "," ","U","N","V","V"," "," "," "," "," "," "," "," "," "," "," "," "," "," ","N","N"," "," ","N","N","N"})
...
aRegs  := {}
AADD(aRegs,{"SZB","14","ZB_POSTOFI","C",08,00,"Posto Fisico","Posto Fisico","Posto Fisico","Posto Fisico ","Posto Fisico ",;
"Posto Fisico "," "," ","€€€€€€€€€€€€€€ "," ","PAS_01",00,"þA"," "," ","U","N","A","R"," "," "," "," "," "," "," "," "," ",;
" "," "," "," "," ","N","N"," "," ","N","N","N"})
