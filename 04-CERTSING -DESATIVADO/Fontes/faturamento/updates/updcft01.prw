...
/*/
//--------------------------------------------------------------------
User Function UPDCFT01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDCFT01" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDCFT01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Rem.Campanha'															, ; //X3_TITULO
	'Rem.Campanha'															, ; //X3_TITSPA
	'Rem.Campanha'															, ; //X3_TITENG
	'Remunera Campanha Contado'												, ; //X3_DESCRIC
	'Remunera Campanha Contado'												, ; //X3_DESCSPA
	'Remunera Campanha Contado'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Remunera Campanha do Contador' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZF_CAMPANH", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZF_CAMPANH" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Remunera Clube do Revendedor' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZF_CLUBE  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZF_CLUBE" + CRLF
