...
±±ºPrograma  ³MTA270MNU ºAutor  ³Microsiga           º Data ³  12/23/09   º±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³NOVO2     ºAutor  ³Microsiga           º Data ³  12/23/09   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³                                                            º±±
±±º          ³                                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
Aadd( aSays, "GERA INVENTÁRIO PARA ZERAR O ESTOQUE." )
Aadd( aSays, "" )
Aadd( aSays, "Esta rotina tem o objetivo de criar movimentos de enventário para zerar o estoque." )
Aadd( aSays, "Selecione os parâmetros para indicar o tipo de movimento a ser gerado." )
Aadd( aSays, "Ao clicar no OK o sistema irá gerar a movimentação de inventário." )

Aadd(aButtons, { 5,.T.,{|| Pergunte(cPerg, .T. ) } } )
Aadd(aButtons, { 1,.T.,{|| Processa( {|| A270Proc(Mv_Par01) }, "Gerando Inventário..."), FechaBatch() }} )
...
Aadd(aRegs,{cPerg,"04","Grupo de Produtos Até",	"","","MV_CH4","C",04,0,0,"G","","Mv_Par04","","","","","","","","","","","","","","","","","","","","","","","","","SBM","","","","",""})
Aadd(aRegs,{cPerg,"05","Tipo de Material De",	"","","MV_CH5","C",02,0,0,"G","","Mv_Par05","","","","","","","","","","","","","","","","","","","","","","","","","02","","","","",""})
Aadd(aRegs,{cPerg,"06","Tipo de Material Até",	"","","MV_CH6","C",02,0,0,"G","","Mv_Par06","","","","","","","","","","","","","","","","","","","","","","","","","02","","","","",""})
...
Aadd(aRegs,{cPerg,"10","Armazem Até",			"","","MV_CHA","C",02,0,0,"G","","Mv_Par10","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""})
