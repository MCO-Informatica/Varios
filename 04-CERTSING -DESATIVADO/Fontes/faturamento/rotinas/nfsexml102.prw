	...
	If DbSeek(xFilial("SF2")+cNota+cSerie+cClieFor+cLoja)	
		...
		While !Eof() .And. xFilial("SD2") == (cAliasSD2)->D2_FILIAL .And.;
			...
			If dbSeek(xFilial("SX5")+"60"+RetFldProd(SB1->B1_COD,"B1_CODISS"))
				cDescServ := If(FindFunction('CleanSpecChar'),CleanSpecChar(AllTrim(SubStr(SX5->X5_DESCRI,1,55))),AllTrim(SubStr(SX5->X5_DESCRI,1,55)))    			
   			EndIf
...
ElseIf Alltrim(SM0->M0_CODMUN) $ "3550308-3304557-3303906-2927408" .And. aNota[04] == "0" .or. aNota[04] == "3" // NFTS: São Paulo, Rio de Janeiro, Petrópolis e Salvador
...
For Nx := 1 to Len(aProd)
	...
	EndIf
	If Alltrim(SM0->M0_CODMUN) $ "2607208-3550308-3304557" //IPOJUCA - PE # Sao Paulo - SP  # Rio de Janeiro - RJ
...
If !Alltrim(SM0->M0_CODMUN) $ "3305505-4205407"
