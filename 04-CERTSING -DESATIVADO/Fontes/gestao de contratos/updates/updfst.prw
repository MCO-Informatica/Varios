...
aAdd( aSX2, { ;
	...
	'NOTAS DE EMPENHO'														, ; //X2_NOME
	'NOTAS DE EMPENHO'														, ; //X2_NOMESPA
	'NOTAS DE EMPENHO'														, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
aAdd( aSX3, { ;
	...
	'Oportunidade'															, ; //X3_TITSPA
	'Oportunidade'															, ; //X3_TITENG
	'Oportunidade'															, ; //X3_DESCRIC
	'Oportunidade'															, ; //X3_DESCSPA
	'Oportunidade'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Gera Pedido?'															, ; //X3_TITULO
	'Gera Pedido?'															, ; //X3_TITSPA
	'Gera Pedido?'															, ; //X3_TITENG
	'Gera Pedido?'															, ; //X3_DESCRIC
	'Gera Pedido?'															, ; //X3_DESCSPA
	'Gera Pedido?'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Nr.Contrato'															, ; //X3_DESCRIC
	'Nr.Contrato'															, ; //X3_DESCSPA
	'Nr.Contrato'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nr. Planilha'															, ; //X3_TITULO
	'Nr. Planilha'															, ; //X3_TITSPA
	'Nr. Planilha'															, ; //X3_TITENG
	'Nr. Planilha'															, ; //X3_DESCRIC
	'Nr. Planilha'															, ; //X3_DESCSPA
	'Nr. Planilha'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nr.Medicao'															, ; //X3_TITULO
	'Nr.Medicao'															, ; //X3_TITSPA
	'Nr.Medicao'															, ; //X3_TITENG
	'Nr.Medicao'															, ; //X3_DESCRIC
	'Nr.Medicao'															, ; //X3_DESCSPA
	'Nr.Medicao'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nota Empenho'															, ; //X3_TITULO
	'Nota Empenho'															, ; //X3_TITSPA
	'Nota Empenho'															, ; //X3_TITENG
	'Nota Empenho'															, ; //X3_DESCRIC
	'Nota Empenho'															, ; //X3_DESCSPA
	'Nota Empenho'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZW'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZW_FILIAL+ZW_NRCONT+ZW_NRPLAN+ZW_REVISA+ZW_NOTA'						, ; //CHAVE
	'Nr.Contrato+Nr. Planilha+Rev.Contrato+Nota Empenho'					, ; //DESCRICAO
	'Nr.Contrato+Nr. Planilha+Rev.Contrato+Nota Empenho'					, ; //DESCSPA
	'Nr.Contrato+Nr. Planilha+Rev.Contrato+Nota Empenho'					, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSX6, { ;
	...
	'MV_CN100SI'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Envia alteracao de status do contrato.'								, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'renato.bernardo@certisign.com.br;bcosta@certisign.com.br'				, ; //X6_CONTEUD
	'renato.bernardo@certisign.com.br;bcosta@certisign.com.br'				, ; //X6_CONTSPA
	'renato.bernardo@certisign.com.br;bcosta@certisign.com.br'				, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		} ) //X6_PYME
...
aAdd( aSX6, { ;
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'renato.bernardo@certisign.com.br'										, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
	''																		, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		} ) //X6_PYME
...
PutHelp( "PAD1_XNATUR", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AD1_XNATUR" + CRLF

//
// Helps Tabela CN9
//
aHlpPor := {}
aAdd( aHlpPor, 'Código da oportunidade para' )
aAdd( aHlpPor, 'preenchimento da natureza e vendedor.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PCN9_XOPORT", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "CN9_XOPORT" + CRLF
