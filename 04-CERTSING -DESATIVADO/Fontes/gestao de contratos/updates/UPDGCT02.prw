...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tipo Periodo'															, ; //X3_TITULO
	'Tipo Periodo'															, ; //X3_TITSPA
	'Tipo Periodo'															, ; //X3_TITENG
	'Tipo Periodo'															, ; //X3_DESCRIC
	'Tipo Periodo'															, ; //X3_DESCSPA
	'Tipo Periodo'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Dia;2=Mes;3=Ano'														, ; //X3_CBOX
	'1=Dia;2=Mes;3=Ano'														, ; //X3_CBOXSPA
	'1=Day;2=Month;3=Year'													, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Ult.Medicao'															, ; //X3_TITULO
	'Ult.Medicao'															, ; //X3_TITSPA
	'Ult.Medicao'															, ; //X3_TITENG
	'Ult.Medicao'															, ; //X3_DESCRIC
	'Ult.Medicao'															, ; //X3_DESCSPA
	'Ult.Medicao'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX6, { ;
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'001075,000554'															, ; //X6_CONTEUD
	'001075,001076'															, ; //X6_CONTSPA
	'001075,001076'															, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		} ) //X6_PYME
...
aAdd( aSX6, { ;
	...
	'MV_CSGCT07'															, ; //X6_VAR
	'C'																		, ; //X6_TIPO
	'Aviso de Caucao para o financeiro.'									, ; //X6_DESCRIC
	''																		, ; //X6_DSCSPA
	''																		, ; //X6_DSCENG
	''																		, ; //X6_DESC1
	''																		, ; //X6_DSCSPA1
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'renato.bernardo@certisign.com.br;lcoelho@certisign.com.br'				, ; //X6_CONTEUD
	''																		, ; //X6_CONTSPA
	''																		, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		} ) //X6_PYME
