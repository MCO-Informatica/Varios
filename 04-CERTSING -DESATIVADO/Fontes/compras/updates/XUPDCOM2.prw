...
/*/
//--------------------------------------------------------------------
User Function XUPDCOM2( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "XUPDCOM2" )
				Else
					MsgStop( "Atualização não Realizada.", "XUPDCOM2" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'C. Custo'																, ; //X3_TITSPA
	'C. Custo'																, ; //X3_TITENG
	'Centro de Custos'														, ; //X3_DESCRIC
	'Centro de Custos'														, ; //X3_DESCSPA
	'Centro de Custos'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	150																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'E-Mail Aprov'															, ; //X3_TITULO
	'E-Mail Aprov'															, ; //X3_TITSPA
	'E-Mail Aprov'															, ; //X3_TITENG
	'E-Mail Aprovador de SC'												, ; //X3_DESCRIC
	'E-Mail Aprovador de SC'												, ; //X3_DESCSPA
	'E-Mail Aprovador de SC'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Centro de Custos' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAI_XCC    ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AI_XCC" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Aprovador da Solicitação de Compras.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAI_XAPROV ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AI_XAPROV" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'E-Mail Aprovador de Solicitação de' )
aAdd( aHlpPor, 'Compras.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PAI_XMAIL  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "AI_XMAIL" + CRLF
