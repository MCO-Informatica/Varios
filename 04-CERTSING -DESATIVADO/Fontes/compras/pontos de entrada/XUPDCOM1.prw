...
/*/
//--------------------------------------------------------------------
User Function XUPDCOM1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "XUPDCOM1" )
				Else
					MsgStop( "Atualização não Realizada.", "XUPDCOM1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Gr.Aprov.'																, ; //X3_TITSPA
	'Gr.Aprov.'																, ; //X3_TITENG
	'Gr.Aprov.Compras'														, ; //X3_DESCRIC
	'Gr.Aprov.Compras'														, ; //X3_DESCSPA
	'Gr.Aprov.Compras'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
