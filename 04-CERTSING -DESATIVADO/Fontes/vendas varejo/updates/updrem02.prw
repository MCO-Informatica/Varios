...
/*/
//--------------------------------------------------------------------
User Function UPDREM02( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDREM02" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDREM02" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Ctr.Faixa'																, ; //X3_TITSPA
	'Ctr.Faixa'																, ; //X3_TITENG
	'Controle de Faixas'													, ; //X3_DESCRIC
	'Controle de Faixas'													, ; //X3_DESCSPA
	'Controle de Faixas'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Prod.Faixa'															, ; //X3_TITULO
	'Prod.Faixa'															, ; //X3_TITSPA
	'Prod.Faixa'															, ; //X3_TITENG
	'Produtos Controle Faixa'												, ; //X3_DESCRIC
	'Produtos Controle Faixa'												, ; //X3_DESCSPA
	'Produtos Controle Faixa'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
