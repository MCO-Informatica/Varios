...
/*/
//--------------------------------------------------------------------
User Function updcft08( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDFAT08" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDFAT08" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSXA, { ;
	'SZ3'																	, ; //XA_ALIAS
	'2'																		, ; //XA_ORDEM
	'Regras de Remuneracao'													, ; //XA_DESCRIC
	'Regras de Remuneracao'													, ; //XA_DESCSPA
	'Regras de Remuneracao'													, ; //XA_DESCENG
	'U'																		, ; //XA_PROPRI
	''																		, ; //XA_AGRUP
	''																		} ) //XA_TIPO
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Entidade Grupo/Rede'													, ; //XB_DESCRI
	'Entidade Grupo/Rede'													, ; //XB_DESCSPA
	'Entidade Grupo/Rede'													, ; //XB_DESCENG
	'SZ3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Entidade Grp Projeto'													, ; //XB_DESCRI
	'Entidade Grp Projeto'													, ; //XB_DESCSPA
	'Entidade Grp Projeto'													, ; //XB_DESCENG
	'SZ3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Entidade Revendedor'													, ; //XB_DESCRI
	'Entidade Revendedor'													, ; //XB_DESCSPA
	'Entidade Revendedor'													, ; //XB_DESCENG
	'SZ3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod Pareceiro'															, ; //XB_DESCRI
	'Cod Pareceiro'															, ; //XB_DESCSPA
	'Cod Pareceiro'															, ; //XB_DESCENG
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod Ent GAR'															, ; //XB_DESCRI
	'Cod Ent GAR'															, ; //XB_DESCSPA
	'Cod Ent GAR'															, ; //XB_DESCENG
	'Z3_CODGAR'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Entidade Federacao'													, ; //XB_DESCRI
	'Entidade Federacao'													, ; //XB_DESCSPA
	'Entidade Federacao'													, ; //XB_DESCENG
	'SZ3'																	} ) //XB_CONTEM
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Zera CCR' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZ3_ZERA   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "Z3_ZERA" + CRLF
