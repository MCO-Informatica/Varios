...
/*/
//--------------------------------------------------------------------
User Function UPDTAB01( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTAB01" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTAB01" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Imagem'																, ; //X3_TITSPA
	'Imagem'																, ; //X3_TITENG
	'Imagem no checkout'													, ; //X3_DESCRIC
	'Imagem no checkout'													, ; //X3_DESCSPA
	'Imagem no checkout'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'imagens do checkout'													, ; //XB_DESCRI
	'imagens do checkout'													, ; //XB_DESCSPA
	'imagens do checkout'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'PA8'																	} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDTAB01" ) ) ) ;
