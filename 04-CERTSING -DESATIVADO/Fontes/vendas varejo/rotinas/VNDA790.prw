                ...
                */
                ...
                if len(aColsEx) > 0
                    ...
                    DEFINE MSDIALOG oDlg TITLE cTitulo FROM 000, 000  TO 400, 1200  PIXEL
                        ...
                        oLista:SetLocate() // Habilita a Localização de registros
                        ...
                        oLista:addColumn({"Emissão"  ,{||aColsEx[oLista:nAt,03]}, "D", "@D"                  , 1, 08 , 0, .F., , .F.,, "aColsEx[oLista:nAt,03]",, .F., .T.,  , "Emissao" })
                        oLista:addColumn({"Cliente"  ,{||aColsEx[oLista:nAt,04]}, "C", "@!"                  , 1, 09 , 0, .F., , .F.,, "aColsEx[oLista:nAt,04]",, .F., .T.,  , "Cliente" })
                        oLista:addColumn({"NºParc"   ,{||aColsEx[oLista:nAt,05]}, "N", "@E 999"              , 1, 03 , 0, .F., , .F.,, "aColsEx[oLista:nAt,05]",, .F., .T.,  , "nroparc" })
                        ...
                        oLista:addColumn({"Operação" ,{||aColsEx[oLista:nAt,09]}, "C", "@!"                  , 1, 02 , 0, .F., , .F.,, "aColsEx[oLista:nAt,09]",, .F., .T.,  , "oper" })
                        ...
                        //oLista:setInsert(.T.)  // habilitar inserÃ§Ã£o
                        //oLista:SetDelete(.T.)  // habilitar deleÃ§Ã£o
                        //oLista:DelLine(.T.) // Para executar uma funÃ§Ã£o
                        //oLista:LineOk(.T.)  // Para executar uma funÃ§Ã£o
                        oLista:Activate(.T.)
                        */
