...
/*/
//--------------------------------------------------------------------
User Function UPDCFT02( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDCFT02" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDCFT02" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	9																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Preco Renov.'															, ; //X3_TITULO
	'Preco Renov.'															, ; //X3_TITSPA
	'Preco Renov.'															, ; //X3_TITENG
	'Preco Renovacao'														, ; //X3_DESCRIC
	'Preco Renovacao'														, ; //X3_DESCSPA
	'Preco Renovacao'														, ; //X3_DESCENG
...
aAdd( aSX7, { ;
	'C5_PONDIS'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'SZ8->Z8_FORNEC'														, ; //X7_REGRA
	'C5_CLIENTE'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'SZ8'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("SZ8")+M->C5_PONDIS'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Ponto de Distribuicao' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PC5_PONDIS ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "C5_PONDIS" + CRLF
