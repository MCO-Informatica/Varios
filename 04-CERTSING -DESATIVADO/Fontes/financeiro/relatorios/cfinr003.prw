...
Local nLin     := 80
Local Cabec1   := " Codigo      Nome do Cliente  Titulo   Parc Vencimento Prefixo   Pedido   Saldo    Observacao                                                                                                  Dt_Emissao_Ped     "
Local Cabec2   := "                               "
Local imprime  := .T.
Local aOrd 		:= {}
Private lEnd         := .F.
...
Private limite       := 220
Private tamanho      := "G"
Private nomeprog     := "CFINR003"
Private nTipo        := 18
Private aReturn      := { "Zebrado", 1, "Administracao", 2, 2, 1, "", 1}
Private nLastKey     := 0
Private cPerg       := "RFIN03"
//Private cbtxt      	:= Space(10)
Private cbcont     	:= 00
Private CONTFL     	:= 01
Private m_pag      	:= 01
Private wnrel      	:= "CFINR003"
Private cString		:= "SE1"
...
cSelect	+= "AND C5_MENNOTA LIKE '%POR CARTAO%' AND C5_NUM = E1_PEDIDO "+ENTER 
...
cSelect	+= "E1_EMISSAO >= '"+ dtos(MV_PAR05) +"' And E1_EMISSAO   <= '"+ dtos(MV_PAR06) +"' And "+ENTER 
cSelect	+= "E1_CLIENTE = A1_COD And E1_LOJA = A1_LOJA and E1_SALDO > 0 "+ENTER 
cSelect	+= "AND C5_MENNOTA LIKE '%PAGO%' AND C5_NUM = E1_PEDIDO "+ENTER 
cSelect	+= "Order By E1_PREFIXO, E1_NUM"+ENTER       
...
Do While !TMPQ->(EOF())
	...
	@nLin,065 pSay TMPQ->C5_NUM 							 // numero do Pedido
	...
	@nLin,085 psay Substr(TMPQ->C5_MENNOTA,1,100)           //MENSAGEM DA NOTA
//	@nLin,168 psay TMPQ->C5_XBANDEI			              //BANDEIRA DO CARTAO 
...
aAdd(aRegs,{cPerg,"07","Departamento			  		   ","","","mv_ch7","N",01,00,01,"C","","","","","mv_par07","Financeiro","Financeiro","Financeiro","","SAV","SAV","SAV","","","","","","","","","","","","","",{"Departamento"}})
