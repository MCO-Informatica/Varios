...
Processa({|| ProcATU()},"Processando [GH888]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [GH888] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
...
aRegs  := {}
AADD(aRegs,{"ADE","N","ADE_FILIAL+ADE_PEDGAR+ADE_DATA                                                                                                                                  ","Pedido GAR+DT Abertura                                                ","Pedido GAR+DT Abertura                                                ","Pedido GAR+DT Abertura                                                ","U","                                                                                                                                                                ","PEDIDOGAR ","N"})
