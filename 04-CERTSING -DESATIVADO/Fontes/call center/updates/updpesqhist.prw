...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPDPESQHIST( cEmpAmb, cFilAmb )
...
//
// Cria indices para pesquisa por E-Mail
//
AAdd( aSIX, { ;
	'SA1'						, ; //INDICE
	'A'							, ; //ORDEM
	'A1_FILIAL+A1_EMAIL' 		, ; //CHAVE
	'E-Mail'   					, ; //DESCRICAO
	'E-Mail'   					, ; //DESCSPA
	'E-Mail'    				, ; //DESCENG
	'U'							, ; //PROPRI
