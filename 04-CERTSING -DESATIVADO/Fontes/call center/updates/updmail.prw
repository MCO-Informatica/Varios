...
±±³Fun‡ao    ³UPDMAIL  ³ Autor ³ OPVS											             ³ Data ³ 18/06/12 ³±±
...
Processa({|| ProcATU()},"Processando [UPDMAIL]","Aguarde , processando preparação dos arquivos")
...
If (lOpen := IIF(Alias() <> "SM0", MyOpenSm0Ex(), .T. ))
	...
	If lOpen
		...
		If lOpen
			...
			DEFINE MSDIALOG oDlg TITLE "Atualizador [UPDMAIL] - Atualizacao concluida." From 3,0 to 340,417 PIXEL
...
aRegs  := {}
AADD(aRegs,{"ADE","A5","ADE_ORGUNI","C",02,00,"Org.Unit","Org.Unit","Org.Unit","Org.Unit","Org.Unit","Org.Unit","@!","","€€€€€€€€€€€€€€ ","","",00,"þÀ","","","U","N","V","R","","","","","","","","","","3","","","","","N","N","","N","N","N"})
AADD(aRegs,{"ADE","A7","ADE_COMNAM","C",60,00,"CommonName","CommonName","CommonName","CommonName","CommonName","CommonName","","","€€€€€€€€€€€€€€ ","","",00,"þÀ","","","U","N","V","R","","","","","","","","","","3","","","","","N","N","","N","N","N"})
AADD(aRegs,{"ADE","A8","ADE_CODREG","C",06,00,"CodigoRegra","CodigoRegra","CodigoRegra","CodigoRegra","CodigoRegra","CodigoRegra","","","€€€€€€€€€€€€€€ ","","",00,"þÀ","","","U","N","V","R","","","","","","","","","","","","","","","N","N","","N","N","N"})
AADD(aRegs,{"ADE","A9","ADE_REGRA","M",80,00,"Regra","Regra","Regra","RegradacaixadeEntrada","RegradacaixadeEntrada","RegradacaixadeEntrada","","","€€€€€€€€€€€€€€ ","If(inclui,'',MSMM(ADE->ADE_CODREG,80))","",00,"þÀ","","","U","N","V","V","","","","","","","","","","","","","","","N","N","","N","N","N"})
...
aRegs  := {}
AADD(aRegs,{"","","Posicione('AD1',1,xFilial('SC6')+M->C6_NROPOR,'AD1_CODCLI')","","","","",00,"","",""})
