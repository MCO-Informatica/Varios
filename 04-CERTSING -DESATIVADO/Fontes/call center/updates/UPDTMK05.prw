...
/*/
//--------------------------------------------------------------------
User Function UPDTMK05( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDTMK05" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDTMK05" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Prioridade do atendimento'												, ; //X3_DESCRIC
	'Prioridade do atendimento'												, ; //X3_DESCSPA
	'Prioridade do atendimento'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Baixa;2=Alta'														, ; //X3_CBOX
	'1=Baixa;2=Alta'														, ; //X3_CBOXSPA
	'1=Baixa;2=Alta'														, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Cod.Origem'															, ; //X3_TITSPA
	'Cod.Origem'															, ; //X3_TITENG
	'Cod.Origem'															, ; //X3_DESCRIC
	'Cod.Origem'															, ; //X3_DESCSPA
	'Cod.Origem'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	15																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Expectativa'															, ; //X3_TITULO
	'Expectativa'															, ; //X3_TITSPA
	'Expectativa'															, ; //X3_TITENG
	'Expectativa'															, ; //X3_DESCRIC
	'Expectativa'															, ; //X3_DESCSPA
	'Expectativa'															, ; //X3_DESCENG
...
aAdd( aSIX, { ;
	'SU4'																	, ; //INDICE
	'6'																		, ; //ORDEM
	'U4_FILIAL+U4_OPERAD+U4_STATUS+U4_XGRUPO'								, ; //CHAVE
	'Operador+Status+Grupo'													, ; //DESCRICAO
	'Operador+Status+Grupo'													, ; //DESCSPA
	'Operador+Status+Grupo'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'BAIXA_FILA'															, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SU4'																	, ; //INDICE
	'7'																		, ; //ORDEM
	'U4_FILIAL+U4_OPERAD+U4_DESC'											, ; //CHAVE
	'Operador+Nome Lista'													, ; //DESCRICAO
	'Operador+Nombre Lista'													, ; //DESCSPA
	'Operator+Nombre Lista'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'CABECLISTA'															, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SUA'																	, ; //INDICE
	'C'																		, ; //ORDEM
	'UA_FILIAL+UA_XORIG'													, ; //CHAVE
	'Atendimento Origem'													, ; //DESCRICAO
	'Atendimento Origem'													, ; //DESCSPA
	'Atendimento Origem'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Codigo de origem do atendimento' )
aAdd( aHlpPor, 'televendas' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PUA_XORIG  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "UA_XORIG" + CRLF
