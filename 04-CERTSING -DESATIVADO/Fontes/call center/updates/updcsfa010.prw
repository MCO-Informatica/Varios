...
ฑฑบ Programa ณ UPDFST   บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPDCSFA010( cEmpAmb, cFilAmb )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
If ( lOpen := MyOpenSm0(.T.) )
	...
	If lOpen
		...
		For nI := 1 To Len( aRecnoSM0 )
			...
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			oProcess:IncRegua1( "Dicionแrio de gatilhos disparadores" + " - " + SM0->M0_CODIGO + " " + SM0->M0_NOME + " ..." )
			FSAtuSX7( @cTexto )

			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณAtualiza o dicionแrio SXB         ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			oProcess:IncRegua1( "Dicionแrio de consulta padrใo" + " - " + SM0->M0_CODIGO + " " + SM0->M0_NOME + " ..." )
			FSAtuSXB( @cTexto )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'Codigo'																, ; //X3_TITSPA
	'Codigo'																, ; //X3_TITENG
	'Codigo do registro'													, ; //X3_DESCRIC
	'Codigo do registro'													, ; //X3_DESCSPA
	'Codigo do registro'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Empresa'																, ; //X3_TITSPA
	'Empresa'																, ; //X3_TITENG
	'Razao social da empresa'												, ; //X3_DESCRIC
	'Razao social da empresa'												, ; //X3_DESCSPA
	'Razao social da empresa'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'CNPJ/CPF'																, ; //X3_TITSPA
	'CNPJ/CPF'																, ; //X3_TITENG
	'CNPJ/CPF da entidade'													, ; //X3_DESCRIC
	'CNPJ/CPF da entidade'													, ; //X3_DESCSPA
	'CNPJ/CPF da entidade'													, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	70																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Common Name'															, ; //X3_TITULO
	'Common Name'															, ; //X3_TITSPA
	'Common Name'															, ; //X3_TITENG
	'Common Name'															, ; //X3_DESCRIC
	'Common Name'															, ; //X3_DESCSPA
	'Common Name'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Consultor'																, ; //X3_TITSPA
	'Consultor'																, ; //X3_TITENG
	'Codigo do consultor'													, ; //X3_DESCRIC
	'Codigo do consultor'													, ; //X3_DESCSPA
	'Codigo do consultor'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	50																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Contato tec.'															, ; //X3_TITULO
	'Contato tec.'															, ; //X3_TITSPA
	'Contato tec.'															, ; //X3_TITENG
	'Contato tecnico'														, ; //X3_DESCRIC
	'Contato tecnico'														, ; //X3_DESCSPA
	'Contato tecnico'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'M->ZT_DT_VLD >= M->ZT_DT_INC'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Orig.Registr'															, ; //X3_TITULO
	'Orig.Registr'															, ; //X3_TITSPA
	'Orig.Registr'															, ; //X3_TITENG
	'Origem do registro'													, ; //X3_DESCRIC
	'Origem do registro'													, ; //X3_DESCSPA
	'Origem do registro'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'No.List.Cont'															, ; //X3_TITULO
	'No.List.Cont'															, ; //X3_TITSPA
	'No.List.Cont'															, ; //X3_TITENG
	'Numero da lista contato'													, ; //X3_DESCRIC
	'Numero da lista contato'													, ; //X3_DESCSPA
	'Numero da lista contato'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Emissao'															, ; //X3_TITSPA
	'Emissao'															, ; //X3_TITENG
	'Data de emissao do cadast'													, ; //X3_DESCRIC
	'Data de emissao do cadast'													, ; //X3_DESCSPA
	'Data de emissao do cadast'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Nome contato'													, ; //X3_DESCSPA
	'Nome contato'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'UF'																, ; //X3_TITSPA
	'UF'																, ; //X3_TITENG
	'Unidade Federativa'													, ; //X3_DESCRIC
	'Unidade Federativa'													, ; //X3_DESCSPA
	'Unidade Federativa'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistCpo("SX5","12"+M->ZT_UF)'			  					, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Estado'																, ; //X3_TITSPA
	'Estado'																, ; //X3_TITENG
	'Estado Brasileiro'													, ; //X3_DESCRIC
	'Estado Brasileiro'													, ; //X3_DESCSPA
	'Estado Brasileiro'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'SZT'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZT_FILIAL+ZT_COMMON+ZT_PRODUTO+DTOS(ZT_DT_INC)+DTOS(ZT_DT_VLD)'		, ; //CHAVE
	'Common Name+Produto+DT. Inclusao+DT. Validade'							, ; //DESCRICAO
	'Common Name+Produto+DT. Inclusao+DT. Validade'							, ; //DESCSPA
	'Common Name+Produto+DT. Inclusao+DT. Validade'							, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZT'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'ZT_FILIAL+ZT_LISTA+ZT_CODIGO'		, ; //CHAVE
	'No.List.Cont+Codigo'							, ; //DESCRICAO
	'No.List.Cont+Codigo'							, ; //DESCSPA
	'No.List.Cont+Codigo'							, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZT'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'ZT_FILIAL+ZT_COMMON'											, ; //CHAVE
	'Common Name'														, ; //DESCRICAO
	'Common Name'														, ; //DESCSPA
	'Common Name'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX5 บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX5- Tabela Genericaณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX5   - Gerado por EXPORDIC / Upd. V.4.10.4 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
For nI := 1 To Len( aSX5 )
	...
	If !SX5->( dbSeek( PadR( aSX5[nI][1], nTamFil ) + aSX5[nI][2] + aSX5[nI][3] ) )
		lContinua := .T.
		lReclock  := .T.
		cTexto += "Foi incluํdo a tabela" + aSX5[nI][2] + " chave [" + aSX5[nI][3] + "]"+ CRLF
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX6 บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX7 บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
For nI := 1 To Len( aSX7 )
	...
	If !SX7->( dbSeek( aSX7[nI][1] + aSX7[nI][2] ) )
		lContinua := .T.
		lReclock  := .T.
		cTexto += "Foi incluํdo o gatilhos " + aSX7[nI][1] + aSX7[nI][2] + " Sequencia [" + AllTrim( aSX7[nI][2] ) + "]"+ CRLF
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSXB บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SXB - Consulta padr.ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
For nI := 1 To Len( aSXB )
	...
	If !SXB->( dbSeek( PadR( aSXB[nI][1], nTamVar ) + aSXB[nI][2] + aSXB[nI][3] + aSXB[nI][4] ) )
		...
		lContinua := .T.
		lReclock  := .T.
		cTexto += "Foi incluํdo a consulta padrใo " + aSXB[nI][1] + " " + CRLF
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'C๓digo do registro.' )
aHlpEng := {}
aHlpSpa := {}
...
aHlpPor := {}
aAdd( aHlpPor, 'Razใo social da empresa.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_EMPRESA", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_EMPRESA" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'CNPJ/CPF da entidade.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_CNPJ   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_CNPJ   " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Common Name.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_COMMON ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_COMMON " + CRLF
...
PutHelp( "PZT_PRODUTO", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_PRODUTO" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'C๓digo do consultor que serแ' )
aAdd( aHlpPor, 'representado pelo c๓digo de vendedor' )
aAdd( aHlpPor, '(SA3).' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_CONSULT", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_CONSULT" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Codigo do operador relacionado com o' )
aAdd( aHlpPor, 'vendedor.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_OPERAD ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_OPERAD " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Contato tecnico.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_CONTTEC", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_CONTTEC" + CRLF
...
PutHelp( "PZT_DT_INC ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_DT_INC " + CRLF
...
PutHelp( "PZT_DT_VLD ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_DT_VLD " + CRLF
...
PutHelp( "PZT_ORIGEM ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_ORIGEM " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'N๚mero da lista de contato.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_LISTA  ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_LISTA " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Data de emiSsใo do cadastro.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_EMISSAO", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_EMISSAO " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Nome do contato Common Name.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_NOME", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_NOME " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Sigla da Unidade Federativa, ' )
aAdd( aHlpPor, 'ou seja, a sigla do estado' )
aAdd( aHlpPor, 'brasileiro.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_UF", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_UF " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Nome do estado brasileiro.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_ESTADO", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_ESTADO " + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'N๚mero do telefone.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZT_FONE", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "ZT_FONE " + CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  20/08/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
