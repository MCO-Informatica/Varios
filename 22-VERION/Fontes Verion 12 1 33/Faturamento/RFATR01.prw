...
cQuery := " SELECT D2_EMISSAO,D2_DOC,D2_SERIE,D2_TIPO,D2_CLIENTE,D2_LOJA,D2_COD,D2_EST,D2_CF,D2_QUANT,D2_PRCVEN,D2_VALBRUT,D2_PICM,D2_BASEICM,D2_VALICM,D2_IPI,D2_BASEIPI,D2_VALIPI,D2_BASEISS,D2_VALISS,D2_ALQIMP5,D2_VALIMP5,D2_ALQIMP6,D2_VALIMP6, D2_ICMSRET "
...
cQuery := " SELECT D1_DTDIGIT,D1_DOC,D1_SERIE,D1_TIPO,D1_FORNECE,D1_LOJA,D1_COD,D1_CF,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_PICM,D1_BASEICM,D1_VALICM,D1_IPI,D1_BASEIPI,D1_VALIPI,D1_BASEISS,D1_VALISS,((D1_TOTAL+D1_VALIPI)-D1_VALICM-D1_VALIPI-D1_VALISS),D1_ALQIMP5,D1_VALIMP5,D1_ALQIMP6,D1_VALIMP6,D1_NFORI,D1_SERIORI,D1_ICMSRET "
...
cTxt += "VLR_COFINS"+";"+"ALIQ_PIS"+";"+"VLR_PIS"+";"+"VLR_LIQ"+";"+"VEND"+";"+"NOME_VEND"+";"+"REPR"+";"+"NOME_REPR"+";"+"ICMS_ST"
...
Do While WorkS->(!EOF())
	...
	cTxt += ";"+Iif(Left(Stuff(Str(D2_ICMSRET),Rat(".",Str(D2_ICMSRET)),1,","),1)==",",Str(D2_ICMSRET),Stuff(Str(D2_ICMSRET),Rat(".",Str(D2_ICMSRET)),1,","))+";"
...
Do While WorkE->(!EOF())
    ...
    cMunic  := Iif(WorkE->D1_TIPO$"BD",Posicione("SA1",1,xFilial("SA1")+WorkE->D1_FORNECE+WorkE->D1_LOJA,"A1_MUN"),Posicione("SA2",1,xFilial("SA2")+WorkE->D1_FORNECE+WorkE->D1_LOJA,"A2_MUN"))
   ...
   IF  (WorkS->D2_TIPO$"BD" .and. SA1->A1_EST >= cEstDe .and. SA1->A1_EST <= cEstAte .and.  iif(Empty(alltrim(cMun)),.t.,cMun $ SA1->A1_MUN )) ;
	...
	cTxt += ";"+Iif(Left(Stuff(Str(WorkE->D1_ICMSRET),Rat(".",Str(WorkE->D1_ICMSRET)),1,","),1)==",",Str(WorkE->D1_ICMSRET),Stuff(Str(WorkE->D1_ICMSRET),Rat(".",Str(WorkE->D1_ICMSRET)),1,","))
...
cQuery := " SELECT D2_FILIAL,D2_DOC,D2_SERIE,D2_TIPO,D2_CLIENTE,D2_LOJA,D2_CF,SUM(D2_VALBRUT)D2_VALBRUT,SUM(D2_PICM)D2_PICM,SUM(D2_BASEICM)D2_BASEICM,SUM(D2_VALICM)D2_VALICM,SUM(D2_IPI)D2_IPI,SUM(D2_BASEIPI)D2_BASEIPI,SUM(D2_VALIPI)D2_VALIPI,SUM(D2_BASEISS)D2_BASEISS,SUM(D2_VALISS)D2_VALISS,MAX(D2_ALQIMP5)D2_ALQIMP5,SUM(D2_VALIMP5)D2_VALIMP5,MAX(D2_ALQIMP6)D2_ALQIMP6,SUM(D2_VALIMP6)D2_VALIMP6,SUM(D2_ICMSRET)D2_ICMSRET "
cQuery += " FROM " +RetSqlName("SD2") + " D2 " 
...
cTxt += "VLR_COF"+";"+"PIS"+";"+"VLR_PIS"+";"+" "+";"+" "+";"+" "+";"+" "+";"+"ICMS_ST"
fWrite(nHdlText,cTxt+Chr(13)+Chr(10))
...
cTxt += Iif(Left(Stuff(Str(nTSVlIm7),Rat(".",Str(nTSVlIm7)),1,","),1)==",",Str(nTSVlIm7),Stuff(Str(nTSVlIm7),Rat(".",Str(nTSVlIm7)),1,","))
fWrite(nHdlText,ctxt+Chr(13)+Chr(10))
...
cTxt += Iif(Left(Stuff(Str(nTEVlIm7),Rat(".",Str(nTEVlIm7)),1,","),1)==",",Str(nTEVlIm7),Stuff(Str(nTEVlIm7),Rat(".",Str(nTEVlIm7)),1,","))
fWrite(nHdlText,ctxt+Chr(13)+Chr(10))
...
cTxt += Iif(Left(Stuff(Str(nTGVlIm7),Rat(".",Str(nTGVlIm7)),1,","),1)==",",Str(nTGVlIm7),Stuff(Str(nTGVlIm7),Rat(".",Str(nTGVlIm7)),1,","))
fWrite(nHdlText,ctxt+Chr(13)+Chr(10))
