...
If Empty(_nPosQtdSC) .OR. _nPosQtdSC == Nil
	_nPosQtdSC := 0
EndIf
...
For _nlinat := 1 to len(aret)
	...
	if ALLTRIM(aret[_nlinat,01]) <> "PRODUTO"
		...
		acols[N,_nPosQtdSC ]    := 0//Space(TAMSX3("C7_QTDSOL")[1])
		M->C7_QTDSOL            := 0//Space(TAMSX3("C7_QTDSOL")[1])

		acols[N,_nPosValIPI ]   := 0//Space(TAMSX3("C7_VALIPI")[1])
		M->C7_VALIPI            := 0//Space(TAMSX3("C7_VALIPI")[1])

		acols[N,_nPosBaseIPI ]  := 0//Space(TAMSX3("C7_BASEIPI")[1])
		M->C7_BASEIPI           := 0//Space(TAMSX3("C7_BASEIPI")[1])
