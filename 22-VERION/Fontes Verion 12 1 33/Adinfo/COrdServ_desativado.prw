...
aCores:= {	{'ZA_STATUS == "B"'  , 'BR_BRANCO'        },;
			...
			{'ZA_STATUS == "R"'  , 'BR_MARROM' /*'RECUSA_ALMOX'*/    },;
			{'ZA_STATUS == "L"'  , 'BR_PINK'          },;
			{'ZA_STATUS == "S"'  , 'BR_AMARELO'       },;
			{'ZA_STATUS == "J"'  , 'BR_PRETO_0' /*'PEND_ALM'*/         },;
			{'ZA_STATUS == "O"'  , 'BR_AZUL'          },;
			{'ZA_STATUS == "P"'  , 'BR_CINZA' /*'PEND_FAB'*/         },;
			{'ZA_STATUS == "M"'  , 'BR_PRETO' /*'RECUSA_FABRICA'*/   },;
			{'ZA_STATUS == "C"'  , 'BR_VERDE_ESCURO' /*'ENCERR_FABRICA'*/   },;
			{'ZA_STATUS == "W"'  , 'BR_AZUL_CLARO'    },;
			{'ZA_STATUS == "Y"'  , 'BR_VIOLETA' /*'PEND_ELET'*/        },;
			{'ZA_STATUS == "X"'  , 'BR_PINK' /*'RECUSA_ELET'*/      },;
			{'ZA_STATUS == "Z"'  , 'BR_MARRON_OCEAN' /*'ENCER_ELET'*/       },;
			{'ZA_STATUS == "E"'  , 'DISABLE'          }}
...
BRWLEGENDA(cCADASTRO,"Legenda",{{"BR_BRANCO"      ,"Gerar OP"        },;
								{"ENABLE"         ,"Inclusao"        },;
								{"BR_MARROM"   ,"Recusa Almox"    },;
								{"BR_PINK"        ,"Aprovado"        },;
								{"BR_AMARELO"     ,"Separação"       },;
								{"BR_PRETO_0"       ,"Pendente Almox"  },;
								{"BR_AZUL"        ,"Fabrica"         },;
								{"BR_CINZA"       ,"Pendente Fabr"   },;
								{"BR_PRETO" ,"Recusa Fabrica"  },;
								{"BR_VERDE_ESCURO" ,"Encerrado Fab"   },;
								{"BR_AZUL_CLARO"  ,"Eletronica"      },;     
								{"BR_VIOLETA"      ,"Pendente Eletr"  },;     
								{"BR_PINK"    ,"Recusa Eletr"    },;     																
								{"BR_MARRON_OCEAN"     ,"Encerrado Eletr" },;     								
								{"DISABLE"        ,"Encerrada"       }})
return
