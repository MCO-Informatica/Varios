...
±±ºPrograma  ³A175GRV   ºAutor  ³RICARDO CAVALINI    º Data ³  29/09/2016 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Ponto de entrada para baixa do pedido de compras de        º±±
±±ºDesc.     ³ importacao, visando o pedido indicado pela sra renata      º±±
±±ºDesc.     ³ no processo que temos hoje na parte de estoque             º±±
