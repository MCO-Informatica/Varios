...
if SA1->A1_RISCO <> "A"
   ...
   If (Empty(_cPricom) .or. SA1->A1_RISCO = "F") .and. (INCLUI .or. ALTERA) .and. .not. (ALLTRIM(M->UA_CONDPG)$"050/051/096/097/098/091") //incluído condição de pagamento 091 - Alex Rodrigues - 22/07/2018
      ALERT (" Para Clientes Novos ou Risco = F, Condicao de Pagamento somente A Vista, favor contactar o financeiro ")
   Endif

   If  (_cNroCom < _NCompra .or. SA1->A1_RISCO = "F") .and. _cPricom >= CTOD("01/04/2010") .and. (INCLUI .or. ALTERA) .and. .not. (ALLTRIM(M->UA_CONDPG)$"050/051/096/097/098/091") //incluído condição de pagamento 091 - Alex Rodrigues - 22/07/2018
