...
Do While WorkE->(!EOF())
   ...
   IF  (WorkS->D2_TIPO$"BD" .and. SA1->A1_EST >= cEstDe .and. SA1->A1_EST <= cEstAte .and.  iif(Empty(alltrim(cMun)),.t.,cMun $ SA1->A1_MUN )) ;
	...
	cTxt += D1_COD+";"+Posicione("SB1",1,xFilial("SD1")+D1_COD,"B1_DESC")+";"+Posicione("SB1",1,xFilial("SD1")+D1_COD,"B1_POSIPI")+";"+Posicione("SF1",1,xFilial("SD1")+D1_DOC+D1_SERIE+D1_FORNECE+D1_LOJA,"F1_EST")+";"+cMunic+";"+D1_CF+";"
