...
Private aOrd         := {}
Private CbTxt        := ""
Private cDesc1       := "Este programa gera um relat๓rio de compras."
Private cDesc2       := ""
Private cDesc3       := ""
Private cPict        := ""
Private lEnd         := .F.
...
AADD(_aStru,{"T_Aplicac","C",10,0})//GRUPO DO Aplica็ใo
...
_cPathDest := cGetFile("","Local para gravacไo...",1,,.F.,GETF_LOCALHARD+GETF_NETWORKDRIVE+GETF_RETDIRECTORY )
