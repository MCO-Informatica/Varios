...
// ENVIA O ARQUIVO JSON
    ...
    */
    ...
    If !Empty(cQtde)
        ...
        _cTagjson += '	"instrucao_cobranca_1": "10",' + _CLRF // NÃO PROTESTAR
    ...
    */
    ...
    _cTagjson += '	"data_instrucao_2": "",' + _CLRF
    ...
    */
    _cTagjson += '				"tipo_juros": 5,' + _CLRF
	_cTagjson += '				"valor_juros": "'+strzero(0,17)+'",' + _CLRF
    _cTagjson += '				"percentual_juros": "'+strzero(0,12)+'"' + _CLRF
    //_cTagjson += '				"valor_juros": "'+strzero((SE1->E1_VALJUR*100),17)+'",' + _CLRF
	...
	*/
    _cTagjson += '				"percentual_multa": "000000000000"' + _CLRF
    _cTagjson += '				},' + _CLRF
