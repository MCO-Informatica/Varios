...
±±∫Programa  ≥RFATR05   ∫Autor  ≥Alex Rodrigues-Adinfo≤Data ≥ 26/12/2014  ∫±±
...
aAdd(aSays,"-------------------------------------------------------------------------------------")
aAdd(aSays,"Programa para exportar as notas fiscais de SaÌdas em arquivo, com o Desconto Verion.")
aAdd(aSays,"AtenÁ„o:----------------------------------------------------------------------")
aAdd(aSays,"Arquivo: o caractere separador ser·:  ;  ")
aAdd(aSays,"Filtro CFOP: informe-os separandos-os com VÌrgula Simples")
aAdd(aSays,"DÛlar: o sistema far· 5 tentativas caso n„o encontre a taxa na emiss„o da NF")
...
cTxt += "VENDEDOR"+";"+"NOME VEND"+";"+"GRUPO"+";"+"MUNICIPIO"
...
Do While WorkS->(!EOF())
	...
	DBSELECTAREA("SC5")
	DBSETORDER(1)      
	DBSEEK(XFILIAL("SC5")+WorkS->D2_PEDIDO)
	If SC5->C5_VEND1 < cVendDe .or. SC5->C5_VEND1 > cVendAte
		DbSelectArea("WorkS")
		Dbskip()
		loop	
	Endif
	...
	DBSELECTAREA("SB1")
	DBSETORDER(1)      
	DBSEEK(XFILIAL("SB1")+WorkS->D2_COD)
	...
	DBSELECTAREA("SA1")
	DBSETORDER(1)      
	DBSEEK(XFILIAL("SA1")+WorkS->D2_CLIENTE+WorkS->D2_LOJA)
	If SA1->A1_MUN < cMUNDe .or. SA1->A1_MUN > cMUNAte
		DbSelectArea("WorkS")
		Dbskip()
		loop	
	Endif	                          
...
aAdd(aRegs,{cPerg,"03"  ,"Da NF SaÌda               "	,""      ,""     ,"MV_CH3","C"    ,06      ,0       ,0     ,"G" ,""    ,"MV_PAR03",""         			,""      ,""      ,""   ,""         ,""             		,""      ,""      ,""    ,""        ,""             	,""      ,""     ,""     ,""       ,""             ,""      ,""      ,""    ,""        ,""            ,""      ,""      ,""    ,""})
aAdd(aRegs,{cPerg,"04"  ,"Ate NF SaÌda              "	,""      ,""     ,"MV_CH4","C"    ,06      ,0       ,0     ,"G" ,""    ,"MV_PAR04",""         			,""      ,""      ,""   ,""         ,""            	    	,""      ,""      ,""    ,""        ,""             	,""      ,""     ,""     ,""       ,""             ,""      ,""      ,""    ,""        ,""            ,""      ,""      ,""    ,""})
aAdd(aRegs,{cPerg,"05"  ,"Da Serie NF SaÌda         "	,""      ,""     ,"MV_CH5","C"    ,03      ,0       ,0     ,"G" ,""    ,"MV_PAR05",""         			,""      ,""      ,""   ,""         ,""            		    ,""      ,""      ,""    ,""        ,""             	,""      ,""     ,""     ,""       ,""             ,""      ,""      ,""    ,""        ,""            ,""      ,""      ,""    ,""   })
