...
lOpenArq := .f.
cPerg    := "PRDNFI    "
cTitulo  := "Produtos inexistentes - Nota Fiscal Importação"
...
msgInfo("Foi gerado um arquivo para ser aberto no Excel, localizado no diretório SYSTEM, chamado: " + cFileProd + ".DBF")
