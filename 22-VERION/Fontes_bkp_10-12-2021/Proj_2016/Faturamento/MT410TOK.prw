...
If M->C5_TIPO == "N" .and. _cDpl == "S"
    ...
    If (empty(_cPricom) .or. SA1->A1_RISCO = "F") .and. (INCLUI .or. ALTERA) .and. .not. (ALLTRIM(M->C5_CONDPAG)$"050/051/096/097/098/091")  //incluído condição de pagamento 091 - Alex Rodrigues - 22/07/2018
		ALERT ("Para Clientes Novos ou Risco = F, Condicao de Pagamento somente A Vista, favor contactar o financeiro")
        Return .f.
    Endif
            
   If  (_cNroCom < _NCompra .or. SA1->A1_RISCO = "F") .and. _cPricom >= CTOD("01/04/2010") .and. (INCLUI .or. ALTERA) .and. .not. (ALLTRIM(M->C5_CONDPAG)$"050/051/096/097/098/091") //incluído condição de pagamento 091 - Alex Rodrigues - 22/07/2018
