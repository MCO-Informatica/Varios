...
±±∫Programa  ≥RFATR03   ∫Autor  ≥Fernando Macieira   ∫ Data ≥ 07/Ago/07   ∫±±
±±ÃÕÕÕÕÕÕÕÕÕÕÿÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕÕ ÕÕÕÕÕÕœÕÕÕÕÕÕÕÕÕÕÕÕÕπ±±
±±∫Desc.     ≥ Relatorio de NF's de Entradas e Saidas p/ Excel p/ Almox   ∫±±
...
cQuery := " SELECT D2_TES,D2_EMISSAO,D2_DOC,D2_SERIE,D2_TIPO,D2_CLIENTE,D2_LOJA,D2_COD,D2_EST,D2_CF,D2_QUANT,D2_PRCVEN,D2_VALBRUT,D2_PICM,D2_BASEICM,D2_VALICM,D2_IPI,D2_BASEIPI,D2_VALIPI,D2_BASEISS,D2_VALISS,D2_ALQIMP5,D2_VALIMP5,D2_ALQIMP6,D2_VALIMP6 "
...
cQuery := " SELECT D1_TES,D1_DTDIGIT,D1_DOC,D1_SERIE,D1_TIPO,D1_FORNECE,D1_LOJA,D1_COD,D1_CF,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_PICM,D1_BASEICM,D1_VALICM,D1_IPI,D1_BASEIPI,D1_VALIPI,D1_BASEISS,D1_VALISS,((D1_TOTAL+D1_VALIPI)-D1_VALICM-D1_VALIPI-D1_VALISS),D1_ALQIMP5,D1_VALIMP5,D1_ALQIMP6,D1_VALIMP6,D1_NFORI,D1_SERIORI "
...
cTxt += "CLAS_IPI"+";"+"UF"+";"+"CFOP"+";"+"QTD"+";"+"TES"+";"+"ATU.ESTOQUE"
/*
...
Do While WorkS->(!EOF())
	...
	cTxt += D2_TES+";"+Posicione("SF4",1,xFilial("SF4")+D2_TES,"F4_ESTOQUE")
/*
...
Do While WorkE->(!EOF())
	...
	cTxt += D1_COD+";"+Posicione("SB1",1,xFilial("SD1")+D1_COD,"B1_DESC")+";"+Posicione("SB1",1,xFilial("SD1")+D1_COD,"B1_POSIPI")+";"+Posicione("SF1",1,xFilial("SD1")+D1_DOC+D1_SERIE+D1_FORNECE+D1_LOJA,"F1_EST")+";"+D1_CF+";"
	cTxt += Iif(Left(Stuff(Str(D1_QUANT),Rat(".",Str(D1_QUANT)),1,","),1)==",",Str(D1_QUANT),Stuff(Str(D1_QUANT),Rat(".",Str(D1_QUANT)),1,","))+";"
	cTxt += Iif(Empty(D1_TES),"NF SEM TES",D1_TES)+";"+Iif(Empty(D1_TES),"NF NAO CLASSIFICADA",Posicione("SF4",1,xFilial("SF4")+D1_TES,"F4_ESTOQUE")	)
/*
