...
cQuery := " SELECT D2_FILIAL,D2_DOC,D2_SERIE,D2_TIPO,D2_CLIENTE,D2_LOJA,D2_CF,SUM(D2_VALBRUT)D2_VALBRUT,SUM(D2_PICM)D2_PICM,SUM(D2_BASEICM)D2_BASEICM,SUM(D2_VALICM)D2_VALICM,SUM(D2_IPI)D2_IPI,SUM(D2_BASEIPI)D2_BASEIPI,SUM(D2_VALIPI)D2_VALIPI,SUM(D2_BASEISS)D2_BASEISS,SUM(D2_VALISS)D2_VALISS,MAX(D2_ALQIMP5)D2_ALQIMP5,SUM(D2_VALIMP5)D2_VALIMP5,MAX(D2_ALQIMP6)D2_ALQIMP6,SUM(D2_VALIMP6)D2_VALIMP6 "
cQuery += " FROM " +RetSqlName("SD2") + " D2 " 
