...
While !Eof()
	...
	AADD(_aDados,{_COD, _NOM,_END,_MUN,_BAI,_CEP,_EST,_DDI,_DDD,_TEL,_FAX,_CONTATO,_TELCON,_CELCON,_FAXCON,_ORIG,_VEND1,_NOM1,_VEND2,_NOM2,_DPRICOM,_DDTORC, _CLIGAC})
