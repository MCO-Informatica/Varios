...
Relatorio de Nota Fiscal de Entrada
@type function
@version 12.1.33
...
Static Function fReportDef()
	...
	oReport := TReport():New(	"RelNsaid",;		//Nome do Relat?rio
								"Relatorio Nota Fiscal de Saida",;		//T?tulo
	...
	TRCell():New(oSectDad, "NR_ITEM", "QRY_AUX", "Nr_item", /*Picture*/, 4, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "DT_DTDIGIT_DOCUMENTO", "QRY_AUX", "Dt_dtdigit_documento", /*Picture*/, 10, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	TRCell():New(oSectDad, "NM_PESSOA", "QRY_AUX", "Nm_pessoa", /*Picture*/, 80, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "LOTE", "QRY_AUX", "Lote", /*Picture*/, 100, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "DS_ENDERECO_DESTINATARIO", "QRY_AUX", "Ds_endereco_destinatario", /*Picture*/, 40, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "DS_BAIRRO_DESTINATARIO", "QRY_AUX", "Ds_bairro_destinatario", /*Picture*/, 20, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
	...
	TRCell():New(oSectDad, "NR_TELEFONE_DESTINATARIO", "QRY_AUX", "Nr_telefone_destinatario", /*Picture*/, 50, /*lPixel*/,/*{|| code-block de impressao }*/,/*cAlign*/,/*lLineBreak*/,/*cHeaderAlign */,/*lCellBreak*/,/*nColSpace*/,/*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
Return oReport
...
Static Function fRepPrint(oReport)
	...
	cQryAux += "D1_DOC 'ID_NOTA_FISCAL',"		+ STR_PULA
	cQryAux += "D1_ITEM 'NR_ITEM',"		+ STR_PULA
	cQryAux += "FT_TIPOMOV 'ENTRADA_SAIDA',"		+ STR_PULA
	cQryAux += "D1_DOC 'NR_DOCUMENTO',"		+ STR_PULA
	cQryAux += "D1_SERIE 'NR_SERIE_DOCUMENTO',"		+ STR_PULA
	cQryAux += "D1_TOTAL 'VL_NOTA_FISCAL',"		+ STR_PULA
	cQryAux += "A2_CGC 'NR_CNPJ_CPF',"		+ STR_PULA
	cQryAux += "SUBSTRING(D1_DTDIGIT,7,2)+'/'+SUBSTRING(D1_DTDIGIT,5,2)+'/'+SUBSTRING(D1_DTDIGIT,1,4) 'DT_DTDIGIT_DOCUMENTO',"		+ STR_PULA
	cQryAux += "A2_NOME 'NM_PESSOA',"		+ STR_PULA
	cQryAux += "A2_EST 'ID_UF',"		+ STR_PULA
	cQryAux += "D1_COD 'ID_PRODUTO',"		+ STR_PULA
	cQryAux += "D1_COD 'CD_PRODUTO',"		+ STR_PULA
	cQryAux += "B1_DESC 'DS_PRODUTO',"		+ STR_PULA
	cQryAux += "B1_DESC 'LOTE',"		+ STR_PULA
	cQryAux += "D1_CF 'ID_CD_FISCAL',"		+ STR_PULA
	cQryAux += "B1_CEST 'CD_CEST',"		+ STR_PULA
	cQryAux += "B1_POSIPI 'CD_NCM',"		+ STR_PULA
	cQryAux += "D1_CLASFIS 'CD_CLASSIFICACAO_TRIB_ESTADUAL',"		+ STR_PULA
	cQryAux += "D1_TOTAL 'VL_TOTAL',"		+ STR_PULA
	cQryAux += "D1_VALDESC 'VL_DESCONTO',"		+ STR_PULA
	cQryAux += "D1_PICM 'ALIQ_ICMS',"		+ STR_PULA
	cQryAux += "D1_BASEICM 'VL_BASE_CALCULO_ICMS',"		+ STR_PULA
	cQryAux += "D1_VALICM 'VL_ICMS',"		+ STR_PULA
	cQryAux += "D1_BRICMS 'VL_BASE_CALCULO_ICMS_ST',"		+ STR_PULA
	...
	cQryAux += "D1_SEGURO 'VL_SEGURO',"		+ STR_PULA
	...
	cQryAux += "D1_PEDIDO 'ID_PEDIDO',"		+ STR_PULA
	cQryAux += "D1_PESO 'NR_PESO_LIQUIDO',"		+ STR_PULA
	cQryAux += "D1_PESO 'NR_PESO_BRUTO',"		+ STR_PULA
	...
	cQryAux += "D1_QUANT 'QTDE_VENDIDA_PIS_ST',"		+ STR_PULA
	...
	cQryAux += "D1_QUANT 'QTDE_VENDIDA_CONFIS_ST',"		+ STR_PULA
	cQryAux += "FT_ALIQCOF 'ALIQ_COFINS_REAIS_ST',"		+ STR_PULA
	cQryAux += "'' 'DM_MODALIDADE_FRETE',"		+ STR_PULA
	cQryAux += "A2_END 'DS_ENDERECO_DESTINATARIO',"		+ STR_PULA
	cQryAux += "'' 'NR_ENDERECO_DESTINATARIO',"		+ STR_PULA
	cQryAux += "A2_COMPLEM 'DS_COMPL_END_DESTINATARIO',"		+ STR_PULA
	cQryAux += "A2_BAIRRO 'DS_BAIRRO_DESTINATARIO',"		+ STR_PULA
	cQryAux += "A2_CEP 'NR_CEP_DESTINATARIO',"		+ STR_PULA
	cQryAux += "A2_MUN 'DS_MUNICIPIO_DESTINATARIO',"		+ STR_PULA
	cQryAux += "A2_PAIS 'DS_PAIS_DESTINATARIO',"		+ STR_PULA
	cQryAux += "A2_TEL 'NR_TELEFONE_DESTINATARIO'"		+ STR_PULA
	...
	cQryAux += "AND FT_ITEM = D1_ITEM"		+ STR_PULA
	...
	cQryAux += "WHERE SD1010.D_E_L_E_T_ =' ' AND D1_DTDIGIT BETWEEN '202200101' AND '204901231'"		+ STR_PULA
	cQryAux += "ORDER BY D1_DOC, D1_SERIE, D1_ITEM"		+ STR_PULA
