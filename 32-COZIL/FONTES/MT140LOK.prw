...
±±ºPrograma  ³MT140LOK  ºAutor  ³Carlos E. Saturnino º Data ³  12/01/10   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Ponto de Entrada com a finalidade de validar o NCN digitado º±±
±±º          ³Para o Item da Pre Nota de entrada, e inclui-lo via execautoº±±
±±º          ³No SB1													  º±±
...
If MsSeek( xFilial("SB1") + SD1->D1_COD )
	aDados := {	{ "B1_COD"		,SB1->B1_COD		,Nil},; 		//Codigo
				...
				{ "B1_POSIPI"	,_cNCM				,Nil},;        //Pos.IPI/NCM
	...
	//³Executa a inclusao do Registro via MsExecAuto				   ³
