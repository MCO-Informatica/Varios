...
IF CpyT2S("E:\MP8\PROTHEUS_DATA\data\SC5010.DBF","\DW", .T.)
	cMens1 += "SC5 - Cabeçalho Pedido de Venda <BR>"
ENDIF
...
IF CpyT2S("E:\MP8\PROTHEUS_DATA\data\SF2010.DBF","\DW", .T.)
	cMens1 += "SF2 - Cabeçalho Nota Fiscal <BR>"
ENDIF
...
IF CpyT2S("E:\MP8\PROTHEUS_DATA\data\SC5010.CDX","\DW", .T.)
	cMens2 += "SC5 - Cabeçalho Pedido de Venda <BR>"
ENDIF
...
IF CpyT2S("E:\MP8\PROTHEUS_DATA\data\SF2010.CDX","\DW", .T.)
	cMens2 += "SF2 - Cabeçalho Nota Fiscal <BR>"
ENDIF
...
Else
ApMsgAlert("O arquivo não pode ser apagado.")
EndIF
