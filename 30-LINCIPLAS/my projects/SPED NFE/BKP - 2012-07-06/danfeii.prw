...
#DEFINE MAXITEMP2  049                                                // Máximo de produtos para a pagina 2 em diante (caso nao utilize a opção de impressao em verso)
#DEFINE MAXITEMP2F 068                                                // Máximo de produtos para a página 2 em diante quando a página não possui informações complementares
#DEFINE MAXITEMP3  027                                                // Máximo de produtos para a pagina 2 em diante (caso utilize a opção de impressao em verso) - Tratamento implementado para atender a legislacao que determina que a segunda pagina de ocupar 50%.
#DEFINE MAXITEMC   025                                                // Máxima de caracteres por linha de produtos/serviços
...
For nZ := 1 To nLenDet
	...
	nMaxDes := MaxCod(NoChar(oDet[nX]:_Prod:_xProd:TEXT,lConverte), 108)//100) //alterado Contemp
...
Next nX
*/
oDanfe:Say(nLinCalc,098,cStrAux, oFont07N:oFont ) //oFont12N:oFont ) alterado Contemp
nLinCalc+=10
...
If cModFrete =="0" //CONTEMP
	If(MV_PAR04==1)
		oDanfe:Say(382,247,"0-FOB",oFont08:oFont)
	Else
		oDanfe:Say(382,247,"0-CIF",oFont08:oFont)
	EndIf
ElseIf cModFrete =="1"
	If(MV_PAR04==1)
		oDanfe:Say(382,247,"1-CIF",oFont08:oFont)
	Else
		oDanfe:Say(382,247,"1-FOB",oFont08:oFont)
	EndIf
...
Endif
//oDanfe:Say(382,247,"0-EMIT/1-DEST [" + aTransp[02] + "]",oFont08:oFont)//CONTEMP
...
For nMax := 1 to Len(cString)
	If IsAlpha(SubStr(cString,nMax,1)) .And. SubStr(cString,nMax,1) $ "MOQWCS"  // Caracteres que ocupam mais espaço em pixels
		nY += 7
	Else
		nY += 4 //Alterado Contemp antes era 5
	EndIf
