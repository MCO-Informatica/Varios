...
For nZ := 1 To nLenDet
	...
	If Type("oImposto:_Imposto")<>"U"
		If Type("oImposto:_Imposto:_ICMS")<>"U"
			...
			IF DTOS(SD2->D2_EMISSAO) >= '20110401'
	...
	AllTrim(TransForm(nQtd,TM(nQtd,TamSX3("D2_QUANT")[1],2))),;//TamSX3("D2_QUANT")[2]))),;
	AllTrim(TransForm(nVUnit,TM(nVUnit,TamSX3("D2_PRCVEN")[1],4))),;
	AllTrim(TransForm(nVTotal,TM(nVTotal,TamSX3("D2_TOTAL")[1],2))),;//,TamSX3("D2_TOTAL")[2]))),;
...
oDanfe:Box(442,250,678,289) // ALTERADO POR THIAGO EM 17/05/2011
//oDanfe:Box(442,245,678,289)
oDanfe:Say(450,252,"QUANT.",oFont08N:oFont)
oDanfe:Box(442,289,678,346) // ALTERADO POR THIAGO EM 17/05/2011
