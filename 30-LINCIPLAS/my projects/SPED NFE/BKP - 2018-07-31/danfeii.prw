...
User Function PrtNfeSef(cIdEnt, cVal1, cVal2, oDanfe, oSetup, cFilePrint, lIsLoja	)
...
If Len(aGrvSF3)>0 .And. SF3->(FieldPos("F3_CHVNFE"))>0
	...
	For nI := 1 To Len(aGrvSF3)	
		...
		IF SF3->(MsSeek(cChaveSF3))
			Do While cChaveSF3 == (xFilial("SF3")+aGrvSF3[nI,1]+aGrvSF3[nI,2]+aGrvSF3[nI,3]+aGrvSF3[nI,4]+aGrvSF3[nI,5]) .And. Empty(SF3->F3_CHVNFE)
