...
#DEFINE MAXVALORC  014//15                                            // Máximo de caracteres por linha de valores numéricos // PADRAO TAMANHO 08
/*/
...
aTotais[07] := a(Val(oTotal:_ICMSTOT:_vSeg:TEXT),"@ze 9,999,999,999,999.99")
...
For nY := 1 To nLenItens
	...
	Else
		...
		//oDanfe:Say(nLinha, nAuxH , aAux[1][3][nY], oFont08:oFont) // NCM
		nAuxH += aTamCol[3]
		...
		oDanfe:Say(nLinha, nAuxH2 + 12, aAux[1][7][nY], oFont08:oFont) // QUANT
		nAuxH += aTamCol[7]
		If Empty(aAux[1][6][nY]) // UN
