...
#DEFINE MAXITEMP3  027                                                // Máximo de produtos para a pagina 2 em diante (caso utilize a opção de impressao em verso) - Tratamento implementado para atender a legislacao que determina que a segunda pagina de ocupar 50%. //PADRAO TAMANHO 25
#DEFINE MAXITEMC   030                                                // Máxima de caracteres por linha de produtos/serviços // PADRAO TAMANHO 18
...
#DEFINE MAXVALORC  015                                                // Máximo de caracteres por linha de valores numéricos // PADRAO TAMANHO 08
...
// Thiago - Supertech 28/08/12
// Alteracoes para que o campo quantidade caiba corretamente dentro de sua respectiva coluna
...
nAuxH += aTamCol[1]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[2])	// 050, 240
oDanfe:Box(442, nAuxH, 678, 603)
oDanfe:Say(450, nAuxH + 2, "DESCRIÇÃO DO PROD./SERV.", oFont08N:oFont)
nAuxH += aTamCol[2]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[3])	// 240, 320
oDanfe:Box(442, 205, 678, 245)
oDanfe:Say(450, 205 + 2, "NCM/SH", oFont08N:oFont)
nAuxH += aTamCol[3]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[4])	// 280, 296
oDanfe:Box(442, 245, 678, 270)
oDanfe:Say(450, 245 + 2, "CST", oFont08N:oFont)
nAuxH += aTamCol[4]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[5])	// 296, 320
oDanfe:Box(442, 270, 678, 300)
oDanfe:Say(450, 270 + 2, "CFOP", oFont08N:oFont)
nAuxH += aTamCol[5]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[6])	// 320, 334
oDanfe:Box(442, 300, 678, 320)
oDanfe:Say(450, 300 + 2, "UN", oFont08N:oFont)
nAuxH += aTamCol[6]
//oDanfe:Box(442, nAuxH, 678,nAuxH + aTamCol[7])	// 334, 371
oDanfe:Box(442, 320, 678, 380)
oDanfe:Say(450, 320 + 2, "QUANT.", oFont08N:oFont)
nAuxH += aTamCol[7]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[8])	// 371, 424
oDanfe:Box(442, 380, 678, 433)
oDanfe:Say(450, nAuxH + 2, "V.UNITARIO", oFont08N:oFont)
nAuxH += aTamCol[8]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[9])	// 424, 462
oDanfe:Box(442, 433, 678, 475)
oDanfe:Say(450, nAuxH + 2, "V.TOTAL", oFont08N:oFont)
nAuxH += aTamCol[9]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[10])	// 462, 498
oDanfe:Box(442, 475, 678, 511)
oDanfe:Say(450, nAuxH + 2, "BC.ICMS", oFont08N:oFont)
nAuxH += aTamCol[10]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[11])	// 498, 528
oDanfe:Box(442, 511, 678, 541)
oDanfe:Say(450, nAuxH + 2, "V.ICMS", oFont08N:oFont)
nAuxH += aTamCol[11]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[12])	// 528,
oDanfe:Box(442, 541, 678, 561)
oDanfe:Say(450, nAuxH + 2, "V.IPI", oFont08N:oFont)
nAuxH += aTamCol[12]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[13])	//
oDanfe:Box(442, 561, 678, 592)
oDanfe:Say(450, nAuxH + 2, "A.ICMS", oFont08N:oFont)
nAuxH += aTamCol[13]
//oDanfe:Box(442, nAuxH, 678, nAuxH + aTamCol[14])	//
oDanfe:Box(442, 592, 678, 616)
...
For nY := 1 To nLenItens
	...
	nAuxH := 0
	// Thiago - Supertech
	// Alteracao para que a Quantidade caiba corretamente em sua coluna
	...
	Else
		...
		oDanfe:Say(nLinha, 205 + 2, aAux[1][3][nY], oFont08:oFont) // NCM
		nAuxH += aTamCol[3]
		//oDanfe:Say(nLinha, nAuxH + 2, aAux[1][4][nY], oFont08:oFont) // CST
		oDanfe:Say(nLinha, 245 + 2, aAux[1][4][nY], oFont08:oFont) // CST
		nAuxH += aTamCol[4]
		//oDanfe:Say(nLinha, nAuxH + 2, aAux[1][5][nY], oFont08:oFont) // CFOP
		oDanfe:Say(nLinha, 270 + 2, aAux[1][5][nY], oFont08:oFont) // CFOP
		nAuxH += aTamCol[5]
		//oDanfe:Say(nLinha, nAuxH + 2, aAux[1][6][nY], oFont08:oFont) // UN
		oDanfe:Say(nLinha, 300 + 2, aAux[1][6][nY], oFont08:oFont) // UN
		nAuxH += aTamCol[6]
		...
		If Empty(aAux[1][6][nY]) // UN
			...
			nAuxH2 := 320 + ((aTamCol[7] + 5) - RetTamTex(aAux[1][7][nY], oFont08:oFont, oDanfe)) + 2 //- RetTamTex("0", oFont08:oFont, oDanfe)
		Else
			//nAuxH2 := nAuxH + ((aTamCol[7] - 2) - RetTamTex(aAux[1][7][nY], oFont08:oFont, oDanfe)) + 2
			nAuxH2 := 320 + ((aTamCol[7] + 5) - RetTamTex(aAux[1][7][nY], oFont08:oFont, oDanfe)) + 2
		EndIf
		oDanfe:Say(nLinha, nAuxH2 + 2, aAux[1][7][nY], oFont08:oFont) // QUANT
		//oDanfe:Say(nLinha, nAuxH2 + 5, aAux[1][7][nY], oFont08:oFont) // QUANT
		nAuxH += aTamCol[7]
		If Empty(aAux[1][6][nY]) // UN
			//nAuxH2 := nAuxH + ((aTamCol[8] - 2) - RetTamTex(aAux[1][8][nY], oFont08:oFont, oDanfe)) + 2 //- RetTamTex("0", oFont08:oFont, oDanfe)
			nAuxH2 := nAuxH + ((aTamCol[8]) - RetTamTex(aAux[1][8][nY], oFont08:oFont, oDanfe)) + 4 //- RetTamTex("0", oFont08:oFont, oDanfe)
		Else
			//nAuxH2 := nAuxH + ((aTamCol[8] - 2) - RetTamTex(aAux[1][8][nY], oFont08:oFont, oDanfe)) + 2
			nAuxH2 := nAuxH + ((aTamCol[8]) - RetTamTex(aAux[1][8][nY], oFont08:oFont, oDanfe)) + 4
		EndIf
		//oDanfe:Say(nLinha, nAuxH2 + 2, aAux[1][8][nY], oFont08:oFont) // V UNITARIO
		oDanfe:Say(nLinha, nAuxH2 - 4, aAux[1][8][nY], oFont08:oFont) // V UNITARIO
		nAuxH += aTamCol[8]
		If Empty(aAux[1][6][nY]) // UN
		...
		oDanfe:Say(nLinha, nAuxH2+9, aAux[1][9][nY], oFont08:oFont) // V. TOTAL
		nAuxH += aTamCol[9]
		If Empty(aAux[1][6][nY]) // UN
