...
±±ºPrograma  ³CadChvSF3 º Autor ³ Alessandra         º Data ³  14/06/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Usado para inserir a chave da NF referenciada na SF3       º±±
±±º          ³                                                            º±±
...
Private cCadastro := "Cadastro de Chave NFe
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
aCampos := { {"Nota Fiscal","F3_NFISCAL"},;        
				{"Serie","F3_SERIE" },;    
				{"Emissao","F3_EMISSAO"},;	
				{"Cli/Forne","F3_CLIEFOR"},;
				{"Loja","F3_LOJA"},;
		        {"Chave NFe","F3_CHVNFE"}}     
