...
#DEFINE MAXVALORC  015//15                                                // Máximo de caracteres por linha de valores numéricos // PADRAO TAMANHO 08
...
For nY := 1 To nLenItens
	...
	Else
		...
		oDanfe:Say(nLinha, nAuxH2+9, substring(aAux[1][9][nY],1,at(",",aAux[1][9][nY])+2), oFont08:oFont) // V. TOTAL
		nAuxH += aTamCol[9]
		If Empty(aAux[1][6][nY]) // UN
