...
cBody += CHR(13)+CHR(10)
cBody += OEMTOANSI("Segue anexo nota fiscal ")+ALLTRIM(cNumNota)+"/"+ALLTRIM(cSerieNF)+" e Boleto bancário para pagamento "+"."+CHR(13)+CHR(10)
cBody += CHR(13)+CHR(10)
...
cBody += OEMTOANSI("Atenção: Este é um email gerado automaticamente pelo sistema. Favor não responder este email.")+CHR(13)+CHR(10)
	...
	ELSE
		ALERT("Servidor de e-mail NÃO conectado!")
	Endif
