...
//³Jonatas     ³15/03/11  ³006244³Tratamento de novas funcionalidades p/ o³
//³            ³          ³  2011³calculo de professores.                 ³
//³R.Berti     ³11/11/11  ³TDWJV5³Ajusta help da perg. "Nome Ate"		  ³
//³Fabio G.    ³06/03/12  ³TEMJAC³Ajuste do campo RA_RGUF para impressao  ³
//³     	   ³ 		  ³		 ³na Integracao Word. 		   			  ³
//³Leandro Dr. ³14/05/12  ³TEWEFU³Inclusao de campos para preenchimento do³
//³     	   ³ 		  ³		 ³novo Cadastro NIS da CEF.				  ³
//³Leandro Dr. ³15/05/12  ³TEZG99³Alterado set epoch para 1950.           ³
//³Allyson M   ³01/08/12  ³TFMQVE³Inclusao de campos da segunda data de   ³
//³     	   ³ 		  ³		 ³experiencia.				 			  ³
//³Fabio G.    ³13/08/12  ³TFLBNW³Ajuste dos campos RA_DTRGEXP e RA_DTCPEX³
//³     	   ³ 		  ³		 ³para outros paises diferentes de Brasil.³
//³Fabio G.    ³19/12/2012³TGIEA9³Ajuste para integracao do Word aceitar  ³
//³     	   ³ 		  ³		 ³arquivos de Entrada com extensao ".DOTX"³
//³Claudinei S.³10/01/2013³TGJYYE³Criacao de 53 variaveis para o DCN/DMN  ³
//³     	   ³ 		  ³      ³do NIS-PIS e novo pergunte MV_PAR30     ³
//³Claudinei S.³25/02/2013³TGSSQE³Declaracao da fOpTipPis() como Static.  ³
...
nEpoca	:= Set( 5 , 1950 )	//Altera o Set Epoch para 1950
...
/*ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
  ...
  ³execucao da rotina e informa ao usuario.                   ³
...
Set( 5 , nEpoca ) //RETORNA EPOCA PADRAO
...
IF !Empty( cNewPathArq )
	...
	Else
		IF Upper( Subst( AllTrim( cNewPathArq), - 3 ) ) == Upper( AllTrim( STR0008 ) )	
   	    ...
   	    ElseIf	Upper( Subst( AllTrim( cNewPathArq ), - 4 ) ) == Upper( AllTrim( STR0294 ) )	 //Definir a String Correta
				Aviso( STR0009 , cNewPathArq , { STR0010 } )
	    Else
	    	MsgAlert( STR0011 )															
	    	Return
...
/*
ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿
³Fun‡„o    ³fTarProf  ³ Autor ³Jonatas A. T. Alves    ³ Data ³18/02/2011³
ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´
³Descri‡„o ³Carrega Informacoes dos lancamentos de tarefas p/ professor ³
ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ*/
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡„o    ³fOpTipPIS ³ Autor ³ Claudinei Soares      ³ Data ³ 10/01/13 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡„o ³ Opcoes dos Tipos de NIS para o cadastro de PIS			  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³ GPEWORD                                                    ³±±
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
