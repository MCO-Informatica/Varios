...
//While SRA->( !Eof() .and. Eval( &(cInicio) ) <= cFim  .AND. Eval( &(cInicio) ) >= cFilDe + cMatDe)
//While SRA->( !Eof() .and. SRA->RA_FILIAL >= cFilDe .and. SRA->RA_FILIAL <= cFilAte .and. SRA->RA_MAT >= cMatDe .and. SRA->RA_MAT <= cMatAte )
//    ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
aAdd( aExp, {'GPE_NOME_EMPRESA' 		,	SM0->M0_NOMECOM /*aInfo[03]*/          					, "@!"						,STR0130	} )
aAdd( aExp, {'GPE_END_EMPRESA'			,	SM0->M0_ENDCOB /*aInfo[04]*/           					, "@!"						,STR0131	} )
aAdd( aExp, {'GPE_CID_EMPRESA'			,	SM0->M0_CIDCOB /*aInfo[05]*/           					, "@!"						,STR0132	} )
aAdd( aExp, {'GPE_CEP_EMPRESA'         	,   SM0->M0_CEPCOB /*aInfo[07]*/                           	, "!@R #####-###"          	,STR0034 	} )
aAdd( aExp, {'GPE_EST_EMPRESA'         	,   SM0->M0_ESTCOB /*aInfo[06]*/							, "@!"						,STR0032 	} )
aAdd( aExp, {'GPE_CGC_EMPRESA' 			,	SM0->M0_CGC /*aInfo[08]*/   							, "@R ##.###.###/####-##"	,STR0134	} )
aAdd( aExp, {'GPE_INSC_EMPRESA' 		,	SM0->M0_INSC /*aInfo[09]*/             					, "@!" 						,STR0135	} )
aAdd( aExp, {'GPE_TEL_EMPRESA'	 		,	SM0->M0_TEL /*aInfo[10]*/              					, "@!" 						,STR0136	} )
aAdd( aExp, {'GPE_FAX_EMPRESA'         	,   SM0->M0_FAX /*If(aInfo[11]#nil ,aInfo[11], "        ")*/, "@!"                     	,STR0136 	} )
aAdd( aExp, {'GPE_BAI_EMPRESA'			,	SM0->M0_BAIRCOB /*aInfo[13]*/                           , "@!" 						,STR0137	} )
...
aAdd( aExp, {'GPE_DESC_ESTEMP'         	,   SM0->M0_CIDCOB /*alltrim(fDesc("SX5","12"+aInfo[06],"X5_DESCRI"))*/ , "@!"             	,STR0134 	} ) 
