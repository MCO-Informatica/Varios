...
DEFINE MSDIALOG oDlg TITLE "Autenticação Bancaria" FROM C(242),C(245) TO C(452),C(642) PIXEL

// Defina aqui a chamada dos Aliases para o GetArea
CtrlArea(1,@_aArea,@_aAlias,{"SA1","SA2"}) // GetArea

// Cria Componentes Padroes do Sistema
@ C(010),C(010) Say "Já foi impresso Boleto do Bradesco para os titulos:" Size C(121),C(008) COLOR CLR_BLACK PIXEL OF oDlg
