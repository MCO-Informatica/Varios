...
For _nI := 1 to len(_aXMLs)
	...
	If empty(_cFornece)
		aAdd(_aErros,{_cNfisc + ' / ' +  _cSerie, dtoc(_dEmiss), 'Fornecedor não localizado. Verificar CNPJ e Inscr. Estadual (emitente)', _cNomeD, tran(_cCNPJD,'@R 99.999.999/9999-99'), _cIED, _cNomeE, tran(_cCNPJE,'@R 99.999.999/9999-99'), _cIEE})
		loop
	EndIf
