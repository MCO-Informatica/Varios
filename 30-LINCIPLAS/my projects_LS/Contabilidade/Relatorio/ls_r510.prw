...
Local CDESC			:= OemToAnsi("Este programa irá imprimir a Demonstração de Resultados, de acordo com os parâmetros informados pelo usuário.")
...
MsgMeter({|	oMeter, oText, oDlg, lEnd | ;
			...
			,"Criando Arquivo Temporario...", "Demonstracao de resultados do Exercício") //
...
If lImpTrmAux
	...
	If !File(cArqTRM)
		aSavSet:=__SetSets()
		cArqTRM := CFGX024(cArqTRM,"Responsáveis...") // 
		__SetSets(aSavSet)
		Set(24,Set(24),.t.)
	Endif
...
MsgMeter({|	oMeter, oText, oDlg, lEnd | ;
			...
			,"Criando Arquivo Temporario...", cProcesso,, "Demonstração do Resultado do Exercício") //
