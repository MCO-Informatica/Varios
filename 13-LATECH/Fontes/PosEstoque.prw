...
User Function PosEstoque()        // incluido pelo assistente de conversao do AP6 IDE em 12/02/05
...
//----> armazena numero dos pedidos de vendas para cada produto
If mv_par11 == 1
	_aEstrPed:={}
...
cabec1 := "CODIGO       QTD TINTO     QTD CRU     TINGINDO     REPROCES     PEDIDOS     SALDO     PROD MES     TEARES     CUSTO/UN      VLR EST"
cabec2 := ""
...
Else
	If TRB->SINT_ANA == "S"
		...
		@ _nLin,Pcol()+03 PSAY  "AQUI"	//TRB->ESTOQUE    PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+02 PSAY  "AQUI"	//TRB->CRU        PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+03 PSAY  "AQUI" 	//TRB->TINGINDO   PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+03 PSAY  "AQUI"	//TRB->REPROCES   PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+02 PSAY  "AQUI"	 //TRB->PEDIDOS    PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+00 PSAY 	"AQUI" //TRB->SALDO      PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+03 PSAY  "AQUI"	//TRB->PRO_MES    PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+01 PSAY  "AQUI"	//TRB->QTD_TEAR   PICTURE "@E 999,999.99"
		@ _nLin,Pcol()+16 PSAY  "AQUI"	 //TRB->TOTAL      PICTURE "@E 999,999.99"
...
_lo:= MV_PAR09
cQuery := ''
cQuery := "SELECT  B1_COD, B1_DESC, B1_LOCPAD, B1_TIPO, B1_PRODMES, B1_QTEARES, B1_STATUS, B1_UPRC, B1_CUSTD, B2_LOCAL, B2_QATU, B2_QPEDVEN, B2_QEMP, B2_QEMPPRE, B2_CM1, B2_VATU1 "
...
cQuery := ''
cQuery := " SELECT C5_NUM,C5_TIPO,C5_EMISSAO,C5_CLIENTE,C6_NUM,C6_ITEM,C6_DESCRI,C6_PRODUTO,C6_QTDVEN,C6_QTDENT,C6_BLQ,A1_NREDUZ " 
...
TcSetField("K6","C5_EMISSAO","D",TamSX3("C5_EMISSAO")[1],TamSX3("C5_EMISSAO")[2])
