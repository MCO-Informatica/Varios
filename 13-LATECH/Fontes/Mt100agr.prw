...
//	        cProx := 1
	...
	*/				
	//				U_LjDocSeq()
					...
					SD1->D1_TES		:= ACOLS[nX][11]
					SD1->D1_COD		:= ACOLS[nX][02]
					SD1->D1_UM		:= ACOLS[nX][03]
					SD1->D1_VUNIT	:= cValor1
					SD1->D1_TOTAL	:= cValor1
					SD1->D1_CF		:= ACOLS[nX][12]
					SD1->D1_PICM	:= ACOLS[nX][15]
					SD1->D1_CC		:= ACOLS[nX][19]
					SD1->D1_FORNECE	:= cA100For
					SD1->D1_LOJA	:= cLoja
					SD1->D1_LOCAL	:= ACOLS[nX][25]
					SD1->D1_DOC		:= cNFiscal
					SD1->D1_EMISSAO	:= ACOLS[nX][27]
					...
					SD1->D1_ITEMORI	:= ACOLS[nX][01]
					SD1->D1_ITEM	:= ACOLS[nX][01]
					SD1->D1_CLASFIS	:= "000"
					SD1->D1_RATEIO	:= "2"
					SD1->D1_STSERV	:= "1"
	//				SD1->D1_USERLGI	:= "1"
					...
					SD1->D1_GARANTI	:= "N"
					SD1->D1_ALQPIS	:= ACOLS[nX][121]
					SD1->D1_ALQCOF	:= ACOLS[nX][127]
	...
	*/
	...
	//			U_LjDocSeq()
				...
				dbSelectArea("SE2")
				dbSeek(xFilial("SE2")+SE2->E2_PREFIXO+SE2->E2_NUM)
