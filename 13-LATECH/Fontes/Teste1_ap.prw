...
User Function Teste1()        // incluido pelo assistente de conversao do AP6 IDE em 12/02/05
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Function ImpCheq(cBanco,cAgencia,cConta,lMovBco,cFilAtual,nLayOut,cMunic)
Local lRet		:=	.F.
LOCAL cValor
LOCAL lFirst	:=.T.
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Function ImpCheqLoc(cBanco,cAgencia,cConta,lMovBco,cFilAtual)
Local lRet			:=	.F.
LOCAL cValor
LOCAL lFirst    	:=.T.
LOCAL aMes := { OemToAnsi(STR0006),OemToAnsi(STR0007),OemToAnsi(STR0008),;   //"Janeiro"###"Fevereiro"###"Marco"
