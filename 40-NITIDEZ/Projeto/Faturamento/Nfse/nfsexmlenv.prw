...
user function nfseXMLEnv( cTipo, dDtEmiss, cSerie, cNota, cClieFor, cLoja, cMotCancela,aAIDF )
	...
	Private cCgc		:= ""
	Private cEstCob		:= ""
	Private _NatOper1	:= "" //---> Customização feita por Lucas Baía (UPDUO) -> 13/07/2022
...
static function servicos( aProd, aISSQN, aRetido, cNatOper, lNFeDesc, cDiscrNFSe,aCST, cTpPessoa, cCodMun, cF4Agreg, nDescon, cFntCtrb,aLeiTrp,lRecIrrf,aRetSF3)	
	...
	EndIf
	//---> Customização Feita por Lucas Baía (UPDUO) -> 13/07/2022
	IF _NatOper1 $ '1'
		nAliqISs := 0	// Envio de Aliquota Zerada Agora Pra Sjc - Lucas Baia (UPDUO) 13/07/2022
	ENDIF
	//---> Fim da Customização.
