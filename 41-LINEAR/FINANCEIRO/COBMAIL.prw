...
for G:=1 to len(amovtob)
	...
	ELSE
		...
		*/
		...
		// checa os tres emails do cliente
		cVENDMA		:= lower(alltrim(amovtob[g,9]))
		cass		:= "Aviso ref. cobrança em atraso"
...
'<p style="line-height: 100%; word-spacing: 0; margin-top: 0; margin-bottom: 0"><font face="Arial" size="2">' + IIF(naviso==1,"Voce esta recebendo um lembrete de vencimento de duplicatas, conforme detalhamento abaixo:","Nosso sistema constatou que os boletos abaixo estão em aberto:") + '</font></p><br>' + XCRLF

//
xmsg2:=  SUBTOT1(naviso)

ctxt1:= "<p style=" + chr(34) + "line-height: 100%; word-spacing: 0; margin-top: 0; margin-bottom: 0" + chr(34) + '"><font face="Arial" size="2">' + "Caso não tenha recebido o boleto, por favor entre em contato urgente. <br>Se o pagamento ja foi realizado, favor desconsiderar essa mensagem. <br> <br>Atenciosamente, "+ "</font></p><br>" + XCRLF
ctxt2:= "<p style=" + chr(34) + "line-height: 100%; word-spacing: 0; margin-top: 0; margin-bottom: 0" + chr(34) + '"><font face="Arial" size="2">' + "No caso de duvidas,ou não tenha recebido o boleto, entre em contato com nosso departamento de cobrança .<br>Evite despesas adicionais com cobrança via Serasa.<br><br>Caso ja tenha realizado o pagamento, favor desconsiderar essa mensagem.<br><br>Atenciosamente, " + "</font></p><br>" + XCRLF
...
"Departamento Financeiro -  Cobrança <br> Tel.: (011) 2304-2541  <br>E-mail: cobranca@spidercapacetes.com.br<br>" + "</font></p>" 				+ XCRLF
