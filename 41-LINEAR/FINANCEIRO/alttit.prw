...
±±ºPrograma  ³MT100GE2  ºAutor  ³Rogerio Costa       º Data ³  02/06/02   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Ponto de entrada para alterar titulos a pagar.              º±±
...
@ 104,014 Say OemToAnsi("Histórico")
...
IF EMPTY(_cBarra)
	IF !EMPTY(_cLinDig)
		IF LEN(ALLTRIM(_cLinDig))<47// .and. !Empty(_cLinDig)
			Alert("Tamanho da linha digitável invalido. Verifique!")
			aRet := .F.
		END IF
	END IF
END IF
