...
//				Verifica se foi informado o número do lote do fornecedor PE MT140CPO para gravar no PE SF1140I
// Uso         	Linciplas
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
If !l140Auto
	...
	*/
	...
	Do While empty(__cLoteFor) .and. (inclui .or. altera)
		...
		If MsgBox('Lote do fornecedor da nota fiscal não informado. Corrigir?','ATENÇÃO!!!','YESNO')
			U_DlgLtFor()
			
		Else
			
			MsgBox('Lote do fornecedor da nota fiscal não informado. Pré-nota não pode ser incluida sem essa informação. Corrija ou abandone a inclusão da Pré-Nota!!','ATENÇÃO!!!','ALERT')
			_lRet := .f.
			Exit
