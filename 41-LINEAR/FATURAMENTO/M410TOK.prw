...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ************************************************************************************************************ //
// PE UTILIZADO NO MOMENTO DA GRAVAÇÃO DO PEDIDO DE VENDA PARA VALIDAR O PERCENTUAL DA COMISSAO DO VENDEDOR     //
// ************************************************************************************************************ //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
IF M->C5_TIPO == 'D'
	...
	IF INCLUI .OR. ALTERA
		...
		For I := 1 To Len(aCols)
			...
			cLoja	 	:= M->C5_LOJACLI 		// aScan(aHeader,{ |x| AllTrim(x[2]) == 'C6_SERIORI'} )
			...
			ELSE
				...
				if ALLTRIM(acols[I][NPOSDOC]) <> ""
					...
					//-------------------------------------------------------
					IF LVALIDA == .F.
						// acho que talvez seria bom passar como parametro o fonecedor e loja também
						// pra melhorar os filtros e consultas que vc faz depois também
...
If lRet
	...
	If DbSeek(xFilial("SFT")+"E"+M->C5_CLIENTE+M->C5_LOJACLI+cSerieOri+cDocOri) // ACRESCENTADO O IF QUE VERIFICA A EXISTENCIA DA NOTA FISCAL
		...
		EndDo
	Else
		//Alert("Nota Fiscal não Existe") // ACRESCENTADO A MENSAGEM EM CASO NÃO EXISTA A NOTA FISCAL
...
If Empty(ALLTRIM(cChave))
	...
	Alert("CHAVE NÃO PODE SER EM BRANCO")
