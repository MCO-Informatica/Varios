...
amovtob := ASort(amovtoc,,,{|x,y|x[2]<y[2]})    //] ordena por FUNÇÃO/CARGO
...
U_ENVIAEMAIL("claudinei@linciplas.com.br","Atualização da Carteira de Trabalho",msg2,nnumtit,"",aMovtob[g,1],.F.)
U_ENVIAEMAIL("rh@linciplas.com.br","Atualização da Carteira de Trabalho",msg2,nnumtit,"",aMovtob[g,1],.F.)
U_ENVIAEMAIL("thiago@stch.com.br","Atualização da Carteira de Trabalho",msg2,nnumtit,"",aMovtob[g,1],.F.)
...
'<p style="line-height: 100%; word-spacing: 0; margin-top: 0; margin-bottom: 0"><font face="Arial" size="2">' + "É necessário realizar a atualização das carteiras de trabalho dos funcionários abaixo:" + '</font></p><br>' + XCRLF

// MENSAGEM APÓS A RELAÇÃO DE CARTEIRAS SEM ATUALIZAÇÃO
xmsg2:=  SUBTOT2(naviso)

ctxt1:= "<p style=" + chr(34) + "line-height: 100%; word-spacing: 0; margin-top: 0; margin-bottom: 0" + chr(34) + '"><font face="Arial" size="2">' + "Os Funcionários acima estão a mais de 180 dias (6 meses) sem que suas Carteiras de Trabalho sejam atualizadas e/ou verificadas. "+ "</font></p><br>" + XCRLF
ctxt2:= "<p style=" + chr(34) + "line-height: 100%; word-spacing: 0; margin-top: 0; margin-bottom: 0" + chr(34) + '"><font face="Arial" size="2">' + "Os Funcionários acima estão a mais de 180 dias (6 meses) sem que suas Carteiras de Trabalho sejam atualizadas e/ou verificadas. "+ "</font></p><br>" + XCRLF
...
'<td style="background-color: #236B8E; border-style: solid; border-width: 1" width="250" align="center" ><font face="Arial" size="2" color="#FFFFFF">' + "Função"		+ '</td>' + XCRLF + ;
