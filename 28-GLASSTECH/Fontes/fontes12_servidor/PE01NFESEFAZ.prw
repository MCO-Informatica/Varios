...
User Function PE01NFESEFAZ()
   ...
   Local aEspVol   := ParamIxb[13]   
   Local aIPI      := ParamIxb[14]
...
return( { aProd,_cMenNota,cMensFis,aDest,aNota,aInfoItem,aDupl,aTransp,aEntrega,aRetirada,aVeiculo,aReboque, aEspVol, aIPI } )
