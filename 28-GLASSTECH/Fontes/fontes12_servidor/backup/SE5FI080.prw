...
±±ºPrograma  ³ SE5FI080 ºAutor  ³ Sérgio Santana     º Data ³ 22/01/2017  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Esta rotina tem por objectivo realizar as baixas dos titu- º±±
±±ºDesc.     ³ los no GESTOQ                                              º±±
±±ºDesc.     ³                                                            º±±
±±º          ³                                                            º±±
...
/*    If _nResult[1] <> 0
    ...
    Else
       ...
       MsgInfo('Não conformidade ao baixar o Titulo ' + rTrim( SE2->E2_NUM ) + '/' +SE2->E2_PARCELA + ' ' +rTrim( SE2->E2_NOMFOR ) + '.', 'Rotina SE5FI080' )
