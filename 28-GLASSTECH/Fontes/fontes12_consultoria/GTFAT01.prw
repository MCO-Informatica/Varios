...
User Function GTFAT01()
	...
	// Ajuste do titulo para quantidade
	aHeader[aScan(aHeader, {|x| AllTrim(x[2]) == "C6_QTDVEN" })][1] := "Qtde. a Liberar"
    ...
    DEFINE MSDIALOG oDlg TITLE OemToAnsi("Pedido Venda " + SC5->C5_NUM) FROM 000, 000  TO aSize[6],aSize[5] COLORS 0, 16777215 PIXEL 
        ...
        @ 006, (aSize[5]/2-001)-(0052*02) BUTTON oBtnSalv  PROMPT "Confirmar"	SIZE 050, 018 OF oDlg ACTION (fSalvar())  FONT oFontBtn PIXEL
...
Static Function fSalvar()
    ...
    If MsgYesNo("ATENÇÃO: Deseja confirmar triagem")
