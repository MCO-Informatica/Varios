...
IndRegua( cAliasTmp, cNomeArq, "AK2_CO+AK2_CC+AK2_ITCTB+AK2_CLVLR+AK2_CLASSE+AK2_OPER+AK2_ENT05",,,"Criando Indice, aguarde..." )
dbClearIndex()
...
FWrite(nHdl, 'AK2_FILIAL;AK2_ORCAME;AK2_VERSAO;AK2_CO;AK2_ID;AK2_CC;AK2_ITCTB;AK2_CLVLR;AK2_CLASSE;AK2_OPER;AK2_ENT05')
aEval( aPeriodo,{|x| FWrite(nHdl,";"+Substr(x,1,10)) } )
FWrite(nHdl, CRLF)

cQuery :=  "SELECT AK2_FILIAL, AK2_ORCAME, AK2_VERSAO, AK2_CO, AK2_CC, AK2_ITCTB, AK2_CLVLR, AK2_ID, AK2_PERIOD, AK2_VALOR, AK2_CLASSE, AK2_OPER, AK2_ENT05 "
...
If !Eof(cAliasTRB)
	...
	While !Eof(cAliasTRB)
		...
		dbSetOrder(1)
		dbGotop(cAliasTmp)
		If dbSeek((cAliasTRB)->(AK2_CO+AK2_CC+AK2_ITCTB+AK2_CLVLR+AK2_CLASSE+AK2_OPER+AK2_ENT05))
		...
		Else
			...
			(cAliasTmp)->AK2_ENT05	:= (cAliasTrb)->AK2_ENT05
			(cAliasTmp)->&("P"+StrTran(DTOC(STOD((cAliasTrb)->AK2_PERIOD)),"/","")) := (cAliasTrb)->AK2_VALOR
			MsUnLock()
	...
	While !Eof(cAliasTmp)
		...
		FWrite(nHdl, Alltrim((cAliasTmp)->AK2_FILIAL)+";"+Alltrim((cAliasTmp)->AK2_ORCAME)+";"+Alltrim((cAliasTmp)->AK2_VERSAO)+";"+Alltrim((cAliasTmp)->AK2_CO)+";"+Alltrim((cAliasTmp)->AK2_ID)+";"+Alltrim((cAliasTmp)->AK2_CC)+";"+ Alltrim((cAliasTmp)->AK2_ITCTB)+";"+ Alltrim((cAliasTmp)->AK2_CLVLR)+";"+ Alltrim((cAliasTmp)->AK2_CLASSE)+";"+ Alltrim((cAliasTmp)->AK2_OPER)+";"+ Alltrim((cAliasTmp)->AK2_ENT05))
		//Periodos
