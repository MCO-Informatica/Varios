...
ฑฑบPrograma  ณ UPREN005 บAutor  ณDanilo Jos้ Grodzickiบ Dataณ  05/11/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Compatibilizador Compra Centralizada.                      บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
aAdd( aSX3, { ;
	...
	1														, ;  // X3_TAMANHO
	0														, ;  // X3_DECIMAL
	'Compra Emerg'										, ;  // X3_TITULO
	'Compra Emerg'										, ;  // X3_TITSPA
	'Compra Emerg'										, ;  // X3_TITENG
	'Compra Emergencial'     							, ;  // X3_DESCRIC
	'Compra de emergencia'								, ;  // X3_DESCSPA
	'Emergency purchase'									, ;  // X3_DESCENG
	'@!'													, ;  // X3_PICTURE
	''														, ;  // X3_VALID
...
aAdd( aSX3, { ;
	...
	1														, ;  // X3_TAMANHO
	0														, ;  // X3_DECIMAL
	'Forn. Espec.'										, ;  // X3_TITULO
	'Forn. Espec.'										, ;  // X3_TITSPA
	'Forn. Espec.'										, ;  // X3_TITENG
	'Fornecedro especifico'    							, ;  // X3_DESCRIC
	'Especํfica fornecedro'								, ;  // X3_DESCSPA
	'Fornecedro specific'								, ;  // X3_DESCENG
	'@!'													, ;  // X3_PICTURE
	''														, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Positivo() .And. cn200MultT()'						, ;  // X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) 		, ;  // X3_USADO
	''														, ;  // X3_RELACAO
...
While !SM0->( EOF() )
	aAdd( aSX6, { ;
		SM0->M0_CODFIL															, ; //X6_FIL
		'MV_XCOMCEN'															, ; //X6_VAR
		'C'																		, ; //X6_TIPO
		'Regra para disparar gatilho compra centralizada.'						, ; //X6_DESCRIC
		'Regla para activar el gatillo compra centralizada.'					, ; //X6_DSCSPA
		'Rule to trigger centralized purchasing trigger.'						, ; //X6_DSCENG
		''																		, ; //X6_DESC1
		''																		, ; //X6_DSCSPA1
		''																		, ; //X6_DSCENG1
		''																		, ; //X6_DESC2
...
aHlpEng := {}
aHlpSpa := {}
aAdd( aHlpPor, "Compra emergencial.                     " )
aAdd( aHlpEng, "Emergency purchase.                     " )
aAdd( aHlpSpa, "Compra de emergencia.                   " )

PutHelp( "PC1_XCOMEME", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "C1_XCOMEME" + CRLF

PutHelp( "PC7_XCOMEME", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "C7_XCOMEME" + CRLF

PutHelp( "PCNB_XCOEME", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "CNB_XCOEME" + CRLF

aHlpPor := {}
aHlpEng := {}
aHlpSpa := {}
aAdd( aHlpPor, "Fornecedor especifico.                  " )
aAdd( aHlpEng, "Fornecedro specific.                    " )
aAdd( aHlpSpa, "Especํfica fornecedro.                  " )

PutHelp( "PC1_XFORESP", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "C1_XFORESP" + CRLF

PutHelp( "PC7_XFORESP", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "C7_XFORESP" + CRLF
