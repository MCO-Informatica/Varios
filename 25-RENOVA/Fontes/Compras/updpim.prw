...
ฑฑบ Programa ณ UPDPIM   บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPDPIM     - Gerado por EXPORDIC / Upd. V.4.10.4 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPDPIM( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDPIM" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPDPIM" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX2, { ;
	...
	'IMOBILIZADO EM CURSO'													, ; //X2_NOME
	'IMOBILIZADO EM CURSO'													, ; //X2_NOMESPA
	'IMOBILIZADO EM CURSO'													, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	'RNATF01'																, ; //X2_ROTINA
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Proj. Curso?'															, ; //X3_TITULO
	'Proj. Curso?'															, ; //X3_TITSPA
	'Proj. Curso?'															, ; //X3_TITENG
	'Projeto Imobilizado em Cu'												, ; //X3_DESCRIC
	'Projeto Imobilizado em Cu'												, ; //X3_DESCSPA
	'Projeto Imobilizado em Cu'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod. Proj. C'															, ; //X3_TITULO
	'Cod. Proj. C'															, ; //X3_TITSPA
	'Cod. Proj. C'															, ; //X3_TITENG
	'Cod. Proj. em Curso'													, ; //X3_DESCRIC
	'Cod. Proj. em Curso'													, ; //X3_DESCSPA
	'Cod. Proj. em Curso'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Cod. Projeto'															, ; //X3_TITSPA
	'Cod. Projeto'															, ; //X3_TITENG
	'Codigo do Projeto em Curs'												, ; //X3_DESCRIC
	'Codigo do Projeto em Curs'												, ; //X3_DESCSPA
	'Codigo do Projeto em Curs'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'EXISTCHAV("SZ0",M->Z0_CODIGO)'											, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nome do Proj'															, ; //X3_TITULO
	'Nome do Proj'															, ; //X3_TITSPA
	'Nome do Proj'															, ; //X3_TITENG
	'Nome do Projeto em Curso'												, ; //X3_DESCRIC
	'Nome do Projeto em Curso'												, ; //X3_DESCSPA
	'Nome do Projeto em Curso'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Status Proj.'															, ; //X3_TITULO
	'Status Proj.'															, ; //X3_TITSPA
	'Status Proj.'															, ; //X3_TITENG
	'Status Projeto em Curso'												, ; //X3_DESCRIC
	'Status Projeto em Curso'												, ; //X3_DESCSPA
	'Status Projeto em Curso'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'1=Aberto;2=Encerrado;3=Andamento;4=Bloq COntabil'						, ; //X3_CBOX
	'1=Aberto;2=Encerrado;3=Andamento;4=Bloq COntabil'						, ; //X3_CBOXSPA
	'1=Aberto;2=Encerrado;3=Andamento;4=Bloq COntabil'						, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Item Da Conta Contabil'												, ; //X3_DESCSPA
	'Item Da Conta Contabil'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Vazio() .Or. Ctb105Item()'												, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	""																	, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Desc Ct Item'															, ; //X3_TITULO
	'Desc Ct Item'															, ; //X3_TITSPA
	'Desc Ct Item'															, ; //X3_TITENG
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSIX, { ;
	'SZ0'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z0_FILIAL+Z0_CODIGO'													, ; //CHAVE
	'Cod. Projeto'															, ; //DESCRICAO
	'Cod. Projeto'															, ; //DESCSPA
	'Cod. Projeto'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'SZ0'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'Z0_FILIAL+Z0_NOME'														, ; //CHAVE
	'Nome do Proj'															, ; //DESCRICAO
	'Nome do Proj'															, ; //DESCSPA
	'Nome do Proj'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ0'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'Z0_FILIAL+Z0_CODIGO+Z0_STATUS'											, ; //CHAVE
	'Cod. Projeto+Status Proj.'												, ; //DESCRICAO
	'Cod. Projeto+Status Proj.'												, ; //DESCSPA
	'Cod. Projeto+Status Proj.'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ0'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'Z0_FILIAL+Z0_CODIGO+Z0_NOME'											, ; //CHAVE
	'Cod. Projeto+Nome do Proj'												, ; //DESCRICAO
	'Cod. Projeto+Nome do Proj'												, ; //DESCSPA
	'Cod. Projeto+Nome do Proj'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ0'																	, ; //INDICE
	'5'																		, ; //ORDEM
	'Z0_FILIAL+Z0_NOME+Z0_CODIGO'											, ; //CHAVE
	'Nome do Proj+Cod. Projeto'												, ; //DESCRICAO
	'Nome do Proj+Cod. Projeto'												, ; //DESCSPA
	'Nome do Proj+Cod. Projeto'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ0'																	, ; //INDICE
	'6'																		, ; //ORDEM
	'Z0_FILIAL+Z0_ITEM'														, ; //CHAVE
	'Conta Item'															, ; //DESCRICAO
	'Conta Item'															, ; //DESCSPA
	'Conta Item'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX7 บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX7, { ;
	'C1_EC05DB'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'IIF(SUBSTR(M->C1_CONTA,1,7)=' + SIMPLES + '1232103' + SIMPLES + ',' + DUPLAS  + 'S' + DUPLAS  + ',' + DUPLAS  + 'N' + DUPLAS  + ')', ; //X7_REGRA
	'C1_XIMCURS'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'C1_EC05DB'																, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	"IIF(GDFIELDGET('C1_XIMCURS')='N','',GDFIELDGET('C1_XPROJIM'))"			, ; //X7_REGRA
	'C1_XPROJIM'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'C1_ITEMCTA'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'SZ0->Z0_CODIGO'														, ; //X7_REGRA
	'C1_XPROJIM'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'SZ0'																	, ; //X7_ALIAS
	6																		, ; //X7_ORDEM
	'xFilial("SZ0")+M->C1_ITEMCTA'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'C7_EC05DB'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'IIF(SUBSTR(M->C7_CONTA,1,7)=' + SIMPLES + '1232103' + SIMPLES + ',' + DUPLAS  + 'S' + DUPLAS  + ',' + DUPLAS  + 'N' + DUPLAS  + ')', ; //X7_REGRA
	'C7_XIMCURS'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'C7_EC05DB'																, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	"IIF(GDFIELDGET('C7_XIMCURS')='N','',GDFIELDGET('C7_XPROJIM'))"			, ; //X7_REGRA
	'C7_XPROJIM'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	...
	'SZ0'																	, ; //X7_ALIAS
	6																		, ; //X7_ORDEM
	'xFilial("SZ0")+M->C7_ITEMCTA'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'D1_EC05DB'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'IIF(SUBSTR(M->D1_CONTA,1,7)=' + SIMPLES + '1232103' + SIMPLES + ',' + DUPLAS  + 'S' + DUPLAS  + ',' + DUPLAS  + 'N' + DUPLAS  + ')', ; //X7_REGRA
	'D1_XIMCURS'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'D1_EC05DB'																, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	"IIF(GDFIELDGET('D1_XIMCURS')='N','',GDFIELDGET('D1_XPROJIM'))"			, ; //X7_REGRA
	'D1_XPROJIM'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	...
	'SZ0'																	, ; //X7_ALIAS
	6																		, ; //X7_ORDEM
	'xFilial("SZ0")+M->D1_ITEMCTA'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'Z0_ITEM'																, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'CTD->CTD_DESC01'														, ; //X7_REGRA
	'Z0_ITEMDES'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'CNB_EC05DB'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'IIF(SUBSTR(M->CNB_CONTA,1,7)=' + SIMPLES + '1232103' + SIMPLES + ',' + DUPLAS  + 'S' + DUPLAS  + ',' + DUPLAS  + 'N' + DUPLAS  + ')', ; //X7_REGRA
	'CNB_XIMCUR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'CNB_EC05DB'																, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	"IIF(GDFIELDGET('CNB_XIMCUR')='N','',GDFIELDGET('CNB_XPROJI'))"			, ; //X7_REGRA
	'CNB_XPROJI'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	...
	'SZ0'																	, ; //X7_ALIAS
	6																		, ; //X7_ORDEM
	'xFilial("SZ0")+M->CNB_ITEMCT'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'CNE_EC05DB'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'IIF(SUBSTR(M->CNE_CONTA,1,7)=' + SIMPLES + '1232103' + SIMPLES + ',' + DUPLAS  + 'S' + DUPLAS  + ',' + DUPLAS  + 'N' + DUPLAS  + ')', ; //X7_REGRA
	'CNE_XIMCUR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'CNE_EC05DB'																, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	"IIF(GDFIELDGET('CNE_XIMCUR')='N','',GDFIELDGET('CNE_XPROJI'))"			, ; //X7_REGRA
	'CNE_XPROJI'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	...
	'SZ0'																	, ; //X7_ALIAS
	6																		, ; //X7_ORDEM
	'xFilial("SZ0")+M->CNE_ITEMCT'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'IMOBILIZADO EM CURSO'													, ; //XB_DESCRI
	'IMOBILIZADO EM CURSO'													, ; //XB_DESCSPA
	'IMOBILIZADO EM CURSO'													, ; //XB_DESCENG
	'SZ0'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod. Projeto'															, ; //XB_DESCRI
	'Cod. Projeto'															, ; //XB_DESCSPA
	'Cod. Projeto'															, ; //XB_DESCENG
	'Z0_CODIGO'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'02'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Nome do Proj'															, ; //XB_DESCRI
	'Nome do Proj'															, ; //XB_DESCSPA
	'Nome do Proj'															, ; //XB_DESCENG
	'Z0_NOME'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'03'																	, ; //XB_SEQ
	'06'																	, ; //XB_COLUNA
	'Conta Item'															, ; //XB_DESCRI
	'Conta Item'															, ; //XB_DESCSPA
	'Conta Item'															, ; //XB_DESCENG
	'ITEMCTA'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'03'																	, ; //XB_COLUNA
	'Status Proj.'															, ; //XB_DESCRI
	'Status Proj.'															, ; //XB_DESCSPA
	'Status Proj.'															, ; //XB_DESCENG
	'Z0_STATUS'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'05'																	, ; //XB_COLUNA
	'Desc Ct Item'															, ; //XB_DESCRI
	'Desc Ct Item'															, ; //XB_DESCSPA
	'Desc Ct Item'															, ; //XB_DESCENG
	'Z0_ITEMDES'															} ) //XB_CONTEM
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  16/10/2015 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
