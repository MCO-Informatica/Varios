...
Processa({|| U_ETIQHP820()})

Return

User Function ETIQHP820()
...
For i:= 1 to Len(_aLote)
	...
	MSBAR(_aTpBar[i],5.0,6.8,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	MSBAR(_aTpBar[i],5.0,17.4,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
