...
User Function Filtrovend()        // incluido pelo assistente de conversao do AP6 IDE em 12/02/05
...
Do While Eof() == .f.
    ...
    While SD2->(D2_DOC+D2_SERIE) == SF2->(F2_DOC+F2_SERIE)
        ...
        //----> filtrando series diferente de "12"
        ...
        RecLock("FAT",.t.)
          ...
          DbSelectArea("SD2")
          While SD2->D2_DOC == SF2->F2_DOC .and. SD2->D2_COD == cProduto .And. SD2->D2_CLIENTE+SD2->D2_LOJA == cCliente
...
If !DbSeek(cPerg)
    ...
    aadd(aRegs,{cPerg,'01','Do Vendedor     ? ','mv_ch1','D',08, 0, 0,'G', '', 'mv_par13','','','','','','','','','','','','','','',''})
    aadd(aRegs,{cPerg,'02','Ate o Vendedor  ? ','mv_ch2','D',08, 0, 0,'G', '', 'mv_par14','','','','','','','','','','','','','','',''})
    ...
    aadd(aRegs,{cPerg,'13','Data Fat Inicial? ','mv_chd','C',06, 0, 0,'G', '', 'mv_par01','','','','','','','','','','','','','','','SA3'})
    aadd(aRegs,{cPerg,'14','Data Fat Final  ? ','mv_che','C',06, 0, 0,'G', '', 'mv_par02','','','','','','','','','','','','','','','SA3'})
