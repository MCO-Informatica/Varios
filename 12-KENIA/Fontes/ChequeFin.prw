...
#include "PROTHEUS.CH"
	...
	#define STR0026 "Datos de Cta. Corriente Destino de cheque CPMF son invalidos"
	...
	#else
		#define STR0001 "Este programa irá imprimir os Cheques do Banco, através de"
		#define STR0002 "formulário pré-impresso."
		...
		#define STR0019 "Antes de iniciar a impressäo, verifique se o formulário continuo"
		#define STR0020 "está ajustado. O teste será impresso na coluna do valor."
		#define STR0021 "Formulário posicionado corretamente ?                         "
		...
		#define STR0026 "Dados da Conta Corrente Destino do cheque CPMF säo invalidos"
	#endif
#endif
...
AADD(aHelpPor,"Informe o código do banco destino do")
AADD(aHelpPor,"cheque. Esta opção serve para informar")
AADD(aHelpPor,"qual o banco destino do cheque de ")
AADD(aHelpPor,"transferência entre contas de mesma ")
AADD(aHelpPor,"titularidade (cheque CPMF). Este ")
AADD(aHelpPor,"parâmetro não tem qualquer função quando")
AADD(aHelpPor,"o layout do cheque for normal. Consulta")
AADD(aHelpPor,"<F3> disponível")
...
AADD(aHelpPor,"Informe o código da Agência destino do")
AADD(aHelpPor,"cheque. Esta opção serve para informar")
AADD(aHelpPor,"qual a agência destino do cheque de ")
AADD(aHelpPor,"transferência entre contas de mesma ")
AADD(aHelpPor,"titularidade (cheque CPMF). Este ")
AADD(aHelpPor,"parâmetro não tem qualquer função quando")
...
AADD(aHelpPor,"Informe o código da Conta destino do")
AADD(aHelpPor,"cheque. Esta opção serve para informar")
