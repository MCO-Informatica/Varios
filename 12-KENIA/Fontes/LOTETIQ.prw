...
User Function LOTETIQ()

Processa({|| U_LOTETIQ1022()})

Return

User Function LOTETIQ1022()
...
For i:= 1 to Len(_aLote)
	...
	oPrint:Say  (0265, 1300, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (0350, 1500, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (0855, 0040, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (0940, 0240, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (0855, 1300, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (0940, 1500, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (1445, 0040, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (1530, 0240, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (1445, 1300, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (1530, 1500, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (2045, 0040, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (2130, 0240, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (2045, 1300, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (2130, 1500, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (2645, 0040, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (2730, 0240, "NF.:"   		, oFont8	)	//----> "OP"
	...
	oPrint:Say  (2645, 1300, "Fornecedor:"		, oFont8	)	//----> "CLIENTE"
	...
	oPrint:Say  (2730, 1500, "NF.:"   		, oFont8	)	//----> "OP"
