...
User Function HP1100()

Processa({|| U_ETIQHP1100()})

Return

User Function ETIQHP1100()
...
//----> BUSCA AS ETIQUETAS A SEREM IMPRESSAS
BuscaEtiq()
...
While !Eof()
	...
	AADD(_aLote	  	, 	TEMP->Z3_LOTE	)
	AADD(_aTpBar  	, 	"CODE128" 		)
	AADD(_aCodBar 	,	TEMP->Z3_LOTE	)
	AADD(_aCliente	,	TEMP->Z3_CLIENTE	)
	AADD(_aOP		,	TEMP->Z3_PARTIDA	)
	AADD(_aRevisor	,	Transform(TEMP->Z3_REVISOR,"@E 999"))
	AADD(_aArtigo	,	TEMP->Z3_ARTIGO	)
	AADD(_aCor		,	TEMP->Z3_COR		)
	AADD(_aQtde		,	Transform( TEMP->Z3_QUANTID,"@E 999,999.99"))
	AADD(_aCompos	,	TEMP->Z3_COMP	)
	AADD(_aCNPJ		,	Iif(Empty(TEMP->Z3_CNPJ),"50747674000122",TEMP->Z3_CNPJ))
	AADD(_aNome		,	Iif(Empty(TEMP->Z3_NOME),"KENIA",TEMP->Z3_NOME	))
...
For i:= 1 to Len(_aLote)
	...
	oPrint:Say  (0520, 0040, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],5.1,6.8,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (0520, 1300, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],5.1,17.4,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (1110, 0040, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],10.0,6.8,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (1110, 1300, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],10.0,17.4,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (1530, 0440, "Revisor:"		, oFont8	)	//----> "REVISOR"
	...
	oPrint:Say  (1700, 0040, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],15.0,6.8,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (1700, 1300, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],15.0,17.4,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (2300, 0040, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],20.0,6.8,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (2300, 1300, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],20.0,17.4,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (2900, 0040, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],25.0,6.8,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
	...
	oPrint:Say  (2900, 1300, "Composição:" 	, oFont8	)	//----> "COMPOSICAO"
	...
	MSBAR(_aTpBar[i],25.0,17.4,_aCodBar[i],oPrint,.F.,,,0.0250,1.0,.T.,,,.F.)		//----> IMPRESSAO DO CODIGO DE BARRAS
