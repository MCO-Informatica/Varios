...
If Empty(MV_PAR20)
	...
	TRCell():New(oSection2,"TOTAL",           ,STR0035,, 89,.F.)  // "Nome Cliente/Fornecedor"
	TRCell():New(oSection2,"TOTAL2",          ,"",, 1,.F.)        // "Historico"
	TRCell():New(oSection2,"E2_NOMFOR",  "SE2",STR0035,, 40,.F.)  // "Nome Cliente/Fornecedor"
	TRCell():New(oSection2,"E2_HIST",    "SE2",STR0036,, 50,.F.)  // "Historico"
