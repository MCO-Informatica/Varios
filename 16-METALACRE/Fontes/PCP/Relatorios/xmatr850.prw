...
BeginSql Alias cAliasSC2
	...
	WHERE  SC2.C2_FILIAL    = %xFilial:SC2%  AND
	       ...
	       SC2.C2_DATPRF   >= %Exp:mv_par12% AND SC2.C2_DATPRF <= %Exp:mv_par13% AND
...
cQuery    += "SC2.C2_DATPRF  >= '"+DtoS(mv_par12)+"' And SC2.C2_DATPRF  <= '"+DtoS(mv_par13)+"' And "
