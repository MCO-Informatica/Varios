/*/
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
ãoãorograma  ãoFISTRFNFEãoAutor ãoCarlos Lima        ãoData ão 30/07/12   ãoão
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
ãoãoescriãoo ãoPonto de Entrada para impressao da CC-e.                   ãoão
ãoão         ãoLayout nosso enquanto aguarda padrao da SEFAZ              ãoão
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
ãoãoso       ão                                                           ãoão
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
ãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoãoão
...
//////////////////////////////////////////////////////////////
Private _cTopAlias := "TSS"         //DEFINI?O DO SHEMA DE AMBIENTE ALIAS
Private _cTopDB    := "MSSQL"       //BANCO DE DADOS UTILIZADO
Private _cTopSrv   := "localhost" //= IP DO SERVIDOR
Private _cTopSrvN  := "localhost"
Private cTopServer
Private cTopAlias

cTop         := GetPvProfString("TSS","TOPALIAS",_cTopAlias,GetAdv97())
cTopData     := GetPvProfString("MSSQL","TOPDATABASE",_cTopDB,GetAdv97())
cTopAlias    := cTopData + "/" + cTop              
cTopServer   := GetPvProfString("localhost","TOPSERVER",_cTopSrv,GetAdv97())
...
MCORGAO    := STR(TMP->CORGAO,2)+IIF(TMP->CORGAO==13 , " - AMAZONAS",IIF(TMP->CORGAO==35 , " - SÃO PAULO" , ""))
...
xEnder  := Capital(RTRIM(SM0->M0_ENDENT) + " - " + RTRIM(SM0->M0_BAIRENT) + " - " + RTRIM(SM0->M0_CIDENT) + "/" + SM0->M0_ESTENT)
...
ENDIF
*
MDESCEVEN := "Carta de Correção Registrada"
...
IF ( iw1 > 0 )
	...
	DO WHILE !EMPTY(SUBS(MCORRECAO,iw1,10))
		AADD(aCorrec , SUBS(MCORRECAO,iw1,80) )
		iw1 += 80     ///Nro de caracteres da linha - fica a criterio
	ENDDO
ENDIF
*
aCondic   := {}
...
oPrint:Box(100,1890,390,2300)

oPrint:Line(150,1890,150,2300)
...
oPrint:Say(940,670,"Código de recepção do evento",oFont11b ,240)
