...
oPrn:cPathPDF := "C:\TEMP\" // Caso seja utilizada impressใo em IMP_PDF 
...
//ImpCabecP(oPrn)   
		...
		oPrn:Box(020+0000,0345,165+0000,1990)
   		...
   		oPrn:Say(050,0400,"Metalacre Ind๚stria e Com้rcio de Lacres",oFont7,100) 
...
While TMP->(!Eof())     
	...
	oPrn:Say(_nLin+0235,0320,"SษRIE.: " + TMP->F3_SERIE      ,oFont8,100) //0065
   	oPrn:Say(_nLin+0235,520,"CLIENTE/FORNECEDOR.: " + Transform(cNome, "@!")             ,oFont8,100) 
	oPrn:Say(_nLin+0285,0065,"EMISSรO.: " + cEmiss          ,oFont8,100) 
