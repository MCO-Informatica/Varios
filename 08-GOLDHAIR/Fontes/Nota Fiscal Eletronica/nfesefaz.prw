			...
			Else
				...
				If MsSeek(cChave)
					...
					If lSimpNac
						...
						//----> MENSAGEM CASA BELLA DONNA
						Else
							cMensFis += "ICMS antecipado nos termos do decreto 46.974 de 01/01/2019, N 48.303/2018, CC 19.528/1996, com liberacao de credito presumido conforme decreto. Documento emitido por ME ou EPP optante pelo Simples Nacional. Nao gera direito a credito fiscal de IPI."
						EndIf
					EndIf
				EndIf		
				dbSelectArea("SF2")
...
If !Empty(aNota)
	...
	cString += "<Contato>Rodrigo de Almeida Sartorio</Contato>"
	
	cString += "<email>resp_tecnico_dfe_protheus@totvs.com.br</email>"
		
	cString += "<fone>28591383</fone>"
