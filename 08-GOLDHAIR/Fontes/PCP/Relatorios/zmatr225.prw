...
TRCell():New(oSection1,'SUMCOMP'	,'   ',"Soma Quantidade : "	,/*Picture*/					,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
...
//#TD20130409 - Inicio
//oSection3 := TRSection():New(oSection1,STR0037,{'SG1','SB1'}) // "Estruturas"
//TRCell():New(oSection3,'SUMCOMP'		,'   ',STR0019	,/*Picture*/					,10			,/*lPixel*/,/*{|| code-block de impressao }*/)
//TRCell():New(oSection3,"SUMCOMP"        ,"   ","TOTAL"  ,/*Picture*/                    ,/*22*/     ,/*lPixel*/,{|| cId1 },"CENTER",        ,"CENTER"    ,           ,/*nColSpace*/,.T./*lAutoSize*/,/*nClrBack*/,/*nClrFore*/,/*lBold*/)
//#TD20130409 - Fim
...
While !oReport:Cancel() .And. !Eof() .And. SG1->G1_FILIAL+SG1->G1_COD <= xFilial('SG1')+mv_par02
	...
	If lContinua	
		...
		//#TD20130409 - Inicio		                
		oSection1:Init()
		oSection1:Cell('SUMCOMP'	):SetValue(nSumComp)		
		//cID1 := nSumComp
		oSection1:PrintLine()
		oSection1:Finish()
		//#TD20130409 - Fim		
...
While !Eof() .And. G1_FILIAL+G1_COD <= xFilial("SG1")+mv_par02
	...
	Else
		...
		//Li += 2
		@ li,143 PSAY "Total : "	
		@ li,153 PSAY nSumcomp Picture cPictQuant	
		LI += 2
		@ li,000 PSAY __PrtThinLine()
	 	LI += 5	
		//#TD20130409 Fim
